# 1 "CubeMX/Core/Src/gpio.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "CubeMX/Core/Src/gpio.c" 2
# 22 "CubeMX/Core/Src/gpio.c"
# 1 "./CubeMX/Core/Inc\\gpio.h" 1
# 29 "./CubeMX/Core/Inc\\gpio.h"
...
# 30 "./CubeMX/Core/Inc\\gpio.h" 2
# 39 "./CubeMX/Core/Inc\\gpio.h"
void MX_GPIO_Init(void);
# 23 "CubeMX/Core/Src/gpio.c" 2
# 42 "CubeMX/Core/Src/gpio.c"
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0400UL)), ((uint16_t)0x0800), GPIO_PIN_RESET);


  GPIO_InitStruct.Pin = ((uint16_t)0x4000)|((uint16_t)0x8000);
  GPIO_InitStruct.Mode = ((0x0UL << 0U) | (0x1UL << 16U) | (0x1UL << 20U) | (0x2UL << 20U));
  GPIO_InitStruct.Pull = (0x00000002U);
  HAL_GPIO_Init(((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0800UL)), &GPIO_InitStruct);


  GPIO_InitStruct.Pin = ((uint16_t)0x0004)|((uint16_t)0x0400);
  GPIO_InitStruct.Mode = ((0x0UL << 0U) | (0x1UL << 16U) | (0x1UL << 20U) | (0x2UL << 20U));
  GPIO_InitStruct.Pull = (0x00000002U);
