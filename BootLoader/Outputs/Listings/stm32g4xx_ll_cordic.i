# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_cordic.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_cordic.c" 2
# 21 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_cordic.c"
# 1 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_cordic.h" 1
# 28 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_cordic.h"
...
# 29 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_cordic.h" 2
# 302 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_cordic.h"
...
# 329 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_cordic.h"
...
# 350 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_cordic.h"
static __inline uint32_t LL_CORDIC_GetFunction(CORDIC_TypeDef *CORDICx)
{
  return (uint32_t)(((CORDICx->CSR) & ((0xFUL << (0U)))));
}
# 377 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_cordic.h"
...
# 550 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_cordic.h"
static __inline uint32_t LL_CORDIC_GetOutSize(CORDIC_TypeDef *CORDICx)
{
  return (uint32_t)(((CORDICx->CSR) & ((0x1UL << (21U)))));
}
# 569 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_cordic.h"
...
# 610 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_cordic.h"
...
# 680 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_cordic.h"
...
# 712 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_cordic.h"
static __inline uint32_t LL_CORDIC_IsActiveFlag_RRDY(CORDIC_TypeDef *CORDICx)
{
  return ((((CORDICx->CSR) & ((0x1UL << (31U)))) == ((0x1UL << (31U)))) ? 1U : 0U);
}
# 732 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_cordic.h"
...
# 758 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_cordic.h"
ErrorStatus LL_CORDIC_DeInit(CORDIC_TypeDef *CORDICx);
# 22 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_cordic.c" 2
...
# 23 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_cordic.c" 2
# 61 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_cordic.c"
ErrorStatus LL_CORDIC_DeInit(CORDIC_TypeDef *CORDICx)
{
  ...
  if (CORDICx == ((CORDIC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x0C00UL)))
  {

    LL_AHB1_GRP1_ForceReset((0x1UL << (3U)));


    LL_AHB1_GRP1_ReleaseReset((0x1UL << (3U)));
  }
  else
  {
    status = ERROR;
