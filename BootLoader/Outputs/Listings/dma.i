# 1 "CubeMX/Core/Src/dma.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "CubeMX/Core/Src/dma.c" 2
# 22 "CubeMX/Core/Src/dma.c"
# 1 "./CubeMX/Core/Inc\\dma.h" 1
# 29 "./CubeMX/Core/Inc\\dma.h"
...
# 23 "CubeMX/Core/Src/dma.c" 2
# 39 "CubeMX/Core/Src/dma.c"
void MX_DMA_Init(void)
{


  do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB1ENR) |= ((0x1UL << (2U)))); tmpreg = ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB1ENR) & ((0x1UL << (2U)))); (void)tmpreg; } while(0);
