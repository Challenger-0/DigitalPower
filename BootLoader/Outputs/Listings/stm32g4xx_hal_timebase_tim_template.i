# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_timebase_tim_template.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_timebase_tim_template.c" 2
# 41 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_timebase_tim_template.c"
...
# 42 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_timebase_tim_template.c" 2
# 55 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_timebase_tim_template.c"
TIM_HandleTypeDef TimHandle;

void TIM6_DAC_IRQHandler(void);
# 69 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_timebase_tim_template.c"
HAL_StatusTypeDef HAL_InitTick(uint32_t TickPriority)
{
  ...
  do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB1ENR1) |= ((0x1UL << (4U)))); tmpreg = ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB1ENR1) & ((0x1UL << (4U)))); (void)tmpreg; } while(0);
  ...
  TimHandle.Instance = ((TIM_TypeDef *) ((0x40000000UL) + 0x1000UL));
  ...
  TimHandle.Init.CounterMode = 0x00000000U;
...
void HAL_SuspendTick(void)
{
  ...
  ((&TimHandle)->Instance->DIER &= ~((0x1UL << (0U))));
}
...
# 176 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_timebase_tim_template.c"
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim)
{
  HAL_IncTick();
}
