# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_comp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_comp.c" 2
# 21 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_comp.c"
# 1 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_comp.h" 1
# 28 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_comp.h"
...
# 29 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_comp.h" 2
# 62 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_comp.h"
typedef struct
{
  uint32_t InputPlus;
...
# 330 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_comp.h"
static __inline void LL_COMP_ConfigInputs(COMP_TypeDef *COMPx, uint32_t InputMinus, uint32_t InputPlus)
{
  (((COMPx->CSR)) = ((((((COMPx->CSR))) & (~((0xFUL << (4U)) | (0x1UL << (8U)) | (0x1UL << (23U)) | (0x1UL << (22U))))) | (InputMinus | InputPlus))));


}
# 349 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_comp.h"
static __inline void LL_COMP_SetInputPlus(COMP_TypeDef *COMPx, uint32_t InputPlus)
{
  (((COMPx->CSR)) = ((((((COMPx->CSR))) & (~((0x1UL << (8U))))) | (InputPlus))));
}
# 365 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_comp.h"
static __inline uint32_t LL_COMP_GetInputPlus(COMP_TypeDef *COMPx)
{
  return (uint32_t)(((COMPx->CSR) & ((0x1UL << (8U)))));
}
# 409 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_comp.h"
static __inline void LL_COMP_SetInputMinus(COMP_TypeDef *COMPx, uint32_t InputMinus)
{
  (((COMPx->CSR)) = ((((((COMPx->CSR))) & (~((0xFUL << (4U)) | (0x1UL << (23U)) | (0x1UL << (22U))))) | (InputMinus))));
}
# 440 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_comp.h"
static __inline uint32_t LL_COMP_GetInputMinus(COMP_TypeDef *COMPx)
{
  return (uint32_t)(((COMPx->CSR) & ((0xFUL << (4U)) | (0x1UL << (23U)) | (0x1UL << (22U)))));
}
# 463 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_comp.h"
static __inline void LL_COMP_SetInputHysteresis(COMP_TypeDef *COMPx, uint32_t InputHysteresis)
{
  (((COMPx->CSR)) = ((((((COMPx->CSR))) & (~((0x7UL << (16U))))) | (InputHysteresis))));
}
# 482 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_comp.h"
static __inline uint32_t LL_COMP_GetInputHysteresis(COMP_TypeDef *COMPx)
{
  return (uint32_t)(((COMPx->CSR) & ((0x7UL << (16U)))));
}
# 504 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_comp.h"
static __inline void LL_COMP_SetOutputPolarity(COMP_TypeDef *COMPx, uint32_t OutputPolarity)
{
  (((COMPx->CSR)) = ((((((COMPx->CSR))) & (~((0x1UL << (15U))))) | (OutputPolarity))));
}
# 517 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_comp.h"
static __inline uint32_t LL_COMP_GetOutputPolarity(COMP_TypeDef *COMPx)
{
  return (uint32_t)(((COMPx->CSR) & ((0x1UL << (15U)))));
}
# 569 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_comp.h"
static __inline void LL_COMP_SetOutputBlankingSource(COMP_TypeDef *COMPx, uint32_t BlankingSource)
{
  (((COMPx->CSR)) = ((((((COMPx->CSR))) & (~((0x7UL << (19U))))) | (BlankingSource))));
}
# 620 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_comp.h"
static __inline uint32_t LL_COMP_GetOutputBlankingSource(COMP_TypeDef *COMPx)
{
  return (uint32_t)(((COMPx->CSR) & ((0x7UL << (19U)))));
}
# 642 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_comp.h"
static __inline void LL_COMP_Enable(COMP_TypeDef *COMPx)
{
  ((COMPx->CSR) |= ((0x1UL << (0U))));
}
...
static __inline void LL_COMP_Disable(COMP_TypeDef *COMPx)
{
  ((COMPx->CSR) &= ~((0x1UL << (0U))));
}
# 665 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_comp.h"
static __inline uint32_t LL_COMP_IsEnabled(COMP_TypeDef *COMPx)
{
  return ((((COMPx->CSR) & ((0x1UL << (0U)))) == ((0x1UL << (0U)))) ? 1UL : 0UL);
}
# 678 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_comp.h"
static __inline void LL_COMP_Lock(COMP_TypeDef *COMPx)
{
  ((COMPx->CSR) |= ((0x1UL << (31U))));
}
# 692 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_comp.h"
static __inline uint32_t LL_COMP_IsLocked(COMP_TypeDef *COMPx)
{
  return ((((COMPx->CSR) & ((0x1UL << (31U)))) == ((0x1UL << (31U)))) ? 1UL : 0UL);
}
# 711 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_comp.h"
static __inline uint32_t LL_COMP_ReadOutputLevel(COMP_TypeDef *COMPx)
{
  return (uint32_t)(((COMPx->CSR) & ((0x1UL << (30U))))
                    >> (30U));
}
# 726 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_comp.h"
ErrorStatus LL_COMP_DeInit(COMP_TypeDef *COMPx);
ErrorStatus LL_COMP_Init(COMP_TypeDef *COMPx, LL_COMP_InitTypeDef *COMP_InitStruct);
void LL_COMP_StructInit(LL_COMP_InitTypeDef *COMP_InitStruct);
# 22 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_comp.c" 2
# 284 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_comp.c"
ErrorStatus LL_COMP_DeInit(COMP_TypeDef *COMPx)
{
...
# 321 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_comp.c"
ErrorStatus LL_COMP_Init(COMP_TypeDef *COMPx, LL_COMP_InitTypeDef *COMP_InitStruct)
{
  ErrorStatus status = SUCCESS;
  ...
  if (LL_COMP_IsLocked(COMPx) == 0UL)
  {
    ...
    (((COMPx->CSR)) = ((((((COMPx->CSR))) & (~((0x1UL << (8U)) | (0x1UL << (23U)) | (0x1UL << (22U)) | (0xFUL << (4U)) | (0x7UL << (16U)) | (0x1UL << (15U)) | (0x7UL << (19U))))) | (COMP_InitStruct->InputPlus | COMP_InitStruct->InputMinus | COMP_InitStruct->InputHysteresis | COMP_InitStruct->OutputPolarity | COMP_InitStruct->OutputBlankingSource))));
# 359 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_comp.c"
  }
  else
  {
...
void LL_COMP_StructInit(LL_COMP_InitTypeDef *COMP_InitStruct)
{
  ...
  COMP_InitStruct->InputPlus = (0x00000000UL);
  COMP_InitStruct->InputMinus = ( (0x2UL << (4U)) | (0x1UL << (4U)) | (0x1UL << (23U)) );
  COMP_InitStruct->InputHysteresis = (0x00000000UL);
  COMP_InitStruct->OutputPolarity = (0x00000000UL);
  COMP_InitStruct->OutputBlankingSource = (0x00000000UL);
}
