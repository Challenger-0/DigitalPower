# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_dma.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_dma.c" 2
# 90 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_dma.c"
...
# 91 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_dma.c" 2
# 111 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_dma.c"
static void DMA_SetConfig(DMA_HandleTypeDef *hdma, uint32_t SrcAddress, uint32_t DstAddress, uint32_t DataLength);

static void DMA_CalcDMAMUXChannelBaseAndMask(DMA_HandleTypeDef *hdma);
static void DMA_CalcDMAMUXRequestGenBaseAndMask(DMA_HandleTypeDef *hdma);
# 152 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_dma.c"
HAL_StatusTypeDef HAL_DMA_Init(DMA_HandleTypeDef *hdma)
{
  uint32_t tmp;
  ...
  if ((uint32_t)(hdma->Instance) < (uint32_t)(((DMA_Channel_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x0008UL))))
  {

    hdma->ChannelIndex = (((uint32_t)hdma->Instance - (uint32_t)((DMA_Channel_TypeDef *) ((((0x40000000UL) + 0x00020000UL)) + 0x0008UL))) / ((uint32_t)((DMA_Channel_TypeDef *) ((((0x40000000UL) + 0x00020000UL)) + 0x001CUL)) - (uint32_t)((DMA_Channel_TypeDef *) ((((0x40000000UL) + 0x00020000UL)) + 0x0008UL)))) << 2;
    hdma->DmaBaseAddress = ((DMA_TypeDef *) (((0x40000000UL) + 0x00020000UL)));
  }
  else
  {

    hdma->ChannelIndex = (((uint32_t)hdma->Instance - (uint32_t)((DMA_Channel_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x0008UL))) / ((uint32_t)((DMA_Channel_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x001CUL)) - (uint32_t)((DMA_Channel_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x0008UL)))) << 2;
    hdma->DmaBaseAddress = ((DMA_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x0400UL));
  }
  ...
  if (hdma->Init.Direction == (0x1UL << (14U)))
  {

    hdma->Init.Request = 0U;
  }


  hdma->DMAmuxChannel->CCR = (hdma->Init.Request & (0xFFUL << (0U)));


  hdma->DMAmuxChannelStatus->CFR = hdma->DMAmuxChannelStatusMask;

  if (((hdma->Init.Request > 0U) && (hdma->Init.Request <= 4U)))
  {
...
HAL_StatusTypeDef HAL_DMA_DeInit(DMA_HandleTypeDef *hdma)
{
  ...
  hdma->DmaBaseAddress->IFCR = ((0x1UL << (0U)) << (hdma->ChannelIndex & 0x1FU));
...
# 378 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_dma.c"
HAL_StatusTypeDef HAL_DMA_Start(DMA_HandleTypeDef *hdma, uint32_t SrcAddress, uint32_t DstAddress, uint32_t DataLength)
{
...
# 421 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_dma.c"
HAL_StatusTypeDef HAL_DMA_Start_IT(DMA_HandleTypeDef *hdma, uint32_t SrcAddress, uint32_t DstAddress,
                                   uint32_t DataLength)
{
  HAL_StatusTypeDef status = HAL_OK;
  ...
  if (HAL_DMA_STATE_READY == hdma->State)
  {
    ...
    if (0 != hdma->XferHalfCpltCallback)
    {
      ...
      ((hdma)->Instance->CCR |= (((0x1UL << (1U)) | (0x1UL << (2U)) | (0x1UL << (3U)))));
    }
    else
    {
      ((hdma)->Instance->CCR &= ~((0x1UL << (2U))));
      ((hdma)->Instance->CCR |= (((0x1UL << (1U)) | (0x1UL << (3U)))));
    }


    if ((hdma->DMAmuxChannel->CCR & (0x1UL << (16U))) != 0U)
    {

      hdma->DMAmuxChannel->CCR |= (0x1UL << (8U));
    }
    ...
    if (hdma->DMAmuxRequestGen != 0U)
    {
      ...
      hdma->DMAmuxRequestGen->RGCR |= (0x1UL << (8U));
    }
...
# 611 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_dma.c"
HAL_StatusTypeDef HAL_DMA_PollForTransfer(DMA_HandleTypeDef *hdma, HAL_DMA_LevelCompleteTypeDef CompleteLevel,
                                          uint32_t Timeout)
{
  uint32_t temp;
  ...
  if (0U != (hdma->Instance->CCR & (0x1UL << (5U))))
  {
  ...
  if (HAL_DMA_FULL_TRANSFER == CompleteLevel)
  {
    ...
    temp = (uint32_t)0x00000002U << (hdma->ChannelIndex & 0x1FU);
  }
  else
  {

    temp = (uint32_t)0x00000004U << (hdma->ChannelIndex & 0x1FU);
  }
  ...
  {
    if ((0U != (hdma->DmaBaseAddress->ISR & ((uint32_t)0x00000008U << (hdma->ChannelIndex & 0x1FU)))))
    {



      hdma->DmaBaseAddress->IFCR = ((uint32_t)(0x1UL << (0U)) << (hdma->ChannelIndex & 0x1FU));
  ...
  if ((hdma->DMAmuxChannelStatus->CSR & hdma->DMAmuxChannelStatusMask) != 0U)
  {
    ...
    hdma->ErrorCode |= 0x00000200U;
  }

  if (HAL_DMA_FULL_TRANSFER == CompleteLevel)
  {

    hdma->DmaBaseAddress->IFCR = ((uint32_t)0x00000002U << (hdma->ChannelIndex & 0x1FU));
  ...
  else
  {
    ...
    hdma->DmaBaseAddress->IFCR = ((uint32_t)0x00000004U << (hdma->ChannelIndex & 0x1FU));
  }
...
void HAL_DMA_IRQHandler(DMA_HandleTypeDef *hdma)
{
  ...
  if ((0U != (flag_it & ((uint32_t)0x00000004U << (hdma->ChannelIndex & 0x1FU)))) && (0U != (source_it & (0x1UL << (2U)))))
  {
    ...
    hdma->DmaBaseAddress->IFCR = ((uint32_t)(0x1UL << (2U)) << (hdma->ChannelIndex & 0x1FU));
  ...
  else if ((0U != (flag_it & ((uint32_t)0x00000002U << (hdma->ChannelIndex & 0x1FU))))
           && (0U != (source_it & (0x1UL << (1U)))))
  {
    if ((hdma->Instance->CCR & (0x1UL << (5U))) == 0U)
    {

      ((hdma)->Instance->CCR &= ~((0x1UL << (3U)) | (0x1UL << (1U))));


      hdma->State = HAL_DMA_STATE_READY;
    }

    hdma->DmaBaseAddress->IFCR = ((uint32_t)(0x1UL << (1U)) << (hdma->ChannelIndex & 0x1FU));
  ...
  else if ((0U != (flag_it & ((uint32_t)0x00000008U << (hdma->ChannelIndex & 0x1FU))))
           && (0U != (source_it & (0x1UL << (3U)))))
  {
...
# 835 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_dma.c"
HAL_StatusTypeDef HAL_DMA_RegisterCallback(DMA_HandleTypeDef *hdma, HAL_DMA_CallbackIDTypeDef CallbackID, void (* pCallback)(DMA_HandleTypeDef *_hdma))
{
  HAL_StatusTypeDef status = HAL_OK;
...
# 886 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_dma.c"
HAL_StatusTypeDef HAL_DMA_UnRegisterCallback(DMA_HandleTypeDef *hdma, HAL_DMA_CallbackIDTypeDef CallbackID)
{
  HAL_StatusTypeDef status = HAL_OK;
...
# 964 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_dma.c"
HAL_DMA_StateTypeDef HAL_DMA_GetState(DMA_HandleTypeDef *hdma)
{
...
# 1002 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_dma.c"
static void DMA_SetConfig(DMA_HandleTypeDef *hdma, uint32_t SrcAddress, uint32_t DstAddress, uint32_t DataLength)
{
  ...
  if ((hdma->Init.Direction) == (0x1UL << (4U)))
  {
...
static void DMA_CalcDMAMUXChannelBaseAndMask(DMA_HandleTypeDef *hdma)
{
  ...
  if ((uint32_t)hdma->Instance < (uint32_t)((DMA_Channel_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x0008UL)))
  {
    ...
    DMAMUX1_ChannelBase = ((DMAMUX_Channel_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0800UL)));
  }
  else
  {
    ...
    DMAMUX1_ChannelBase = ((DMAMUX_Channel_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0800UL) + 0x0020UL));
  ...
  hdma->DMAmuxChannel = (DMAMUX_Channel_TypeDef *)(uint32_t)(dmamux_base_addr + ((hdma->ChannelIndex >> 2U) * ((uint32_t)((DMAMUX_Channel_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0800UL) + 0x0004UL)) - (uint32_t)((DMAMUX_Channel_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0800UL))))));
  hdma->DMAmuxChannelStatus = ((DMAMUX_ChannelStatus_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0800UL) + 0x0080UL));
  hdma->DMAmuxChannelStatusMask = 1UL << (channel_number & 0x1FU);
}
# 1082 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_dma.c"
static void DMA_CalcDMAMUXRequestGenBaseAndMask(DMA_HandleTypeDef *hdma)
{
  uint32_t request = hdma->Init.Request & (0xFFUL << (0U));


  hdma->DMAmuxRequestGen = (DMAMUX_RequestGen_TypeDef *)((uint32_t)(((uint32_t)((DMAMUX_RequestGen_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0800UL) + 0x0100UL))) + ((request - 1U) * 4U)));

  hdma->DMAmuxRequestGenStatus = ((DMAMUX_RequestGenStatus_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0800UL) + 0x0140UL));
