# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_cortex.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_cortex.c" 2
# 104 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_cortex.c"
...
# 105 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_cortex.c" 2
# 163 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_cortex.c"
void HAL_NVIC_SetPriorityGrouping(uint32_t PriorityGroup)
{
...
# 185 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_cortex.c"
void HAL_NVIC_SetPriority(IRQn_Type IRQn, uint32_t PreemptPriority, uint32_t SubPriority)
{
...
# 207 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_cortex.c"
void HAL_NVIC_EnableIRQ(IRQn_Type IRQn)
{
...
# 223 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_cortex.c"
void HAL_NVIC_DisableIRQ(IRQn_Type IRQn)
{
...
# 249 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_cortex.c"
uint32_t HAL_SYSTICK_Config(uint32_t TicksNumb)
{
   return SysTick_Config(TicksNumb);
}
# 277 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_cortex.c"
uint32_t HAL_NVIC_GetPriorityGrouping(void)
{

  return __NVIC_GetPriorityGrouping();
}
# 304 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_cortex.c"
void HAL_NVIC_GetPriority(IRQn_Type IRQn, uint32_t PriorityGroup, uint32_t *pPreemptPriority, uint32_t *pSubPriority)
{
...
# 319 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_cortex.c"
void HAL_NVIC_SetPendingIRQ(IRQn_Type IRQn)
{
...
# 337 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_cortex.c"
uint32_t HAL_NVIC_GetPendingIRQ(IRQn_Type IRQn)
{
...
# 353 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_cortex.c"
void HAL_NVIC_ClearPendingIRQ(IRQn_Type IRQn)
{
...
# 370 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_cortex.c"
uint32_t HAL_NVIC_GetActive(IRQn_Type IRQn)
{

  return __NVIC_GetActive(IRQn);
}
# 384 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_cortex.c"
void HAL_SYSTICK_CLKSourceConfig(uint32_t CLKSource)
{
...
# 430 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_cortex.c"
void HAL_MPU_Enable(uint32_t MPU_Control)
{
...
# 461 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_cortex.c"
void HAL_MPU_ConfigRegion(MPU_Region_InitTypeDef *MPU_Init)
{
