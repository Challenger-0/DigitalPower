# 1 "BSP/MXGeneratedInit.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 415 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "BSP/MXGeneratedInit.cpp" 2
# 1 "./CubeMX/Core/Inc\\dma.h" 1
# 25 "./CubeMX/Core/Inc\\dma.h"
extern "C" {
...
# 30 "./CubeMX/Core/Inc\\dma.h" 2
# 41 "./CubeMX/Core/Inc\\dma.h"
...
# 2 "BSP/MXGeneratedInit.cpp" 2
# 1 "./CubeMX/Core/Inc\\gpio.h" 1
# 25 "./CubeMX/Core/Inc\\gpio.h"
extern "C" {
# 39 "./CubeMX/Core/Inc\\gpio.h"
...
# 3 "BSP/MXGeneratedInit.cpp" 2
# 1 "./CubeMX/Core/Inc\\spi.h" 1
# 25 "./CubeMX/Core/Inc\\spi.h"
extern "C" {
# 35 "./CubeMX/Core/Inc\\spi.h"
...
# 4 "BSP/MXGeneratedInit.cpp" 2
# 1 "./CubeMX/Core/Inc\\tim.h" 1
# 25 "./CubeMX/Core/Inc\\tim.h"
extern "C" {
# 35 "./CubeMX/Core/Inc\\tim.h"
...
# 5 "BSP/MXGeneratedInit.cpp" 2
# 1 "./CubeMX/Core/Inc\\usart.h" 1
# 25 "./CubeMX/Core/Inc\\usart.h"
extern "C" {
# 35 "./CubeMX/Core/Inc\\usart.h"
...
# 6 "BSP/MXGeneratedInit.cpp" 2
# 1 "./CubeMX/Core/Inc\\usb.h" 1
# 25 "./CubeMX/Core/Inc\\usb.h"
extern "C" {
# 35 "./CubeMX/Core/Inc\\usb.h"
...
# 7 "BSP/MXGeneratedInit.cpp" 2
# 1 "./CubeMX/Core/Inc\\rtc.h" 1
# 25 "./CubeMX/Core/Inc\\rtc.h"
extern "C" {
# 35 "./CubeMX/Core/Inc\\rtc.h"
...
void SystemClock_Config(void) {
    ...
    HAL_PWREx_ControlVoltageScaling(((uint32_t)0x00000000));




    RCC_OscInitStruct.OscillatorType = 0x00000002U | 0x00000020U;
    RCC_OscInitStruct.HSIState = (0x1UL << (8U));
    RCC_OscInitStruct.HSICalibrationValue = 0x40U;
    RCC_OscInitStruct.HSI48State = (0x1UL << (0U));
    RCC_OscInitStruct.PLL.PLLState = 0x00000002U;
    RCC_OscInitStruct.PLL.PLLSource = (0x1UL << (1U));
    RCC_OscInitStruct.PLL.PLLM = 0x00000004U;
    RCC_OscInitStruct.PLL.PLLN = 85;
    RCC_OscInitStruct.PLL.PLLP = 0x00000002U;
    RCC_OscInitStruct.PLL.PLLQ = 0x00000002U;
    RCC_OscInitStruct.PLL.PLLR = 0x00000002U;
    ...
    if (HAL_RCC_ClockConfig(&RCC_ClkInitStruct, (0x00000004U)) != HAL_OK) {
        Error_Handler();
    }
}

void MXGeneratedInit(void) {
    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SHCSR |= 0x00007000;
    HAL_Init();
    SystemClock_Config();
    MX_GPIO_Init();
    MX_DMA_Init();
