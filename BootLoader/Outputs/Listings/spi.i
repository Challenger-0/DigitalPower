...
# 54 "./Components/FreeRTOS/include\\FreeRTOS.h"
    extern "C" {
...
# 24 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_spi.h"
extern "C" {
...
# 2280 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_spi.h"
}
# 3 "BSP/SPI.cpp" 2
...
bool SPI::write(const void *buffer, size_t size) {
    ...
    result = (bool)ulTaskGenericNotifyTake( ( ( 0 ) ), ( ( ( BaseType_t ) 1 ) ), ( ( TickType_t ) 0xffffffffUL ) );
    return result;
}
...
void SPI::setDataWidth(DataWidth value) {
    ...
    if (value == DataWidth::bits8)
        dataWidth = ((0x4UL << (8U)) | (0x2UL << (8U)) | (0x1UL << (8U)));
    else if (value == DataWidth::bits16)
        dataWidth = ((0x8UL << (8U)) | (0x4UL << (8U)) | (0x2UL << (8U)) | (0x1UL << (8U)));
    else
        return;
...
void SPI::_trFailCb(void) {
    xTaskGenericNotifyFromISR( ( currTask ), ( ( 0 ) ), ( (std::uint32_t) false ), ( eSetValueWithOverwrite ), 0, ( nullptr ) );
}

void SPI::_trSuccessCb(void) {
    xTaskGenericNotifyFromISR( ( currTask ), ( ( 0 ) ), ( (std::uint32_t) true ), ( eSetValueWithOverwrite ), 0, ( nullptr ) );
}
