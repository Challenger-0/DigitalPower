# 1 "Components/Graphics/Basic/GraphicsFunction.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 415 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "Components/Graphics/Basic/GraphicsFunction.cpp" 2
...
# 8 "Components/Graphics/Basic/GraphicsFunction.hpp" 2
...
# 2 "Components/Graphics/Basic/GraphicsFunction.cpp" 2
...
void Graphics::GraphicsFunction::drawRRectFilled(Offset offset, Size size, Color color, std::int16_t radius) {
    ...
    yl = offset.y + size.height - radius - 2;
