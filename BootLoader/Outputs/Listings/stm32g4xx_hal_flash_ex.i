# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash_ex.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash_ex.c" 2
# 71 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash_ex.c"
...
# 72 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash_ex.c" 2
# 92 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash_ex.c"
...
# 138 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash_ex.c"
HAL_StatusTypeDef HAL_FLASHEx_Erase(FLASH_EraseInitTypeDef *pEraseInit, uint32_t *PageError)
{
  ...
  status = FLASH_WaitForLastOperation((uint32_t)1000U);
  ...
  if (status == HAL_OK)
  {
    ...
    if (((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->ACR) & ((0x1UL << (9U)))) != 0U)
    {
    ...
    else if (((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->ACR) & ((0x1UL << (10U)))) != 0U)
    {
    ...
    if (pEraseInit->TypeErase == 0x01U)
    {
      ...
      ((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->CR) &= ~(((0x1UL << (2U)))));
    ...
    else
    {
      ...
      *PageError = 0xFFFFFFFFU;
      ...
      for (page_index = pEraseInit->Page; page_index < (pEraseInit->Page + pEraseInit->NbPages); page_index++)
      {
        ...
        ((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->CR) &= ~(((0x1UL << (1U)) | (0x3FUL << (3U)))));
...
HAL_StatusTypeDef HAL_FLASHEx_Erase_IT(FLASH_EraseInitTypeDef *pEraseInit)
{
  ...
  do { if((((0x1UL << (24U)) | (0x1UL << (25U))) & ((0x1UL << (24U)) >> 24U)) != 0U) { ((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->ECCR) |= ((0x1UL << (24U)))); } if((((0x1UL << (24U)) | (0x1UL << (25U))) & (~((0x1UL << (24U)) >> 24U))) != 0U) { ((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->CR) |= ((((0x1UL << (24U)) | (0x1UL << (25U))) & (~((0x1UL << (24U)) >> 24U))))); } } while (0);
...
# 310 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash_ex.c"
HAL_StatusTypeDef HAL_FLASHEx_OBProgram(FLASH_OBProgramInitTypeDef *pOBInit)
{
  HAL_StatusTypeDef status = HAL_OK;
  ...
  if ((pOBInit->OptionType & 0x01U) != 0U)
  {
  ...
  if ((pOBInit->OptionType & 0x02U) != 0U)
  {
  ...
  if ((pOBInit->OptionType & 0x04U) != 0U)
  {
  ...
  if ((pOBInit->OptionType & 0x08U) != 0U)
  {
  ...
  if ((pOBInit->OptionType & 0x20U) != 0U)
  {
  ...
  if ((pOBInit->OptionType & 0x10U) != 0U)
  {
...
# 399 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash_ex.c"
void HAL_FLASHEx_OBGetConfig(FLASH_OBProgramInitTypeDef *pOBInit)
{
  pOBInit->OptionType = (0x02U | 0x04U);





  if ((pOBInit->WRPArea == 0x00U) || (pOBInit->WRPArea == 0x01U))

  {
    pOBInit->OptionType |= 0x01U;
  ...
  if (pOBInit->PCROPConfig == 0x00000001U)

  {
    pOBInit->OptionType |= 0x08U;

    FLASH_OB_GetPCROP(&(pOBInit->PCROPConfig), &(pOBInit->PCROPStartAddr), &(pOBInit->PCROPEndAddr));
  }

  pOBInit->OptionType |= 0x10U;
  ...
  if (pOBInit->SecBank == 0x00000001U)

  {
    pOBInit->OptionType |= 0x20U;
    FLASH_OB_GetSecMem(pOBInit->SecBank, &(pOBInit->SecSize));
  }
}
# 459 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash_ex.c"
HAL_StatusTypeDef HAL_FLASHEx_EnableSecMemProtection(uint32_t Bank)
{
# 481 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash_ex.c"
  {
    ((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->CR) |= ((0x1UL << (28U))));
  }
...
void HAL_FLASHEx_EnableDebugger(void)
{
  ((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->ACR |= (0x1UL << (18U));
}
# 505 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash_ex.c"
void HAL_FLASHEx_DisableDebugger(void)
{
  ((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->ACR &= ~(0x1UL << (18U));
}
# 533 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash_ex.c"
static void FLASH_MassErase(uint32_t Banks)
{
...

  {
    ...
    if ((Banks & 0x00000001U) != 0U)
    {
      ((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->CR) |= ((0x1UL << (2U))));
    }
# 555 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash_ex.c"
  }
# 564 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash_ex.c"
  ((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->CR) |= ((0x1UL << (16U))));
}
# 578 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash_ex.c"
void FLASH_PageErase(uint32_t Page, uint32_t Banks)
{

  ((void)0U);
# 604 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash_ex.c"
  (((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->CR)) = ((((((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->CR))) & (~((0x3FUL << (3U))))) | (((Page & 0xFFU) << (3U))))));
  ((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->CR) |= ((0x1UL << (1U))));
  ((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->CR) |= ((0x1UL << (16U))));
}
...
void FLASH_FlushCaches(void)
{
      ...
      (cache == FLASH_CACHE_ICACHE_DCACHE_ENABLED))
  {
    ...
    do { ((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->ACR) |= ((0x1UL << (11U)))); ((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->ACR) &= ~((0x1UL << (11U)))); } while (0);
      ...
      (cache == FLASH_CACHE_ICACHE_DCACHE_ENABLED))
  {
    ...
    do { ((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->ACR) |= ((0x1UL << (12U)))); ((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->ACR) &= ~((0x1UL << (12U)))); } while (0);
...
# 667 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash_ex.c"
static HAL_StatusTypeDef FLASH_OB_WRPConfig(uint32_t WRPArea, uint32_t WRPStartOffset, uint32_t WRDPEndOffset)
{
  HAL_StatusTypeDef status;
  ...
  if (status == HAL_OK)
  {
    ...
    if (WRPArea == 0x00U)
    {
      ((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->WRP1AR = ((WRDPEndOffset << (16U)) | WRPStartOffset);
    }
    else if (WRPArea == 0x01U)
    {
      ((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->WRP1BR = ((WRDPEndOffset << (16U)) | WRPStartOffset);
    }
# 700 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash_ex.c"
    else
    {
    ...
    ((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->CR) |= ((0x1UL << (17U))));
...
# 732 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash_ex.c"
static HAL_StatusTypeDef FLASH_OB_RDPConfig(uint32_t RDPLevel)
{
  HAL_StatusTypeDef status;
  ...
  if (status == HAL_OK)
  {
    ...
    (((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->OPTR)) = ((((((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->OPTR))) & (~((0xFFUL << (0U))))) | (RDPLevel))));
...
# 779 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash_ex.c"
static HAL_StatusTypeDef FLASH_OB_UserConfig(uint32_t UserType, uint32_t UserConfig)
{
  ...
  if (status == HAL_OK)
  {
    if ((UserType & 0x00000001U) != 0U)
    {

      ((void)0U);


      optr_reg_val |= (UserConfig & (0x7UL << (8U)));
      optr_reg_mask |= (0x7UL << (8U));
    }

    if ((UserType & 0x00000002U) != 0U)
    {

      ((void)0U);


      optr_reg_val |= (UserConfig & (0x1UL << (12U)));
      optr_reg_mask |= (0x1UL << (12U));
    }

    if ((UserType & 0x00000004U) != 0U)
    {

      ((void)0U);


      optr_reg_val |= (UserConfig & (0x1UL << (13U)));
      optr_reg_mask |= (0x1UL << (13U));
    }

    if ((UserType & 0x00001000U) != 0U)
    {

      ((void)0U);


      optr_reg_val |= (UserConfig & (0x1UL << (14U)));
      optr_reg_mask |= (0x1UL << (14U));
    }

    if ((UserType & 0x00000008U) != 0U)
    {

      ((void)0U);


      optr_reg_val |= (UserConfig & (0x1UL << (16U)));
      optr_reg_mask |= (0x1UL << (16U));
    }

    if ((UserType & 0x00000010U) != 0U)
    {

      ((void)0U);


      optr_reg_val |= (UserConfig & (0x1UL << (17U)));
      optr_reg_mask |= (0x1UL << (17U));
    }

    if ((UserType & 0x00000020U) != 0U)
    {

      ((void)0U);


      optr_reg_val |= (UserConfig & (0x1UL << (18U)));
      optr_reg_mask |= (0x1UL << (18U));
    }

    if ((UserType & 0x00000040U) != 0U)
    {

      ((void)0U);


      optr_reg_val |= (UserConfig & (0x1UL << (19U)));
      optr_reg_mask |= (0x1UL << (19U));
    }
# 885 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash_ex.c"
    if ((UserType & 0x00000200U) != 0U)
    {

      ((void)0U);


      optr_reg_val |= (UserConfig & (0x1UL << (23U)));
      optr_reg_mask |= (0x1UL << (23U));
    }

    if ((UserType & 0x00000400U) != 0U)
    {

      ((void)0U);


      optr_reg_val |= (UserConfig & (0x1UL << (24U)));
      optr_reg_mask |= (0x1UL << (24U));
    }

    if ((UserType & 0x00000800U) != 0U)
    {

      ((void)0U);


      optr_reg_val |= (UserConfig & (0x1UL << (25U)));
      optr_reg_mask |= (0x1UL << (25U));
    }

    if ((UserType & 0x00002000U) != 0U)
    {

      ((void)0U);


      optr_reg_val |= (UserConfig & (0x1UL << (26U)));
      optr_reg_mask |= (0x1UL << (26U));
    }

    if ((UserType & 0x00004000U) != 0U)
    {

      ((void)0U);


      optr_reg_val |= (UserConfig & (0x1UL << (27U)));
      optr_reg_mask |= (0x1UL << (27U));
    }

    if ((UserType & 0x00008000U) != 0U)
    {

      ((void)0U);


      optr_reg_val |= (UserConfig & (0x3UL << (28U)));
      optr_reg_mask |= (0x3UL << (28U));
    }

    if ((UserType & 0x00010000U) != 0U)
    {

      ((void)0U);


      optr_reg_val |= (UserConfig & (0x1UL << (30U)));
      optr_reg_mask |= (0x1UL << (30U));
    }


    (((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->OPTR)) = ((((((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->OPTR))) & (~(optr_reg_mask))) | (optr_reg_val))));
...
# 985 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash_ex.c"
static HAL_StatusTypeDef FLASH_OB_PCROPConfig(uint32_t PCROPConfig, uint32_t PCROPStartAddr, uint32_t PCROPEndAddr)
{
  HAL_StatusTypeDef status;
  uint32_t reg_value;
  ...
  if (status == HAL_OK)
  {
# 1018 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash_ex.c"
    bank1_addr = (0x08000000UL);
# 1048 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash_ex.c"
    {

      if ((PCROPConfig & 0x00000001U) == 0x00000001U)
      {
        reg_value = ((PCROPStartAddr - bank1_addr) >> 3);
        (((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->PCROP1SR)) = ((((((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->PCROP1SR))) & (~((0x3FFFUL << (0U))))) | (reg_value))));

        reg_value = ((PCROPEndAddr - bank1_addr) >> 3);
        (((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->PCROP1ER)) = ((((((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->PCROP1ER))) & (~((0x3FFFUL << (0U))))) | (reg_value))));
      }
# 1068 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash_ex.c"
      else
      {
    ...
    (((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->PCROP1ER)) = ((((((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->PCROP1ER))) & (~((0x1UL << (31U))))) | ((PCROPConfig & (0x1UL << (31U)))))));
...
# 1103 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash_ex.c"
static HAL_StatusTypeDef FLASH_OB_SecMemConfig(uint32_t SecBank, uint32_t SecSize)
{
  ...
  if (status == HAL_OK)
  {
    ...
    if (SecBank == 0x00000001U)
    {
      (((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->SEC1R)) = ((((((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->SEC1R))) & (~((0x7FUL << (0U))))) | (SecSize))));
    }
# 1133 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash_ex.c"
    ((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->CR) |= ((0x1UL << (17U))));
...
# 1156 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash_ex.c"
static HAL_StatusTypeDef FLASH_OB_BootLockConfig(uint32_t BootLockConfig)
{
  HAL_StatusTypeDef status;
  ...
  if (status == HAL_OK)
  {
    (((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->SEC1R)) = ((((((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->SEC1R))) & (~((0x1UL << (16U))))) | (BootLockConfig))));
...
# 1191 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash_ex.c"
static void FLASH_OB_GetSecMem(uint32_t SecBank, uint32_t *SecSize)
{

  if (SecBank == 0x00000001U)
  {
    *SecSize = ((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->SEC1R) & ((0x7FUL << (0U))));
  }
# 1208 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash_ex.c"
}
# 1217 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash_ex.c"
static uint32_t FLASH_OB_GetBootLock(void)
{
  return (((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->SEC1R)) & (0x1UL << (16U)));
}
# 1236 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash_ex.c"
static void FLASH_OB_GetWRP(uint32_t WRPArea, uint32_t *WRPStartOffset, uint32_t *WRDPEndOffset)
{

  if (WRPArea == 0x00U)
  {
    *WRPStartOffset = ((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->WRP1AR) & ((0x3FUL << (0U))));
    *WRDPEndOffset = (((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->WRP1AR) & ((0x3FUL << (16U)))) >> (16U));
  }
  else if (WRPArea == 0x01U)
  {
    *WRPStartOffset = ((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->WRP1BR) & ((0x3FUL << (0U))));
    *WRDPEndOffset = (((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->WRP1BR) & ((0x3FUL << (16U)))) >> (16U));
  }
# 1261 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash_ex.c"
  else
  {

  }
}
# 1275 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash_ex.c"
static uint32_t FLASH_OB_GetRDP(void)
{
  uint32_t rdp_level = ((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->OPTR) & ((0xFFUL << (0U))));

  if ((rdp_level != 0xAAU) && (rdp_level != 0xCCU))
  {
    return (0xBBU);
  }
  else
...
# 1303 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash_ex.c"
static uint32_t FLASH_OB_GetUser(void)
{
  uint32_t user_config = ((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->OPTR));
  ((user_config) &= ~((0xFFUL << (0U))));

  return user_config;
}
# 1322 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash_ex.c"
static void FLASH_OB_GetPCROP(uint32_t *PCROPConfig, uint32_t *PCROPStartAddr, uint32_t *PCROPEndAddr)
{
  uint32_t reg_value;
  uint32_t bank1_addr;
# 1341 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash_ex.c"
  bank1_addr = (0x08000000UL);
# 1370 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash_ex.c"
  {
    if (((*PCROPConfig) & 0x00000001U) == 0x00000001U)
    {
      reg_value = (((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->PCROP1SR)) & (0x3FFFUL << (0U)));
      *PCROPStartAddr = (reg_value << 3) + bank1_addr;

      reg_value = (((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->PCROP1ER)) & (0x3FFFUL << (0U)));
      *PCROPEndAddr = (reg_value << 3) + bank1_addr;
    }
# 1389 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash_ex.c"
    else
    {
  ...
  *PCROPConfig |= (((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->PCROP1ER)) & (0x1UL << (31U)));
}
