# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_dac.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_dac.c" 2
# 21 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_dac.c"
# 1 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h" 1
# 28 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
...
# 29 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h" 2
# 179 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
typedef struct
{
  uint32_t TriggerSource;
# 191 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
  uint32_t TriggerSource2;
# 201 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
...
# 226 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
...
# 665 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline void LL_DAC_SetHighFrequencyMode(DAC_TypeDef *DACx, uint32_t HighFreqMode)
{
  (((DACx->MCR)) = ((((((DACx->MCR))) & (~((0x3UL << (14U))))) | (HighFreqMode))));
}
# 679 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline uint32_t LL_DAC_GetHighFrequencyMode(DAC_TypeDef *DACx)
{
  return (uint32_t)(((DACx->MCR) & ((0x3UL << (14U)))));
}
# 708 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline void LL_DAC_SetMode(DAC_TypeDef *DACx, uint32_t DAC_Channel, uint32_t ChannelMode)
{
  (((DACx->CR)) = ((((((DACx->CR))) & (~((0x1UL << (14U)) << (DAC_Channel & (0UL | 16UL))))) | (ChannelMode << (DAC_Channel & (0UL | 16UL))))));


}
# 731 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline uint32_t LL_DAC_GetMode(DAC_TypeDef *DACx, uint32_t DAC_Channel)
{
  return (uint32_t)(((DACx->CR) & ((0x1UL << (14U)) << (DAC_Channel & (0UL | 16UL))))
                    >> (DAC_Channel & (0UL | 16UL))
                   );
}
# 754 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline void LL_DAC_SetTrimmingValue(DAC_TypeDef *DACx, uint32_t DAC_Channel, uint32_t TrimmingValue)
{
  (((DACx->CCR)) = ((((((DACx->CCR))) & (~((0x1FUL << (0U)) << (DAC_Channel & (0UL | 16UL))))) | (TrimmingValue << (DAC_Channel & (0UL | 16UL))))));


}
# 776 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline uint32_t LL_DAC_GetTrimmingValue(DAC_TypeDef *DACx, uint32_t DAC_Channel)
{
  return (uint32_t)(((DACx->CCR) & ((0x1FUL << (0U)) << (DAC_Channel & (0UL | 16UL))))
                    >> (DAC_Channel & (0UL | 16UL))
                   );
}
# 830 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline void LL_DAC_SetTriggerSource(DAC_TypeDef *DACx, uint32_t DAC_Channel, uint32_t TriggerSource)
{
  (((DACx->CR)) = ((((((DACx->CR))) & (~((0xFUL << (2U)) << (DAC_Channel & (0UL | 16UL))))) | (TriggerSource << (DAC_Channel & (0UL | 16UL))))));


}
# 881 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline uint32_t LL_DAC_GetTriggerSource(DAC_TypeDef *DACx, uint32_t DAC_Channel)
{
  return (uint32_t)(((DACx->CR) & ((0xFUL << (2U)) << (DAC_Channel & (0UL | 16UL))))
                    >> (DAC_Channel & (0UL | 16UL))
                   );
}
# 907 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline void LL_DAC_SetWaveAutoGeneration(DAC_TypeDef *DACx, uint32_t DAC_Channel, uint32_t WaveAutoGeneration)
{
  (((DACx->CR)) = ((((((DACx->CR))) & (~((0x3UL << (6U)) << (DAC_Channel & (0UL | 16UL))))) | (WaveAutoGeneration << (DAC_Channel & (0UL | 16UL))))));


}
# 932 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline uint32_t LL_DAC_GetWaveAutoGeneration(DAC_TypeDef *DACx, uint32_t DAC_Channel)
{
  return (uint32_t)(((DACx->CR) & ((0x3UL << (6U)) << (DAC_Channel & (0UL | 16UL))))
                    >> (DAC_Channel & (0UL | 16UL))
                   );
}
# 971 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline void LL_DAC_SetWaveNoiseLFSR(DAC_TypeDef *DACx, uint32_t DAC_Channel, uint32_t NoiseLFSRMask)
{
  (((DACx->CR)) = ((((((DACx->CR))) & (~((0xFUL << (8U)) << (DAC_Channel & (0UL | 16UL))))) | (NoiseLFSRMask << (DAC_Channel & (0UL | 16UL))))));


}
# 1004 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline uint32_t LL_DAC_GetWaveNoiseLFSR(DAC_TypeDef *DACx, uint32_t DAC_Channel)
{
  return (uint32_t)(((DACx->CR) & ((0xFUL << (8U)) << (DAC_Channel & (0UL | 16UL))))
                    >> (DAC_Channel & (0UL | 16UL))
                   );
}
# 1043 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline void LL_DAC_SetWaveTriangleAmplitude(DAC_TypeDef *DACx, uint32_t DAC_Channel,
...
# 1077 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline uint32_t LL_DAC_GetWaveTriangleAmplitude(DAC_TypeDef *DACx, uint32_t DAC_Channel)
{
  return (uint32_t)(((DACx->CR) & ((0xFUL << (8U)) << (DAC_Channel & (0UL | 16UL))))
                    >> (DAC_Channel & (0UL | 16UL))
                   );
}
# 1105 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline void LL_DAC_SetWaveSawtoothPolarity(DAC_TypeDef *DACx, uint32_t DAC_Channel, uint32_t Polarity)
{
  volatile uint32_t *preg = ((uint32_t *)((uint32_t) ((uint32_t)(&(DACx->STR1)) + (((DAC_Channel >> 7UL) & 0x00000001UL) << 2UL))));

  (((*preg)) = ((((((*preg))) & (~((0x1UL << (12U))))) | (Polarity))));


}
# 1129 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline uint32_t LL_DAC_GetWaveSawtoothPolarity(DAC_TypeDef *DACx, uint32_t DAC_Channel)
{
  volatile uint32_t const *preg = ((uint32_t *)((uint32_t) ((uint32_t)(&(DACx->STR1)) + (((DAC_Channel >> 7UL) & 0x00000001UL) << 2UL))));

  return (uint32_t) ((*preg) & ((0x1UL << (12U))));
}
# 1156 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline void LL_DAC_SetWaveSawtoothResetData(DAC_TypeDef *DACx, uint32_t DAC_Channel, uint32_t ResetData)
{
  volatile uint32_t *preg = ((uint32_t *)((uint32_t) ((uint32_t)(&(DACx->STR1)) + (((DAC_Channel >> 7UL) & 0x00000001UL) << 2UL))));

  (((*preg)) = ((((((*preg))) & (~((0xFFFUL << (0U))))) | (ResetData << (0U)))));


}
# 1179 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline uint32_t LL_DAC_GetWaveSawtoothResetData(DAC_TypeDef *DACx, uint32_t DAC_Channel)
{
  volatile uint32_t const *preg = ((uint32_t *)((uint32_t) ((uint32_t)(&(DACx->STR1)) + (((DAC_Channel >> 7UL) & 0x00000001UL) << 2UL))));

  return (uint32_t)(((*preg) & ((0xFFFUL << (0U)))) >> (0U));
}
# 1208 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline void LL_DAC_SetWaveSawtoothStepData(DAC_TypeDef *DACx, uint32_t DAC_Channel, uint32_t StepData)
{
  volatile uint32_t *preg = ((uint32_t *)((uint32_t) ((uint32_t)(&(DACx->STR1)) + (((DAC_Channel >> 7UL) & 0x00000001UL) << 2UL))));

  (((*preg)) = ((((((*preg))) & (~((0xFFFFUL << (16U))))) | (StepData << (16U)))));


}
# 1233 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline uint32_t LL_DAC_GetWaveSawtoothStepData(DAC_TypeDef *DACx, uint32_t DAC_Channel)
{
  volatile uint32_t const *preg = ((uint32_t *)((uint32_t) ((uint32_t)(&(DACx->STR1)) + (((DAC_Channel >> 7UL) & 0x00000001UL) << 2UL))));

  return (uint32_t)(((*preg) & ((0xFFFFUL << (16U)))) >> (16U));
}
# 1286 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline void LL_DAC_SetWaveSawtoothResetTriggerSource(DAC_TypeDef *DACx, uint32_t DAC_Channel,
                                                              uint32_t TriggerSource)
{
  (((DACx->STMODR)) = ((((((DACx->STMODR))) & (~((0xFUL << (0U)) << (DAC_Channel & (0UL | 16UL))))) | (((TriggerSource >> (2U)) << (0U)) << (DAC_Channel & (0UL | 16UL))))));


}
# 1334 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline uint32_t LL_DAC_GetWaveSawtoothResetTriggerSource(DAC_TypeDef *DACx, uint32_t DAC_Channel)
{
  return (uint32_t)((((DACx->STMODR) & ((0xFUL << (0U)) << (DAC_Channel & (0UL | 16UL))))


                     >> ((0U) + (DAC_Channel & (0UL | 16UL)))
                    ) << (2U));
}
# 1384 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline void LL_DAC_SetWaveSawtoothStepTriggerSource(DAC_TypeDef *DACx, uint32_t DAC_Channel,
                                                             uint32_t TriggerSource)
{
  (((DACx->STMODR)) = ((((((DACx->STMODR))) & (~((0xFUL << (8U)) << (DAC_Channel & (0UL | 16UL))))) | (((TriggerSource >> (2U)) << (8U)) << (DAC_Channel & (0UL | 16UL))))));


}
# 1427 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline uint32_t LL_DAC_GetWaveSawtoothStepTriggerSource(DAC_TypeDef *DACx, uint32_t DAC_Channel)
{
  return (uint32_t)((((DACx->STMODR) & ((0xFUL << (8U)) << (DAC_Channel & (0UL | 16UL))))


                     >> ((8U) + (DAC_Channel & (0UL | 16UL)))
                    ) << (2U));
}
# 1483 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline void LL_DAC_ConfigOutput(DAC_TypeDef *DACx, uint32_t DAC_Channel, uint32_t OutputMode,
                                         uint32_t OutputBuffer, uint32_t OutputConnection)
{
  (((DACx->MCR)) = ((((((DACx->MCR))) & (~(((0x4UL << (0U)) | (0x2UL << (0U)) | (0x1UL << (0U))) << (DAC_Channel & (0UL | 16UL))))) | ((OutputMode | OutputBuffer | OutputConnection) << (DAC_Channel & (0UL | 16UL))))));


}
# 1514 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline void LL_DAC_SetOutputMode(DAC_TypeDef *DACx, uint32_t DAC_Channel, uint32_t OutputMode)
{
  (((DACx->MCR)) = ((((((DACx->MCR))) & (~((uint32_t)(0x4UL << (0U)) << (DAC_Channel & (0UL | 16UL))))) | (OutputMode << (DAC_Channel & (0UL | 16UL))))));


}
# 1536 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline uint32_t LL_DAC_GetOutputMode(DAC_TypeDef *DACx, uint32_t DAC_Channel)
{
  return (uint32_t)(((DACx->MCR) & ((uint32_t)(0x4UL << (0U)) << (DAC_Channel & (0UL | 16UL))))
                    >> (DAC_Channel & (0UL | 16UL))
                   );
}
# 1563 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline void LL_DAC_SetOutputBuffer(DAC_TypeDef *DACx, uint32_t DAC_Channel, uint32_t OutputBuffer)
{
  (((DACx->MCR)) = ((((((DACx->MCR))) & (~((uint32_t)(0x2UL << (0U)) << (DAC_Channel & (0UL | 16UL))))) | (OutputBuffer << (DAC_Channel & (0UL | 16UL))))));


}
# 1585 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline uint32_t LL_DAC_GetOutputBuffer(DAC_TypeDef *DACx, uint32_t DAC_Channel)
{
  return (uint32_t)(((DACx->MCR) & ((uint32_t)(0x2UL << (0U)) << (DAC_Channel & (0UL | 16UL))))
                    >> (DAC_Channel & (0UL | 16UL))
                   );
}
# 1618 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline void LL_DAC_SetOutputConnection(DAC_TypeDef *DACx, uint32_t DAC_Channel, uint32_t OutputConnection)
{
  (((DACx->MCR)) = ((((((DACx->MCR))) & (~((uint32_t)(0x1UL << (0U)) << (DAC_Channel & (0UL | 16UL))))) | (OutputConnection << (DAC_Channel & (0UL | 16UL))))));


}
# 1650 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline uint32_t LL_DAC_GetOutputConnection(DAC_TypeDef *DACx, uint32_t DAC_Channel)
{
  return (uint32_t)(((DACx->MCR) & ((uint32_t)(0x1UL << (0U)) << (DAC_Channel & (0UL | 16UL))))
                    >> (DAC_Channel & (0UL | 16UL))
                   );
}
# 1676 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline void LL_DAC_SetSampleAndHoldSampleTime(DAC_TypeDef *DACx, uint32_t DAC_Channel, uint32_t SampleTime)
{
  volatile uint32_t *preg = ((uint32_t *)((uint32_t) ((uint32_t)(&(DACx->SHSR1)) + (((DAC_Channel >> 6UL) & 0x00000001UL) << 2UL))));


  (((*preg)) = ((((((*preg))) & (~((0x3FFUL << (0U))))) | (SampleTime))));
}
# 1698 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline uint32_t LL_DAC_GetSampleAndHoldSampleTime(DAC_TypeDef *DACx, uint32_t DAC_Channel)
{
  volatile uint32_t const *preg = ((uint32_t *)((uint32_t) ((uint32_t)(&(DACx->SHSR1)) + (((DAC_Channel >> 6UL) & 0x00000001UL) << 2UL))));


  return (uint32_t) ((*preg) & ((0x3FFUL << (0U))));
}
# 1721 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline void LL_DAC_SetSampleAndHoldHoldTime(DAC_TypeDef *DACx, uint32_t DAC_Channel, uint32_t HoldTime)
{
  (((DACx->SHHR)) = ((((((DACx->SHHR))) & (~((0x3FFUL << (0U)) << (DAC_Channel & (0UL | 16UL))))) | (HoldTime << (DAC_Channel & (0UL | 16UL))))));


}
# 1742 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline uint32_t LL_DAC_GetSampleAndHoldHoldTime(DAC_TypeDef *DACx, uint32_t DAC_Channel)
{
  return (uint32_t)(((DACx->SHHR) & ((0x3FFUL << (0U)) << (DAC_Channel & (0UL | 16UL))))
                    >> (DAC_Channel & (0UL | 16UL))
                   );
}
# 1764 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline void LL_DAC_SetSampleAndHoldRefreshTime(DAC_TypeDef *DACx, uint32_t DAC_Channel, uint32_t RefreshTime)
{
  (((DACx->SHRR)) = ((((((DACx->SHRR))) & (~((0xFFUL << (0U)) << (DAC_Channel & (0UL | 16UL))))) | (RefreshTime << (DAC_Channel & (0UL | 16UL))))));


}
# 1785 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline uint32_t LL_DAC_GetSampleAndHoldRefreshTime(DAC_TypeDef *DACx, uint32_t DAC_Channel)
{
  return (uint32_t)(((DACx->SHRR) & ((0xFFUL << (0U)) << (DAC_Channel & (0UL | 16UL))))
                    >> (DAC_Channel & (0UL | 16UL))
                   );
}
# 1815 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline void LL_DAC_SetSignedFormat(DAC_TypeDef *DACx, uint32_t DAC_Channel, uint32_t SignedFormat)
{
  (((DACx->MCR)) = ((((((DACx->MCR))) & (~((0x1UL << (9U)) << (DAC_Channel & (0UL | 16UL))))) | (SignedFormat << (DAC_Channel & (0UL | 16UL))))));


}
# 1837 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline uint32_t LL_DAC_GetSignedFormat(DAC_TypeDef *DACx, uint32_t DAC_Channel)
{
  return (uint32_t)(((DACx->MCR) & ((0x1UL << (9U)) << (DAC_Channel & (0UL | 16UL))))
                    >> (DAC_Channel & (0UL | 16UL))
                   );
}
# 1867 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline void LL_DAC_EnableDMAReq(DAC_TypeDef *DACx, uint32_t DAC_Channel)
{
  ((DACx->CR) |= ((0x1UL << (12U)) << (DAC_Channel & (0UL | 16UL))));

}
# 1888 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline void LL_DAC_DisableDMAReq(DAC_TypeDef *DACx, uint32_t DAC_Channel)
{
  ((DACx->CR) &= ~((0x1UL << (12U)) << (DAC_Channel & (0UL | 16UL))));

}
# 1908 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline uint32_t LL_DAC_IsDMAReqEnabled(DAC_TypeDef *DACx, uint32_t DAC_Channel)
{
  return ((((DACx->CR) & ((0x1UL << (12U)) << (DAC_Channel & (0UL | 16UL))))

           == ((0x1UL << (12U)) << (DAC_Channel & (0UL | 16UL)))) ? 1UL : 0UL);
}
# 1928 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline void LL_DAC_EnableDMADoubleDataMode(DAC_TypeDef *DACx, uint32_t DAC_Channel)
{
  ((DACx->MCR) |= ((0x1UL << (8U)) << (DAC_Channel & (0UL | 16UL))));

}
# 1947 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline void LL_DAC_DisableDMADoubleDataMode(DAC_TypeDef *DACx, uint32_t DAC_Channel)
{
  ((DACx->MCR) &= ~((0x1UL << (8U)) << (DAC_Channel & (0UL | 16UL))));

}
# 1967 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline uint32_t LL_DAC_IsDMADoubleDataModeEnabled(DAC_TypeDef *DACx, uint32_t DAC_Channel)
{
  return ((((DACx->MCR) & ((0x1UL << (8U)) << (DAC_Channel & (0UL | 16UL))))

           == ((0x1UL << (8U)) << (DAC_Channel & (0UL | 16UL)))) ? 1UL : 0UL);
}
# 2009 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline uint32_t LL_DAC_DMA_GetRegAddr(DAC_TypeDef *DACx, uint32_t DAC_Channel, uint32_t Register)
{
...
# 2040 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline void LL_DAC_Enable(DAC_TypeDef *DACx, uint32_t DAC_Channel)
{
  ((DACx->CR) |= ((0x1UL << (0U)) << (DAC_Channel & (0UL | 16UL))));

}
# 2059 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline void LL_DAC_Disable(DAC_TypeDef *DACx, uint32_t DAC_Channel)
{
  ((DACx->CR) &= ~((0x1UL << (0U)) << (DAC_Channel & (0UL | 16UL))));

}
# 2079 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline uint32_t LL_DAC_IsEnabled(DAC_TypeDef *DACx, uint32_t DAC_Channel)
{
  return ((((DACx->CR) & ((0x1UL << (0U)) << (DAC_Channel & (0UL | 16UL))))

           == ((0x1UL << (0U)) << (DAC_Channel & (0UL | 16UL)))) ? 1UL : 0UL);
}
# 2100 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline uint32_t LL_DAC_IsReady(DAC_TypeDef *DACx, uint32_t DAC_Channel)
{
  return ((((DACx->SR) & ((0x1UL << (11U)) << (DAC_Channel & (0UL | 16UL))))

           == ((0x1UL << (11U)) << (DAC_Channel & (0UL | 16UL)))) ? 1UL : 0UL);
}
# 2128 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline void LL_DAC_EnableTrigger(DAC_TypeDef *DACx, uint32_t DAC_Channel)
{
  ((DACx->CR) |= ((0x1UL << (1U)) << (DAC_Channel & (0UL | 16UL))));

}
# 2147 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline void LL_DAC_DisableTrigger(DAC_TypeDef *DACx, uint32_t DAC_Channel)
{
  ((DACx->CR) &= ~((0x1UL << (1U)) << (DAC_Channel & (0UL | 16UL))));

}
# 2167 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline uint32_t LL_DAC_IsTriggerEnabled(DAC_TypeDef *DACx, uint32_t DAC_Channel)
{
  return ((((DACx->CR) & ((0x1UL << (1U)) << (DAC_Channel & (0UL | 16UL))))

           == ((0x1UL << (1U)) << (DAC_Channel & (0UL | 16UL)))) ? 1UL : 0UL);
}
# 2201 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline void LL_DAC_TrigSWConversion(DAC_TypeDef *DACx, uint32_t DAC_Channel)
{
  ((DACx->SWTRIGR) |= ((DAC_Channel & (((0x1UL << (0U))) | ((0x1UL << (1U)))))));

}
# 2233 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline void LL_DAC_TrigSWConversion2(DAC_TypeDef *DACx, uint32_t DAC_Channel)
{
  ((DACx->SWTRIGR) |= ((DAC_Channel & (((0x1UL << (16U))) | ((0x1UL << (17U)))))));

}
# 2255 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline void LL_DAC_ConvertData12RightAligned(DAC_TypeDef *DACx, uint32_t DAC_Channel, uint32_t Data)
{
  volatile uint32_t *preg = ((uint32_t *)((uint32_t) ((uint32_t)(&(DACx->DHR12R1)) + (((DAC_Channel >> 28UL) & 0x0000000FUL) << 2UL))));


  (((*preg)) = ((((((*preg))) & (~((0xFFFUL << (0U))))) | (Data))));
}
# 2279 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline void LL_DAC_ConvertData12LeftAligned(DAC_TypeDef *DACx, uint32_t DAC_Channel, uint32_t Data)
{
...
# 2303 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline void LL_DAC_ConvertData8RightAligned(DAC_TypeDef *DACx, uint32_t DAC_Channel, uint32_t Data)
{
...
# 2323 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline void LL_DAC_ConvertDualData12RightAligned(DAC_TypeDef *DACx, uint32_t DataChannel1,
...
# 2342 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline void LL_DAC_ConvertDualData12LeftAligned(DAC_TypeDef *DACx, uint32_t DataChannel1,
                                                         uint32_t DataChannel2)
{
...
# 2364 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline void LL_DAC_ConvertDualData8RightAligned(DAC_TypeDef *DACx, uint32_t DataChannel1,
                                                         uint32_t DataChannel2)
{
...
# 2390 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline uint32_t LL_DAC_RetrieveOutputData(DAC_TypeDef *DACx, uint32_t DAC_Channel)
{
  volatile uint32_t const *preg = ((uint32_t *)((uint32_t) ((uint32_t)(&(DACx->DOR1)) + (((DAC_Channel >> 5UL) & 0x00000001UL) << 2UL))));


  return (uint16_t) ((*preg) & ((0xFFFUL << (0U))));
}
# 2412 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline uint32_t LL_DAC_IsActiveFlag_CAL1(DAC_TypeDef *DACx)
{
  return ((((DACx->SR) & (((0x1UL << (14U))))) == (((0x1UL << (14U))))) ? 1UL : 0UL);
}
# 2424 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline uint32_t LL_DAC_IsActiveFlag_CAL2(DAC_TypeDef *DACx)
{
  return ((((DACx->SR) & (((0x1UL << (30U))))) == (((0x1UL << (30U))))) ? 1UL : 0UL);
}
# 2436 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline uint32_t LL_DAC_IsActiveFlag_BWST1(DAC_TypeDef *DACx)
{
  return ((((DACx->SR) & (((0x1UL << (15U))))) == (((0x1UL << (15U))))) ? 1UL : 0UL);
}
...
static __inline uint32_t LL_DAC_IsActiveFlag_BWST2(DAC_TypeDef *DACx)
{
  return ((((DACx->SR) & (((0x1UL << (31U))))) == (((0x1UL << (31U))))) ? 1UL : 0UL);
}
# 2459 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline uint32_t LL_DAC_IsActiveFlag_DAC1RDY(DAC_TypeDef *DACx)
{
  return ((((DACx->SR) & (((0x1UL << (11U))))) == (((0x1UL << (11U))))) ? 1UL : 0UL);
}
# 2471 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline uint32_t LL_DAC_IsActiveFlag_DAC2RDY(DAC_TypeDef *DACx)
{
  return ((((DACx->SR) & (((0x1UL << (27U))))) == (((0x1UL << (27U))))) ? 1UL : 0UL);
}
# 2483 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline uint32_t LL_DAC_IsActiveFlag_DORSTAT1(DAC_TypeDef *DACx)
{
  return ((((DACx->SR) & (((0x1UL << (12U))))) == (((0x1UL << (12U))))) ? 1UL : 0UL);
}
# 2495 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline uint32_t LL_DAC_IsActiveFlag_DORSTAT2(DAC_TypeDef *DACx)
{
  return ((((DACx->SR) & (((0x1UL << (28U))))) == (((0x1UL << (28U))))) ? 1UL : 0UL);
}
...
static __inline uint32_t LL_DAC_IsActiveFlag_DMAUDR1(DAC_TypeDef *DACx)
{
  return ((((DACx->SR) & (((0x1UL << (13U))))) == (((0x1UL << (13U))))) ? 1UL : 0UL);
}
# 2518 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline uint32_t LL_DAC_IsActiveFlag_DMAUDR2(DAC_TypeDef *DACx)
{
  return ((((DACx->SR) & (((0x1UL << (29U))))) == (((0x1UL << (29U))))) ? 1UL : 0UL);
}
# 2530 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline void LL_DAC_ClearFlag_DMAUDR1(DAC_TypeDef *DACx)
{
  ((DACx->SR) = (((0x1UL << (13U)))));
}
# 2542 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline void LL_DAC_ClearFlag_DMAUDR2(DAC_TypeDef *DACx)
{
  ((DACx->SR) = (((0x1UL << (29U)))));
}
# 2562 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline void LL_DAC_EnableIT_DMAUDR1(DAC_TypeDef *DACx)
{
  ((DACx->CR) |= (((0x1UL << (13U)))));
}
# 2574 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline void LL_DAC_EnableIT_DMAUDR2(DAC_TypeDef *DACx)
{
  ((DACx->CR) |= (((0x1UL << (29U)))));
}
# 2586 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline void LL_DAC_DisableIT_DMAUDR1(DAC_TypeDef *DACx)
{
  ((DACx->CR) &= ~(((0x1UL << (13U)))));
}
# 2598 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline void LL_DAC_DisableIT_DMAUDR2(DAC_TypeDef *DACx)
{
  ((DACx->CR) &= ~(((0x1UL << (29U)))));
}
# 2610 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline uint32_t LL_DAC_IsEnabledIT_DMAUDR1(DAC_TypeDef *DACx)
{
  return ((((DACx->CR) & (((0x1UL << (13U))))) == (((0x1UL << (13U))))) ? 1UL : 0UL);
}
# 2622 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
static __inline uint32_t LL_DAC_IsEnabledIT_DMAUDR2(DAC_TypeDef *DACx)
{
  return ((((DACx->CR) & (((0x1UL << (29U))))) == (((0x1UL << (29U))))) ? 1UL : 0UL);
}
# 2637 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_dac.h"
ErrorStatus LL_DAC_DeInit(DAC_TypeDef *DACx);
ErrorStatus LL_DAC_Init(DAC_TypeDef *DACx, uint32_t DAC_Channel, LL_DAC_InitTypeDef *DAC_InitStruct);
void LL_DAC_StructInit(LL_DAC_InitTypeDef *DAC_InitStruct);
# 22 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_dac.c" 2
...
# 23 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_dac.c" 2
# 215 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_dac.c"
ErrorStatus LL_DAC_DeInit(DAC_TypeDef *DACx)
{
  ...
  if (DACx == ((DAC_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x08000800UL)))
  {

    LL_AHB2_GRP1_ForceReset((0x1UL << (16U)));


    LL_AHB2_GRP1_ReleaseReset((0x1UL << (16U)));
  }
# 241 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_dac.c"
  if (DACx == ((DAC_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x08001000UL)))
  {

    LL_AHB2_GRP1_ForceReset((0x1UL << (18U)));


    LL_AHB2_GRP1_ReleaseReset((0x1UL << (18U)));
  }
# 261 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_dac.c"
  return SUCCESS;
}
# 292 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_dac.c"
ErrorStatus LL_DAC_Init(DAC_TypeDef *DACx, uint32_t DAC_Channel, LL_DAC_InitTypeDef *DAC_InitStruct)
{
  ...
  ((void)0U);
  ((void)0U);
  if (DAC_InitStruct->WaveAutoGeneration != 0x00000000UL)
  {
    ((void)0U);
  ...
  if (LL_DAC_IsEnabled(DACx, DAC_Channel) == 0UL)
  {
    ...
    if (DAC_InitStruct->WaveAutoGeneration != 0x00000000UL)
    {
      if (DAC_InitStruct->WaveAutoGeneration == ((0x2UL << (6U))|(0x1UL << (6U))))
      {
        ((void)0U);

        (((DACx->CR)) = ((((((DACx->CR))) & (~((0x3UL << (6U)) << (DAC_Channel & (0UL | 16UL))))) | (DAC_InitStruct->WaveAutoGeneration << (DAC_Channel & (0UL | 16UL))))));



        (((DACx->STMODR)) = ((((((DACx->STMODR))) & (~(((0xFUL << (8U)) | (0xFUL << (0U))) << (DAC_Channel & (0UL | 16UL))))) | (( ((DAC_InitStruct->TriggerSource >> (2U)) << (0U)) | ((DAC_InitStruct->TriggerSource2 >> (2U)) << (8U)) ) << (DAC_Channel & (0UL | 16UL))))));
        ...
        ((*(((uint32_t *)((uint32_t) ((uint32_t)(&(DACx->STR1)) + (((DAC_Channel >> 7UL) & 0x00000001UL) << 2UL)))))) = (DAC_InitStruct->WaveAutoGenerationConfig));

      }
      else
      {
        (((DACx->CR)) = ((((((DACx->CR))) & (~(((0xFUL << (2U)) | (0x3UL << (6U)) | (0xFUL << (8U)) ) << (DAC_Channel & (0UL | 16UL))))) | ((DAC_InitStruct->TriggerSource | DAC_InitStruct->WaveAutoGeneration | DAC_InitStruct->WaveAutoGenerationConfig ) << (DAC_Channel & (0UL | 16UL))))));
# 353 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_dac.c"
      }
    }
    else
    {
      (((DACx->CR)) = ((((((DACx->CR))) & (~(((0xFUL << (2U)) | (0x3UL << (6U)) ) << (DAC_Channel & (0UL | 16UL))))) | ((DAC_InitStruct->TriggerSource | 0x00000000UL ) << (DAC_Channel & (0UL | 16UL))))));
# 366 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_dac.c"
    }
    (((DACx->MCR)) = ((((((DACx->MCR))) & (~(((0x2UL << (0U)) | (0x1UL << (0U)) | (0x4UL << (0U)) ) << (DAC_Channel & (0UL | 16UL))))) | ((DAC_InitStruct->OutputBuffer | DAC_InitStruct->OutputConnection | DAC_InitStruct->OutputMode ) << (DAC_Channel & (0UL | 16UL))))));
# 378 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_dac.c"
  }
  else
  {
...
void LL_DAC_StructInit(LL_DAC_InitTypeDef *DAC_InitStruct)
{
  ...
  DAC_InitStruct->TriggerSource = 0x00000000UL;
  DAC_InitStruct->TriggerSource2 = 0x00000000UL;
  DAC_InitStruct->WaveAutoGeneration = 0x00000000UL;


  DAC_InitStruct->WaveAutoGenerationConfig = 0x00000000UL;
  DAC_InitStruct->OutputBuffer = 0x00000000UL;
  DAC_InitStruct->OutputConnection = 0x00000000UL;
  DAC_InitStruct->OutputMode = 0x00000000UL;
}
