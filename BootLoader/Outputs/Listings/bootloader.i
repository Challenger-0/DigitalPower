# 1 "Util/BootLoader.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 415 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "Util/BootLoader.cpp" 2
# 1 "Util/BootLoader.hpp" 1
...
# 2 "Util/BootLoader.cpp" 2
# 1 ".\\Onboards/Onboards.hpp" 1


# 1 ".\\Onboards/ST7735.hpp" 1
...
# 4 ".\\Onboards/ST7735.hpp" 2
# 1 "./Components/Graphics\\GraphicsDevice.hpp" 1
...
# 4 ".\\Onboards/Onboards.hpp" 2
# 1 ".\\Components/Graphics/Graphics.hpp" 1




# 1 "./Components/Graphics/Basic/GraphicsFunction.hpp" 1
...
# 4 "./Components/Graphics/Basic/GraphicsFunction.hpp" 2
...
namespace Graphics {
# 18 "./Components/Graphics/Basic/GraphicsFunction.hpp"
...
# 6 ".\\Components/Graphics/Graphics.hpp" 2
...
# 1 "./Components/Graphics/Graphics.ipp" 1
...
# 7 "./Components/Graphics/Graphics.ipp" 2
...
# 100 "./Components/Graphics/Graphics.ipp"
}
# 45 "./Components/Graphics/Graphics.hpp" 2
# 5 ".\\Onboards/Onboards.hpp" 2
# 1 ".\\Onboards/WS2812.hpp" 1




# 1 ".\\BSP/TimerChannel.hpp" 1
...
# 6 ".\\Onboards/Onboards.hpp" 2
# 1 ".\\Onboards/Button.hpp" 1
...
# 7 ".\\Onboards/Onboards.hpp" 2
# 1 ".\\Onboards/Beep.hpp" 1
...
# 3 "Util/BootLoader.cpp" 2
# 1 "./CubeMX/Core/Inc\\rtc.h" 1
# 25 "./CubeMX/Core/Inc\\rtc.h"
extern "C" {



# 1 "./CubeMX/Core/Inc/main.h" 1
# 26 "./CubeMX/Core/Inc/main.h"
extern "C" {
# 53 "./CubeMX/Core/Inc/main.h"
void Error_Handler(void);
# 78 "./CubeMX/Core/Inc/main.h"
}
# 30 "./CubeMX/Core/Inc\\rtc.h" 2
...
void BootLoader::resetAllPeriph(void) {
    ...
    ((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB1RSTR1 = 0xFFFFFFFF;
    ((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB1RSTR2 = 0xFFFFFFFF;
    ((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB2RSTR = 0xFFFFFFFF;
    ((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB1RSTR = 0xFFFFFFFF;
    ((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB2RSTR = 0xFFFFFFFF;
    ((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB3RSTR = 0xFFFFFFFF;
    ((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB1RSTR1 = 0u;
    ((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB1RSTR2 = 0u;
    ((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB2RSTR = 0u;
    ((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB1RSTR = 0u;
    ((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB2RSTR = 0u;
    ((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB3RSTR = 0u;

    ((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB1ENR1 = 0u;
    ((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB1ENR2 = 0u;
    ((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB2ENR = 0u;
    ((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB1ENR = 0u;
    ((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB2ENR = 0u;
    ((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB3ENR = 0u;
}
