...
TimerChannelDMA BSP::ws2812TimerChannel(BSP::ws2812Timer, 0x00000004U);
Timer BSP::beepAmpTimer(&htim17);
TimerChannel BSP::beepAmpTimerChannel(BSP::beepAmpTimer, 0x00000000U);
Timer BSP::beepFreqTimer(&htim3);
TimerChannel BSP::beepFreqTimerChannel(BSP::beepFreqTimer, 0x00000000U);
