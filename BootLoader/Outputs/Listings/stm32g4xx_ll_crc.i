# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_crc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_crc.c" 2
# 21 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_crc.c"
# 1 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_crc.h" 1
# 28 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_crc.h"
...
# 29 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_crc.h" 2
# 156 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_crc.h"
static __inline void LL_CRC_ResetCRCCalculationUnit(CRC_TypeDef *CRCx)
{
  ((CRCx->CR) |= ((0x1UL << (0U))));
}
# 172 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_crc.h"
static __inline void LL_CRC_SetPolynomialSize(CRC_TypeDef *CRCx, uint32_t PolySize)
{
  (((CRCx->CR)) = ((((((CRCx->CR))) & (~((0x3UL << (3U))))) | (PolySize))));
}
# 187 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_crc.h"
static __inline uint32_t LL_CRC_GetPolynomialSize(CRC_TypeDef *CRCx)
{
  return (uint32_t)(((CRCx->CR) & ((0x3UL << (3U)))));
}
# 203 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_crc.h"
static __inline void LL_CRC_SetInputDataReverseMode(CRC_TypeDef *CRCx, uint32_t ReverseMode)
{
  (((CRCx->CR)) = ((((((CRCx->CR))) & (~((0x3UL << (5U))))) | (ReverseMode))));
}
# 218 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_crc.h"
static __inline uint32_t LL_CRC_GetInputDataReverseMode(CRC_TypeDef *CRCx)
{
  return (uint32_t)(((CRCx->CR) & ((0x3UL << (5U)))));
}
# 232 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_crc.h"
static __inline void LL_CRC_SetOutputDataReverseMode(CRC_TypeDef *CRCx, uint32_t ReverseMode)
{
  (((CRCx->CR)) = ((((((CRCx->CR))) & (~((0x1UL << (7U))))) | (ReverseMode))));
}
# 245 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_crc.h"
static __inline uint32_t LL_CRC_GetOutputDataReverseMode(CRC_TypeDef *CRCx)
{
  return (uint32_t)(((CRCx->CR) & ((0x1UL << (7U)))));
}
# 260 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_crc.h"
static __inline void LL_CRC_SetInitialData(CRC_TypeDef *CRCx, uint32_t InitCrc)
{
  ((CRCx->INIT) = (InitCrc));
}
# 273 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_crc.h"
static __inline uint32_t LL_CRC_GetInitialData(CRC_TypeDef *CRCx)
{
  return (uint32_t)(((CRCx->INIT)));
}
# 290 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_crc.h"
static __inline void LL_CRC_SetPolynomialCoef(CRC_TypeDef *CRCx, uint32_t PolynomCoef)
{
  ((CRCx->POL) = (PolynomCoef));
}
# 304 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_crc.h"
static __inline uint32_t LL_CRC_GetPolynomialCoef(CRC_TypeDef *CRCx)
{
  return (uint32_t)(((CRCx->POL)));
}
# 324 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_crc.h"
static __inline void LL_CRC_FeedData32(CRC_TypeDef *CRCx, uint32_t InData)
{
  ((CRCx->DR) = (InData));
}
# 336 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_crc.h"
static __inline void LL_CRC_FeedData16(CRC_TypeDef *CRCx, uint16_t InData)
{
...
# 351 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_crc.h"
static __inline void LL_CRC_FeedData8(CRC_TypeDef *CRCx, uint8_t InData)
{
...
static __inline uint32_t LL_CRC_ReadData32(CRC_TypeDef *CRCx)
{
  return (uint32_t)(((CRCx->DR)));
}
# 374 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_crc.h"
static __inline uint16_t LL_CRC_ReadData16(CRC_TypeDef *CRCx)
{
  return (uint16_t)((CRCx->DR));
}
# 386 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_crc.h"
static __inline uint8_t LL_CRC_ReadData8(CRC_TypeDef *CRCx)
{
  return (uint8_t)((CRCx->DR));
}
# 398 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_crc.h"
static __inline uint8_t LL_CRC_ReadData7(CRC_TypeDef *CRCx)
{
  return (uint8_t)(((CRCx->DR)) & 0x7FU);
}
# 410 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_crc.h"
static __inline uint32_t LL_CRC_Read_IDR(CRC_TypeDef *CRCx)
{
  return (uint32_t)(((CRCx->IDR)));
}
# 423 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_crc.h"
static __inline void LL_CRC_Write_IDR(CRC_TypeDef *CRCx, uint32_t InData)
{
  *((uint32_t volatile *)(&CRCx->IDR)) = (uint32_t) InData;
}
# 436 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_crc.h"
ErrorStatus LL_CRC_DeInit(CRC_TypeDef *CRCx);
# 22 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_crc.c" 2
...
# 23 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_crc.c" 2
# 62 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_crc.c"
ErrorStatus LL_CRC_DeInit(CRC_TypeDef *CRCx)
{
  ...
  if (CRCx == ((CRC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x3000UL)))
  {

    LL_AHB1_GRP1_ForceReset((0x1UL << (12U)));


    LL_AHB1_GRP1_ReleaseReset((0x1UL << (12U)));
  }
  else
  {
    status = ERROR;
