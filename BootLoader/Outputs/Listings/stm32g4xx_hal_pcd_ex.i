# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_pcd_ex.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_pcd_ex.c" 2
# 24 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_pcd_ex.c"
...
# 25 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_pcd_ex.c" 2
# 80 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_pcd_ex.c"
HAL_StatusTypeDef HAL_PCDEx_PMAConfig(PCD_HandleTypeDef *hpcd, uint16_t ep_addr,
                                       uint16_t ep_kind, uint32_t pmaadress)
{
  PCD_EPTypeDef *ep;
...
HAL_StatusTypeDef HAL_PCDEx_ActivateBCD(PCD_HandleTypeDef *hpcd)
{
  ...
  USBx->BCDR |= ((uint16_t)0x0001U);


  USBx->BCDR &= ~(((uint16_t)0x0004U));
  USBx->BCDR &= ~(((uint16_t)0x0008U));
  USBx->BCDR |= ((uint16_t)0x0002U);
...
void HAL_PCDEx_BCD_VBUSDetect(PCD_HandleTypeDef *hpcd)
{
  ...
  while ((USBx->BCDR & ((uint16_t)0x0010U)) == 0U)
  {
  ...
  if ((USBx->BCDR & ((uint16_t)0x0010U)) == ((uint16_t)0x0010U))
  {
  ...
  if ((USBx->BCDR & ((uint16_t)0x0020U)) == ((uint16_t)0x0020U))
  {
    ...
    if ((USBx->BCDR & ((uint16_t)0x0040U)) == ((uint16_t)0x0040U))
    {
...
HAL_StatusTypeDef HAL_PCDEx_ActivateLPM(PCD_HandleTypeDef *hpcd)
{
  ...
  USBx->LPMCSR |= ((uint16_t)0x0001U);
  USBx->LPMCSR |= ((uint16_t)0x0002U);
...
# 291 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_pcd_ex.c"
__attribute__((weak)) void HAL_PCDEx_LPM_Callback(PCD_HandleTypeDef *hpcd, PCD_LPM_MsgTypeDef msg)
{
...
__attribute__((weak)) void HAL_PCDEx_BCD_Callback(PCD_HandleTypeDef *hpcd, PCD_BCD_MsgTypeDef msg)
{
