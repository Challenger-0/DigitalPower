# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_dma_ex.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_dma_ex.c" 2
# 43 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_dma_ex.c"
...
# 44 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_dma_ex.c" 2
# 95 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_dma_ex.c"
HAL_StatusTypeDef HAL_DMAEx_ConfigMuxSync(DMA_HandleTypeDef *hdma, HAL_DMA_MuxSyncConfigTypeDef *pSyncConfig)
{
  ...
  if (hdma->State == HAL_DMA_STATE_READY)
  {
    ...
    (((hdma->DMAmuxChannel->CCR)) = ((((((hdma->DMAmuxChannel->CCR))) & (~((~(0xFFUL << (0U)))))) | (((pSyncConfig->SyncSignalID) << (24U)) | ((pSyncConfig->RequestNumber - 1U) << (19U)) | pSyncConfig->SyncPolarity | ((uint32_t)pSyncConfig->SyncEnable << (16U)) | ((uint32_t)pSyncConfig->EventEnable << (9U))))));
...
# 141 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_dma_ex.c"
HAL_StatusTypeDef HAL_DMAEx_ConfigMuxRequestGenerator(DMA_HandleTypeDef *hdma,
                                                      HAL_DMA_MuxRequestGeneratorConfigTypeDef *pRequestGeneratorConfig)
{
  ...
  if ((hdma->State == HAL_DMA_STATE_READY) && (hdma->DMAmuxRequestGen != 0U))
  {
    ...
    hdma->DMAmuxRequestGen->RGCR = pRequestGeneratorConfig->SignalID | ((pRequestGeneratorConfig->RequestNumber - 1U) << ((__CLZ(__builtin_arm_rbit((0x1FUL << (19U))))) & 0x1FU)) | pRequestGeneratorConfig->Polarity;
...
HAL_StatusTypeDef HAL_DMAEx_EnableMuxRequestGenerator(DMA_HandleTypeDef *hdma)
{
  ...
  if ((hdma->State != HAL_DMA_STATE_RESET) && (hdma->DMAmuxRequestGen != 0))
  {
    ...
    hdma->DMAmuxRequestGen->RGCR |= (0x1UL << (16U));
