# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_exti.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_exti.c" 2
# 87 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_exti.c"
...
# 88 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_exti.c" 2
# 144 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_exti.c"
HAL_StatusTypeDef HAL_EXTI_SetConfigLine(EXTI_HandleTypeDef *hexti, EXTI_ConfigTypeDef *pExtiConfig)
{
  ...
  offset = ((pExtiConfig->Line & ((0x00uL << 16U) | (0x01uL << 16U))) >> 16U);
  ...
  if ((pExtiConfig->Line & (0x02uL << 24U)) != 0x00u)
  {
    ...
    regaddr = (&((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->RTSR1 + (0x08U * offset));
    regval = *regaddr;
    ...
    *regaddr = regval;
    ...
    regaddr = (&((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->FTSR1 + (0x08U * offset));
    regval = *regaddr;
    ...
    *regaddr = regval;
    ...
    if ((pExtiConfig->Line & ((0x04uL << 24U) | (0x02uL << 24U))) == ((0x04uL << 24U) | (0x02uL << 24U)))
    {
      ...
      regval = ((SYSCFG_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0000UL))->EXTICR[linepos >> 2u];
      regval &= ~((0x7UL << (0U)) << ((4U) * (linepos & 0x03u)));
      regval |= (pExtiConfig->GPIOSel << ((4U) * (linepos & 0x03u)));
      ((SYSCFG_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0000UL))->EXTICR[linepos >> 2u] = regval;
    }
  }


  regaddr = (&((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->IMR1 + (0x08U * offset));
  regval = *regaddr;
  ...
  *regaddr = regval;
  ...
  regaddr = (&((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->EMR1 + (0x08U * offset));
  regval = *regaddr;
...
# 268 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_exti.c"
HAL_StatusTypeDef HAL_EXTI_GetConfigLine(EXTI_HandleTypeDef *hexti, EXTI_ConfigTypeDef *pExtiConfig)
{
  volatile uint32_t *regaddr;
  uint32_t regval;
  ...
  if ((pExtiConfig->Line & (0x02uL << 24U)) != 0x00u)
  {
    ...
    if ((pExtiConfig->Line & ((0x04uL << 24U) | (0x02uL << 24U))) == ((0x04uL << 24U) | (0x02uL << 24U)))
    {
      ...
      regval = ((SYSCFG_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0000UL))->EXTICR[linepos >> 2u];
      pExtiConfig->GPIOSel = ((regval >> ((4U) * ((linepos & 0x03u)))));
    }
  }
...
HAL_StatusTypeDef HAL_EXTI_ClearConfigLine(EXTI_HandleTypeDef *hexti)
{
  ...
  offset = ((hexti->Line & ((0x00uL << 16U) | (0x01uL << 16U))) >> 16U);
...
# 432 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_exti.c"
HAL_StatusTypeDef HAL_EXTI_RegisterCallback(EXTI_HandleTypeDef *hexti, EXTI_CallbackIDTypeDef CallbackID, void (*pPendingCbfn)(void))
{
...
# 463 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_exti.c"
HAL_StatusTypeDef HAL_EXTI_GetHandle(EXTI_HandleTypeDef *hexti, uint32_t ExtiLine)
{
...
# 504 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_exti.c"
void HAL_EXTI_IRQHandler(EXTI_HandleTypeDef *hexti)
{
  volatile uint32_t *regaddr;
  uint32_t regval;
  ...
  regaddr = (&((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->PR1 + (0x08U * offset));
  regval = (*regaddr & maskline);
...
# 574 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_exti.c"
void HAL_EXTI_ClearPending(EXTI_HandleTypeDef *hexti, uint32_t Edge)
{
  volatile uint32_t *regaddr;
  uint32_t maskline;
...
void HAL_EXTI_GenerateSWI(EXTI_HandleTypeDef *hexti)
{
  ...
  regaddr = (&((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->SWIER1 + (0x08U * offset));
  *regaddr = maskline;
}
