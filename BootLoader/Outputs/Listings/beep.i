...
# 2 "Onboards/Beep.cpp" 2

void Beep::onFreqChannelUpdate() {
    currentPlaying.remainTimes--;
    ampChannel.setCompare(calcAmpChannelCompare());
...
void Beep::configForCurrentNote() {
    ...
    freqChannel.setCompare((freqChannel.getTimer().getAutoReload() + 1) / 2);
    currentPlaying.totalTimes = currentPlaying.remainTimes = note.freq * note.duration / 1000;
    float noteAmp;
