# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_pwr.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_pwr.c" 2
# 25 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_pwr.c"
...
# 26 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_pwr.c" 2
# 86 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_pwr.c"
void HAL_PWR_DeInit(void)
{
  ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB1RSTR1) |= ((0x1UL << (28U))));
  ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB1RSTR1) &= ~((0x1UL << (28U))));
}
# 104 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_pwr.c"
void HAL_PWR_EnableBkUpAccess(void)
{
...
# 308 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_pwr.c"
HAL_StatusTypeDef HAL_PWR_ConfigPVD(PWR_PVDTypeDef *sConfigPVD)
{
  ...
  (((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->CR2)) = ((((((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->CR2))) & (~((0x7UL << (1U))))) | (sConfigPVD->PVDLevel))));


  ((((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->EMR1) &= ~(((uint32_t)0x00010000)));
  ((((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->IMR1) &= ~(((uint32_t)0x00010000)));
  ((((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->FTSR1) &= ~(((uint32_t)0x00010000)));
  ((((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->RTSR1) &= ~(((uint32_t)0x00010000)));


  if((sConfigPVD->Mode & ((uint32_t)0x00010000)) == ((uint32_t)0x00010000))
  {
    ((((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->IMR1) |= (((uint32_t)0x00010000)));
  }


  if((sConfigPVD->Mode & ((uint32_t)0x00020000)) == ((uint32_t)0x00020000))
  {
    ((((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->EMR1) |= (((uint32_t)0x00010000)));
  }


  if((sConfigPVD->Mode & ((uint32_t)0x00000001)) == ((uint32_t)0x00000001))
  {
    ((((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->RTSR1) |= (((uint32_t)0x00010000)));
  }

  if((sConfigPVD->Mode & ((uint32_t)0x00000002)) == ((uint32_t)0x00000002))
  {
    ((((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->FTSR1) |= (((uint32_t)0x00010000)));
  }
...
# 388 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_pwr.c"
void HAL_PWR_EnableWakeUpPin(uint32_t WakeUpPinPolarity)
{
  ((void)0U);
  ...
  (((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->CR4)) = ((((((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->CR4))) & (~(((0x1FUL << (0U)) & WakeUpPinPolarity)))) | ((WakeUpPinPolarity >> 0x05U)))));


  ((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->CR3) |= (((0x1FUL << (0U)) & WakeUpPinPolarity)));


}
# 409 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_pwr.c"
void HAL_PWR_DisableWakeUpPin(uint32_t WakeUpPinx)
{
  ((void)0U);

  ((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->CR3) &= ~(((0x1FUL << (0U)) & WakeUpPinx)));
}
# 441 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_pwr.c"
void HAL_PWR_EnterSLEEPMode(uint32_t Regulator, uint8_t SLEEPEntry)
{
  ...
  if (Regulator == ((uint32_t)0x00000000))
  {
  ...
  else
  {
    ...
    if ((((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->SR2) & ((0x1UL << (9U)))) == ((0x1UL << (9U)))) == 0U)
    {
...
# 516 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_pwr.c"
void HAL_PWR_EnterSTOPMode(uint32_t Regulator, uint8_t STOPEntry)
{

  ((void)0U);

  if(Regulator == (0x1UL << (14U)))
  {
...
# 549 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_pwr.c"
void HAL_PWR_EnterSTANDBYMode(void)
{

  (((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->CR1)) = ((((((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->CR1))) & (~((0x7UL << (0U))))) | ((0x3UL << (0U))))));
...
# 575 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_pwr.c"
void HAL_PWR_EnableSleepOnExit(void)
{

  ((((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR) |= (((uint32_t)(1UL << 1U))));
}
# 588 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_pwr.c"
void HAL_PWR_DisableSleepOnExit(void)
{

  ((((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR) &= ~(((uint32_t)(1UL << 1U))));
}
# 602 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_pwr.c"
void HAL_PWR_EnableSEVOnPend(void)
{

  ((((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR) |= (((uint32_t)(1UL << 4U))));
}
# 615 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_pwr.c"
void HAL_PWR_DisableSEVOnPend(void)
{

  ((((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR) &= ~(((uint32_t)(1UL << 4U))));
}
# 629 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_pwr.c"
