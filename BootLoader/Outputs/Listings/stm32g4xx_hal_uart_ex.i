# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_uart_ex.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_uart_ex.c" 2
# 44 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_uart_ex.c"
...
# 45 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_uart_ex.c" 2
# 77 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_uart_ex.c"
static void UARTEx_Wakeup_AddressConfig(UART_HandleTypeDef *huart, UART_WakeUpTypeDef WakeUpSelection);
static void UARTEx_SetNbDataToProcess(UART_HandleTypeDef *huart);
# 166 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_uart_ex.c"
HAL_StatusTypeDef HAL_RS485Ex_Init(UART_HandleTypeDef *huart, uint32_t Polarity, uint32_t AssertionTime,
                                   uint32_t DeassertionTime)
{
  uint32_t temp;
...
# 205 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_uart_ex.c"
...
# 272 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_uart_ex.c"
__attribute__((weak)) void HAL_UARTEx_WakeupCallback(UART_HandleTypeDef *huart)
{
...
__attribute__((weak)) void HAL_UARTEx_RxFifoFullCallback(UART_HandleTypeDef *huart)
{
...
__attribute__((weak)) void HAL_UARTEx_TxFifoEmptyCallback(UART_HandleTypeDef *huart)
{
...
# 387 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_uart_ex.c"
HAL_StatusTypeDef HAL_MultiProcessorEx_AddressLength_Set(UART_HandleTypeDef *huart, uint32_t AddressLength)
{
...
# 425 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_uart_ex.c"
HAL_StatusTypeDef HAL_UARTEx_StopModeWakeUpSourceConfig(UART_HandleTypeDef *huart, UART_WakeUpTypeDef WakeUpSelection)
{
...
HAL_StatusTypeDef HAL_UARTEx_EnableStopMode(UART_HandleTypeDef *huart)
{
  ...
  do { uint32_t val; do { val = (uint32_t)__builtin_arm_ldrex((volatile uint32_t *)&(huart->Instance->CR1)) | ((0x1UL << (1U))); } while (((uint32_t)__builtin_arm_strex(val,(volatile uint32_t *)&(huart->Instance->CR1))) != 0U); } while(0);
...
HAL_StatusTypeDef HAL_UARTEx_EnableFifoMode(UART_HandleTypeDef *huart)
{
  ...
  ((tmpcr1) |= ((0x1UL << (29U))));
  huart->FifoMode = (0x1UL << (29U));


  ((huart->Instance->CR1) = (tmpcr1));
...
# 605 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_uart_ex.c"
HAL_StatusTypeDef HAL_UARTEx_SetTxFifoThreshold(UART_HandleTypeDef *huart, uint32_t Threshold)
{
  uint32_t tmpcr1;
  ...
  (((huart->Instance->CR3)) = ((((((huart->Instance->CR3))) & (~((0x7UL << (29U))))) | (Threshold))));
...
# 654 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_uart_ex.c"
HAL_StatusTypeDef HAL_UARTEx_SetRxFifoThreshold(UART_HandleTypeDef *huart, uint32_t Threshold)
{
  uint32_t tmpcr1;
  ...
  (((huart->Instance->CR3)) = ((((((huart->Instance->CR3))) & (~((0x7UL << (25U))))) | (Threshold))));
...
# 711 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_uart_ex.c"
HAL_StatusTypeDef HAL_UARTEx_ReceiveToIdle(UART_HandleTypeDef *huart, uint8_t *pData, uint16_t Size, uint16_t *RxLen,
                                           uint32_t Timeout)
{
  uint8_t *pdata8bits;
...
# 836 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_uart_ex.c"
HAL_StatusTypeDef HAL_UARTEx_ReceiveToIdle_IT(UART_HandleTypeDef *huart, uint8_t *pData, uint16_t Size)
{
...
# 898 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_uart_ex.c"
HAL_StatusTypeDef HAL_UARTEx_ReceiveToIdle_DMA(UART_HandleTypeDef *huart, uint8_t *pData, uint16_t Size)
{
  HAL_StatusTypeDef status;
...
# 961 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_uart_ex.c"
static void UARTEx_Wakeup_AddressConfig(UART_HandleTypeDef *huart, UART_WakeUpTypeDef WakeUpSelection)
{
  ((void)0U);
...
# 979 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_uart_ex.c"
static void UARTEx_SetNbDataToProcess(UART_HandleTypeDef *huart)
{
  ...
  else
  {
    rx_fifo_depth = 8U;
    tx_fifo_depth = 8U;
    rx_fifo_threshold = (uint8_t)(((huart->Instance->CR3) & ((0x7UL << (25U)))) >> (25U));
    tx_fifo_threshold = (uint8_t)(((huart->Instance->CR3) & ((0x7UL << (29U)))) >> (29U));
