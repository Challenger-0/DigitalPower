# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_opamp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_opamp.c" 2
# 21 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_opamp.c"
# 1 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_opamp.h" 1
# 28 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_opamp.h"
...
# 29 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_opamp.h" 2
# 94 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_opamp.h"
typedef struct
{
  uint32_t PowerMode;
...
# 472 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_opamp.h"
...
# 492 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_opamp.h"
...
# 511 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_opamp.h"
...
# 526 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_opamp.h"
...
# 540 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_opamp.h"
static __inline uint32_t LL_OPAMP_GetPowerMode(OPAMP_TypeDef *OPAMPx)
{
  return (uint32_t)(((OPAMPx->CSR) & ((0x1UL << (7U)))));
}
# 564 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_opamp.h"
...
# 580 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_opamp.h"
static __inline uint32_t LL_OPAMP_GetInputNonInverting(OPAMP_TypeDef *OPAMPx)
{
  return (uint32_t)(((OPAMPx->CSR) & ((0x3UL << (2U)))));
}
# 599 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_opamp.h"
...
# 616 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_opamp.h"
...
# 637 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_opamp.h"
...
# 653 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_opamp.h"
static __inline uint32_t LL_OPAMP_GetInputNonInvertingSecondary(OPAMP_TypeDef *OPAMPx)
{
  return (uint32_t)(((OPAMPx->TCMR) & ((0x3UL << (1U)))));
}
# 673 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_opamp.h"
...
# 688 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_opamp.h"
static __inline uint32_t LL_OPAMP_GetInputInvertingSecondary(OPAMP_TypeDef *OPAMPx)
{
  return (uint32_t)(((OPAMPx->TCMR) & ((0x1UL << (0U)))));
}
# 705 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_opamp.h"
...
# 721 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_opamp.h"
...
# 736 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_opamp.h"
...
# 749 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_opamp.h"
static __inline uint32_t LL_OPAMP_GetInternalOutput(OPAMP_TypeDef *OPAMPx)
{
  return ((OPAMPx->CSR) & ((0x1UL << (8U))));
}
# 771 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_opamp.h"
...
# 784 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_opamp.h"
static __inline uint32_t LL_OPAMP_GetTrimmingMode(OPAMP_TypeDef *OPAMPx)
{
  return (uint32_t)(((OPAMPx->CSR) & ((0x1UL << (4U)))));
}
# 807 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_opamp.h"
...
# 831 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_opamp.h"
...
# 848 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_opamp.h"
...
# 866 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_opamp.h"
...
# 886 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_opamp.h"
...
# 908 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_opamp.h"
...
ErrorStatus LL_OPAMP_DeInit(OPAMP_TypeDef *OPAMPx)
{
  ...
  {
    (((OPAMPx)->TCMR) = ((0x00000000UL)));
  }
  else if ((((OPAMPx)->TCMR)) != 0x80000000UL)
  {
...
# 157 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_opamp.c"
ErrorStatus LL_OPAMP_Init(OPAMP_TypeDef *OPAMPx, LL_OPAMP_InitTypeDef *OPAMP_InitStruct)
{
  ErrorStatus status = SUCCESS;
  ...
  if (OPAMP_InitStruct->FunctionalMode != ((0x2UL << (5U)) | (0x1UL << (5U))))
  {
    ((void)0U);
  }
  ...
  if (LL_OPAMP_IsLocked(OPAMPx) == 0U)
  {
    ...
    if (OPAMP_InitStruct->FunctionalMode != ((0x2UL << (5U)) | (0x1UL << (5U))))
    {
      (((OPAMPx->CSR)) = ((((((OPAMPx->CSR))) & (~((0x1UL << (7U)) | (0x1UL << (11U)) | (0x3UL << (5U)) | (0x3UL << (2U)) | (0x10UL << (14U)) | (0x8UL << (14U))))) | (OPAMP_InitStruct->PowerMode | OPAMP_InitStruct->FunctionalMode | OPAMP_InitStruct->InputNonInverting | OPAMP_InitStruct->InputInverting))));
# 200 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_opamp.c"
    }
    else
    {
      (((OPAMPx->CSR)) = ((((((OPAMPx->CSR))) & (~((0x1UL << (7U)) | (0x1UL << (11U)) | (0x3UL << (5U)) | (0x3UL << (2U)) | (0x10UL << (14U)) | (0x8UL << (14U))))) | (OPAMP_InitStruct->PowerMode | ((0x2UL << (5U)) | (0x1UL << (5U))) | OPAMP_InitStruct->InputNonInverting))));
# 214 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_opamp.c"
    }
  }
  else
  {
...
void LL_OPAMP_StructInit(LL_OPAMP_InitTypeDef *OPAMP_InitStruct)
{
  ...
  OPAMP_InitStruct->PowerMode = (0x00000000UL);
  OPAMP_InitStruct->FunctionalMode = ((0x2UL << (5U)) | (0x1UL << (5U)));
  OPAMP_InitStruct->InputNonInverting = (0x00000000UL);


  OPAMP_InitStruct->InputInverting = (0x2UL << (5U));
}
