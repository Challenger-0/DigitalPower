# 1 "CubeMX/Core/Src/system_stm32g4xx.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "CubeMX/Core/Src/system_stm32g4xx.c" 2
# 78 "CubeMX/Core/Src/system_stm32g4xx.c"
...
# 79 "CubeMX/Core/Src/system_stm32g4xx.c" 2
# 152 "CubeMX/Core/Src/system_stm32g4xx.c"
  uint32_t SystemCoreClock = (16000000UL);

  const uint8_t AHBPrescTable[16] = {0U, 0U, 0U, 0U, 0U, 0U, 0U, 0U, 1U, 2U, 3U, 4U, 6U, 7U, 8U, 9U};
  const uint8_t APBPrescTable[8] = {0U, 0U, 0U, 0U, 1U, 2U, 3U, 4U};
# 179 "CubeMX/Core/Src/system_stm32g4xx.c"
...
# 228 "CubeMX/Core/Src/system_stm32g4xx.c"
