# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_spi.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_spi.c" 2
# 21 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_spi.c"
# 1 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_spi.h" 1
# 28 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_spi.h"
...
# 29 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_spi.h" 2
# 53 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_spi.h"
typedef struct
{
...
# 358 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_spi.h"
static __inline void LL_SPI_Enable(SPI_TypeDef *SPIx)
{
  ((SPIx->CR1) |= ((0x1UL << (6U))));
}
# 370 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_spi.h"
...
# 602 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_spi.h"
...
# 832 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_spi.h"
...
# 848 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_spi.h"
...
# 862 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_spi.h"
static __inline void LL_SPI_EnableNSSPulseMgt(SPI_TypeDef *SPIx)
{
  ((SPIx->CR2) |= ((0x1UL << (3U))));
}
# 874 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_spi.h"
static __inline void LL_SPI_DisableNSSPulseMgt(SPI_TypeDef *SPIx)
{
  ((SPIx->CR2) &= ~((0x1UL << (3U))));
}
# 886 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_spi.h"
static __inline uint32_t LL_SPI_IsEnabledNSSPulse(SPI_TypeDef *SPIx)
{
  return ((((SPIx->CR2) & ((0x1UL << (3U)))) == ((0x1UL << (3U)))) ? 1UL : 0UL);
}
# 905 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_spi.h"
...
# 967 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_spi.h"
...
# 993 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_spi.h"
static __inline uint32_t LL_SPI_GetRxFIFOLevel(SPI_TypeDef *SPIx)
{
  return (uint32_t)(((SPIx->SR) & ((0x3UL << (9U)))));
}
# 1008 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_spi.h"
...
# 1032 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_spi.h"
...
# 1048 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_spi.h"
...
# 1064 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_spi.h"
...
# 1086 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_spi.h"
...
# 1120 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_spi.h"
...
# 1194 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_spi.h"
...
# 1333 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_spi.h"
...
# 1356 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_spi.h"
...
# 1373 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_spi.h"
...
# 1391 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_spi.h"
ErrorStatus LL_SPI_DeInit(SPI_TypeDef *SPIx);
ErrorStatus LL_SPI_Init(SPI_TypeDef *SPIx, LL_SPI_InitTypeDef *SPI_InitStruct);
void LL_SPI_StructInit(LL_SPI_InitTypeDef *SPI_InitStruct);
# 1426 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_spi.h"
typedef struct
{
  uint32_t Mode;
...
# 1637 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_spi.h"
...
# 1676 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_spi.h"
...
# 1822 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_spi.h"
...
# 1835 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_spi.h"
...
# 1880 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_spi.h"
...
# 1922 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_spi.h"
...
# 1991 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_spi.h"
...
# 2046 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_spi.h"
...
# 2080 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_spi.h"
...
# 2154 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_spi.h"
...
# 2228 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_spi.h"
static __inline uint16_t LL_I2S_ReceiveData16(SPI_TypeDef *SPIx)
{
  return LL_SPI_ReceiveData16(SPIx);
}
# 2240 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_spi.h"
static __inline void LL_I2S_TransmitData16(SPI_TypeDef *SPIx, uint16_t TxData)
{
  LL_SPI_TransmitData16(SPIx, TxData);
}
# 2254 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_spi.h"
ErrorStatus LL_I2S_DeInit(SPI_TypeDef *SPIx);
ErrorStatus LL_I2S_Init(SPI_TypeDef *SPIx, LL_I2S_InitTypeDef *I2S_InitStruct);
void LL_I2S_StructInit(LL_I2S_InitTypeDef *I2S_InitStruct);
void LL_I2S_ConfigPrescaler(SPI_TypeDef *SPIx, uint32_t PrescalerLinear, uint32_t PrescalerParity);
# 22 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_spi.c" 2
...
# 23 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_spi.c" 2
...
# 24 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_spi.c" 2
# 133 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_spi.c"
ErrorStatus LL_SPI_DeInit(SPI_TypeDef *SPIx)
{
  ...
  if (SPIx == ((SPI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x3000UL)))
  {

    LL_APB2_GRP1_ForceReset((0x1UL << (12U)));


    LL_APB2_GRP1_ReleaseReset((0x1UL << (12U)));

    status = SUCCESS;
  }


  if (SPIx == ((SPI_TypeDef *) ((0x40000000UL) + 0x3800UL)))
  {

    LL_APB1_GRP1_ForceReset((0x1UL << (14U)));


    LL_APB1_GRP1_ReleaseReset((0x1UL << (14U)));

    status = SUCCESS;
  }


  if (SPIx == ((SPI_TypeDef *) ((0x40000000UL) + 0x3C00UL)))
  {

    LL_APB1_GRP1_ForceReset((0x1UL << (15U)));


    LL_APB1_GRP1_ReleaseReset((0x1UL << (15U)));

    status = SUCCESS;
  }
# 189 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_spi.c"
  return status;
}
# 200 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_spi.c"
ErrorStatus LL_SPI_Init(SPI_TypeDef *SPIx, LL_SPI_InitTypeDef *SPI_InitStruct)
{
  ErrorStatus status = ERROR;
  ...
  {
# 231 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_spi.c"
    (((SPIx->CR1)) = ((((((SPIx->CR1))) & (~(((0x1UL << (0U)) | (0x1UL << (1U)) | (0x1UL << (2U)) | (0x7UL << (3U)) | (0x1UL << (7U)) | (0x1UL << (8U)) | (0x1UL << (9U)) | (0x1UL << (10U)) | (0x1UL << (11U)) | (0x1UL << (12U)) | (0x1UL << (13U)) | (0x1UL << (14U)) | (0x1UL << (15U)))))) | (SPI_InitStruct->TransferDirection | SPI_InitStruct->Mode | SPI_InitStruct->ClockPolarity | SPI_InitStruct->ClockPhase | SPI_InitStruct->NSS | SPI_InitStruct->BaudRate | SPI_InitStruct->BitOrder | SPI_InitStruct->CRCCalculation))));
# 243 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_spi.c"
    (((SPIx->CR2)) = ((((((SPIx->CR2))) & (~((0xFUL << (8U)) | (0x1UL << (2U))))) | (SPI_InitStruct->DataWidth | (SPI_InitStruct->NSS >> 16U)))));




    if (SPI_InitStruct->DataWidth < ((0x8UL << (8U))))
    {
      LL_SPI_SetRxFIFOThreshold(SPIx, ((0x1UL << (12U))));
    }
    ...
    if (SPI_InitStruct->CRCCalculation == ((0x1UL << (13U))))
    {
      ((void)0U);
...
void LL_SPI_StructInit(LL_SPI_InitTypeDef *SPI_InitStruct)
{
  ...
  SPI_InitStruct->Mode = 0x00000000U;
  ...
  SPI_InitStruct->NSS = 0x00000000U;
  SPI_InitStruct->BaudRate = 0x00000000U;
  SPI_InitStruct->BitOrder = 0x00000000U;
  SPI_InitStruct->CRCCalculation = 0x00000000U;
  SPI_InitStruct->CRCPoly = 7U;
}
# 382 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_spi.c"
ErrorStatus LL_I2S_DeInit(SPI_TypeDef *SPIx)
{
  return LL_SPI_DeInit(SPIx);
}
# 397 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_spi.c"
ErrorStatus LL_I2S_Init(SPI_TypeDef *SPIx, LL_I2S_InitTypeDef *I2S_InitStruct)
{
  uint32_t i2sdiv = 2U;
  uint32_t i2sodd = 0U;
  ...
  {
# 426 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_spi.c"
    (((SPIx->I2SCFGR)) = ((((((SPIx->I2SCFGR))) & (~(((0x1UL << (0U)) | (0x3UL << (1U)) | (0x1UL << (3U)) | (0x3UL << (4U)) | (0x3UL << (8U)) | (0x1UL << (11U)) )))) | (I2S_InitStruct->Mode | I2S_InitStruct->Standard | I2S_InitStruct->DataFormat | I2S_InitStruct->ClockPolarity | (0x1UL << (11U))))));
# 441 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_spi.c"
    if (I2S_InitStruct->AudioFreq != 2U)
    {



      if (I2S_InitStruct->DataFormat != 0x00000000U)
      {
      ...
      sourceclock = LL_RCC_GetI2SClockFreq((0x3UL << (22U)));


      if (I2S_InitStruct->MCLKOutput == ((0x1UL << (9U))))
      {
    ...
    ((SPIx->I2SPR) = (i2sdiv | i2sodd | I2S_InitStruct->MCLKOutput));
...
void LL_I2S_StructInit(LL_I2S_InitTypeDef *I2S_InitStruct)
{
  ...
  I2S_InitStruct->Mode = 0x00000000U;
  I2S_InitStruct->Standard = 0x00000000U;
  I2S_InitStruct->DataFormat = 0x00000000U;
  I2S_InitStruct->MCLKOutput = 0x00000000U;
  I2S_InitStruct->AudioFreq = 2U;
  I2S_InitStruct->ClockPolarity = 0x00000000U;
}
# 526 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_spi.c"
void LL_I2S_ConfigPrescaler(SPI_TypeDef *SPIx, uint32_t PrescalerLinear, uint32_t PrescalerParity)
{
  ...
  (((SPIx->I2SPR)) = ((((((SPIx->I2SPR))) & (~((0xFFUL << (0U)) | (0x1UL << (8U))))) | (PrescalerLinear | (PrescalerParity << 8U)))));
}
