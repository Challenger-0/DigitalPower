# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_lpuart.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_lpuart.c" 2
# 21 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_lpuart.c"
# 1 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h" 1
# 28 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
...
# 29 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h" 2
# 46 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
...
# 97 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
typedef struct
{
...
# 495 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline void LL_LPUART_Enable(USART_TypeDef *LPUARTx)
{
  ((LPUARTx->CR1) |= ((0x1UL << (0U))));
}
# 514 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline void LL_LPUART_Disable(USART_TypeDef *LPUARTx)
{
  ((LPUARTx->CR1) &= ~((0x1UL << (0U))));
}
...
static __inline uint32_t LL_LPUART_IsEnabled(USART_TypeDef *LPUARTx)
{
...
static __inline void LL_LPUART_EnableFIFO(USART_TypeDef *LPUARTx)
{
...
static __inline void LL_LPUART_DisableFIFO(USART_TypeDef *LPUARTx)
{
  ((LPUARTx->CR1) &= ~((0x1UL << (29U))));
}
...
static __inline uint32_t LL_LPUART_IsEnabledFIFO(USART_TypeDef *LPUARTx)
{
  return ((((LPUARTx->CR1) & ((0x1UL << (29U)))) == ((0x1UL << (29U)))) ? 1UL : 0UL);
}
# 576 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline void LL_LPUART_SetTXFIFOThreshold(USART_TypeDef *LPUARTx, uint32_t Threshold)
{
  do { uint32_t val; do { val = ((uint32_t)__builtin_arm_ldrex((volatile uint32_t *)&(LPUARTx->CR3)) & ~((0x7UL << (29U)))) | (Threshold << (29U)); } while (((uint32_t)__builtin_arm_strex(val,(volatile uint32_t *)&(LPUARTx->CR3))) != 0U); } while(0);
}
# 593 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline uint32_t LL_LPUART_GetTXFIFOThreshold(USART_TypeDef *LPUARTx)
{
  return (uint32_t)(((LPUARTx->CR3) & ((0x7UL << (29U)))) >> (29U));
}
# 611 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline void LL_LPUART_SetRXFIFOThreshold(USART_TypeDef *LPUARTx, uint32_t Threshold)
{
  do { uint32_t val; do { val = ((uint32_t)__builtin_arm_ldrex((volatile uint32_t *)&(LPUARTx->CR3)) & ~((0x7UL << (25U)))) | (Threshold << (25U)); } while (((uint32_t)__builtin_arm_strex(val,(volatile uint32_t *)&(LPUARTx->CR3))) != 0U); } while(0);
}
# 628 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline uint32_t LL_LPUART_GetRXFIFOThreshold(USART_TypeDef *LPUARTx)
{
  return (uint32_t)(((LPUARTx->CR3) & ((0x7UL << (25U)))) >> (25U));
}
# 654 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline void LL_LPUART_ConfigFIFOsThreshold(USART_TypeDef *LPUARTx, uint32_t TXThreshold, uint32_t RXThreshold)
{
  do { uint32_t val; do { val = ((uint32_t)__builtin_arm_ldrex((volatile uint32_t *)&(LPUARTx->CR3)) & ~((0x7UL << (29U)) | (0x7UL << (25U)))) | ((TXThreshold << (29U)) | (RXThreshold << (25U))); } while (((uint32_t)__builtin_arm_strex(val,(volatile uint32_t *)&(LPUARTx->CR3))) != 0U); } while(0);

}
# 668 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline void LL_LPUART_EnableInStopMode(USART_TypeDef *LPUARTx)
{
  do { uint32_t val; do { val = (uint32_t)__builtin_arm_ldrex((volatile uint32_t *)&(LPUARTx->CR1)) | ((0x1UL << (1U))); } while (((uint32_t)__builtin_arm_strex(val,(volatile uint32_t *)&(LPUARTx->CR1))) != 0U); } while(0);
}
# 680 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline void LL_LPUART_DisableInStopMode(USART_TypeDef *LPUARTx)
{
  do { uint32_t val; do { val = (uint32_t)__builtin_arm_ldrex((volatile uint32_t *)&(LPUARTx->CR1)) & ~((0x1UL << (1U))); } while (((uint32_t)__builtin_arm_strex(val,(volatile uint32_t *)&(LPUARTx->CR1))) != 0U); } while(0);
}
# 692 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline uint32_t LL_LPUART_IsEnabledInStopMode(USART_TypeDef *LPUARTx)
{
...
static __inline void LL_LPUART_EnableDirectionRx(USART_TypeDef *LPUARTx)
{
  do { uint32_t val; do { val = (uint32_t)__builtin_arm_ldrex((volatile uint32_t *)&(LPUARTx->CR1)) | ((0x1UL << (2U))); } while (((uint32_t)__builtin_arm_strex(val,(volatile uint32_t *)&(LPUARTx->CR1))) != 0U); } while(0);
}
...
static __inline void LL_LPUART_DisableDirectionRx(USART_TypeDef *LPUARTx)
{
  do { uint32_t val; do { val = (uint32_t)__builtin_arm_ldrex((volatile uint32_t *)&(LPUARTx->CR1)) & ~((0x1UL << (2U))); } while (((uint32_t)__builtin_arm_strex(val,(volatile uint32_t *)&(LPUARTx->CR1))) != 0U); } while(0);
}
...
static __inline void LL_LPUART_EnableDirectionTx(USART_TypeDef *LPUARTx)
{
  do { uint32_t val; do { val = (uint32_t)__builtin_arm_ldrex((volatile uint32_t *)&(LPUARTx->CR1)) | ((0x1UL << (3U))); } while (((uint32_t)__builtin_arm_strex(val,(volatile uint32_t *)&(LPUARTx->CR1))) != 0U); } while(0);
}
...
static __inline void LL_LPUART_DisableDirectionTx(USART_TypeDef *LPUARTx)
{
  do { uint32_t val; do { val = (uint32_t)__builtin_arm_ldrex((volatile uint32_t *)&(LPUARTx->CR1)) & ~((0x1UL << (3U))); } while (((uint32_t)__builtin_arm_strex(val,(volatile uint32_t *)&(LPUARTx->CR1))) != 0U); } while(0);
}
# 754 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline void LL_LPUART_SetTransferDirection(USART_TypeDef *LPUARTx, uint32_t TransferDirection)
{
  do { uint32_t val; do { val = ((uint32_t)__builtin_arm_ldrex((volatile uint32_t *)&(LPUARTx->CR1)) & ~((0x1UL << (2U)) | (0x1UL << (3U)))) | (TransferDirection); } while (((uint32_t)__builtin_arm_strex(val,(volatile uint32_t *)&(LPUARTx->CR1))) != 0U); } while(0);
}
# 770 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline uint32_t LL_LPUART_GetTransferDirection(USART_TypeDef *LPUARTx)
{
  return (uint32_t)(((LPUARTx->CR1) & ((0x1UL << (2U)) | (0x1UL << (3U)))));
}
# 789 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline void LL_LPUART_SetParity(USART_TypeDef *LPUARTx, uint32_t Parity)
{
  (((LPUARTx->CR1)) = ((((((LPUARTx->CR1))) & (~((0x1UL << (9U)) | (0x1UL << (10U))))) | (Parity))));
}
# 804 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline uint32_t LL_LPUART_GetParity(USART_TypeDef *LPUARTx)
{
  return (uint32_t)(((LPUARTx->CR1) & ((0x1UL << (9U)) | (0x1UL << (10U)))));
}
# 818 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline void LL_LPUART_SetWakeUpMethod(USART_TypeDef *LPUARTx, uint32_t Method)
{
  (((LPUARTx->CR1)) = ((((((LPUARTx->CR1))) & (~((0x1UL << (11U))))) | (Method))));
}
# 831 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline uint32_t LL_LPUART_GetWakeUpMethod(USART_TypeDef *LPUARTx)
{
  return (uint32_t)(((LPUARTx->CR1) & ((0x1UL << (11U)))));
}
# 846 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline void LL_LPUART_SetDataWidth(USART_TypeDef *LPUARTx, uint32_t DataWidth)
{
  (((LPUARTx->CR1)) = ((((((LPUARTx->CR1))) & (~((0x10001UL << (12U))))) | (DataWidth))));
}
# 860 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline uint32_t LL_LPUART_GetDataWidth(USART_TypeDef *LPUARTx)
{
  return (uint32_t)(((LPUARTx->CR1) & ((0x10001UL << (12U)))));
}
...
static __inline void LL_LPUART_EnableMuteMode(USART_TypeDef *LPUARTx)
{
  do { uint32_t val; do { val = (uint32_t)__builtin_arm_ldrex((volatile uint32_t *)&(LPUARTx->CR1)) | ((0x1UL << (13U))); } while (((uint32_t)__builtin_arm_strex(val,(volatile uint32_t *)&(LPUARTx->CR1))) != 0U); } while(0);
}
...
static __inline void LL_LPUART_DisableMuteMode(USART_TypeDef *LPUARTx)
{
  do { uint32_t val; do { val = (uint32_t)__builtin_arm_ldrex((volatile uint32_t *)&(LPUARTx->CR1)) & ~((0x1UL << (13U))); } while (((uint32_t)__builtin_arm_strex(val,(volatile uint32_t *)&(LPUARTx->CR1))) != 0U); } while(0);
}
...
static __inline uint32_t LL_LPUART_IsEnabledMuteMode(USART_TypeDef *LPUARTx)
{
  return ((((LPUARTx->CR1) & ((0x1UL << (13U)))) == ((0x1UL << (13U)))) ? 1UL : 0UL);
}
# 917 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline void LL_LPUART_SetPrescaler(USART_TypeDef *LPUARTx, uint32_t PrescalerValue)
{
  (((LPUARTx->PRESC)) = ((((((LPUARTx->PRESC))) & (~((0xFUL << (0U))))) | ((uint16_t)PrescalerValue))));
}
# 940 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline uint32_t LL_LPUART_GetPrescaler(USART_TypeDef *LPUARTx)
{
  return (uint32_t)(((LPUARTx->PRESC) & ((0xFUL << (0U)))));
}
# 954 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline void LL_LPUART_SetStopBitsLength(USART_TypeDef *LPUARTx, uint32_t StopBits)
{
  (((LPUARTx->CR2)) = ((((((LPUARTx->CR2))) & (~((0x3UL << (12U))))) | (StopBits))));
}
# 967 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline uint32_t LL_LPUART_GetStopBitsLength(USART_TypeDef *LPUARTx)
{
  return (uint32_t)(((LPUARTx->CR2) & ((0x3UL << (12U)))));
}
# 996 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline void LL_LPUART_ConfigCharacter(USART_TypeDef *LPUARTx, uint32_t DataWidth, uint32_t Parity,
                                               uint32_t StopBits)
{
  (((LPUARTx->CR1)) = ((((((LPUARTx->CR1))) & (~((0x1UL << (9U)) | (0x1UL << (10U)) | (0x10001UL << (12U))))) | (Parity | DataWidth))));
  (((LPUARTx->CR2)) = ((((((LPUARTx->CR2))) & (~((0x3UL << (12U))))) | (StopBits))));
}
# 1012 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline void LL_LPUART_SetTXRXSwap(USART_TypeDef *LPUARTx, uint32_t SwapConfig)
{
  (((LPUARTx->CR2)) = ((((((LPUARTx->CR2))) & (~((0x1UL << (15U))))) | (SwapConfig))));
}
# 1025 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline uint32_t LL_LPUART_GetTXRXSwap(USART_TypeDef *LPUARTx)
{
  return (uint32_t)(((LPUARTx->CR2) & ((0x1UL << (15U)))));
}
# 1039 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline void LL_LPUART_SetRXPinLevel(USART_TypeDef *LPUARTx, uint32_t PinInvMethod)
{
  (((LPUARTx->CR2)) = ((((((LPUARTx->CR2))) & (~((0x1UL << (16U))))) | (PinInvMethod))));
}
# 1052 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline uint32_t LL_LPUART_GetRXPinLevel(USART_TypeDef *LPUARTx)
{
  return (uint32_t)(((LPUARTx->CR2) & ((0x1UL << (16U)))));
}
# 1066 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline void LL_LPUART_SetTXPinLevel(USART_TypeDef *LPUARTx, uint32_t PinInvMethod)
{
  (((LPUARTx->CR2)) = ((((((LPUARTx->CR2))) & (~((0x1UL << (17U))))) | (PinInvMethod))));
}
# 1079 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline uint32_t LL_LPUART_GetTXPinLevel(USART_TypeDef *LPUARTx)
{
  return (uint32_t)(((LPUARTx->CR2) & ((0x1UL << (17U)))));
}
# 1096 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline void LL_LPUART_SetBinaryDataLogic(USART_TypeDef *LPUARTx, uint32_t DataLogic)
{
  (((LPUARTx->CR2)) = ((((((LPUARTx->CR2))) & (~((0x1UL << (18U))))) | (DataLogic))));
}
# 1109 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline uint32_t LL_LPUART_GetBinaryDataLogic(USART_TypeDef *LPUARTx)
{
  return (uint32_t)(((LPUARTx->CR2) & ((0x1UL << (18U)))));
}
# 1125 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline void LL_LPUART_SetTransferBitOrder(USART_TypeDef *LPUARTx, uint32_t BitOrder)
{
  (((LPUARTx->CR2)) = ((((((LPUARTx->CR2))) & (~((0x1UL << (19U))))) | (BitOrder))));
}
# 1140 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline uint32_t LL_LPUART_GetTransferBitOrder(USART_TypeDef *LPUARTx)
{
  return (uint32_t)(((LPUARTx->CR2) & ((0x1UL << (19U)))));
}
# 1168 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline void LL_LPUART_ConfigNodeAddress(USART_TypeDef *LPUARTx, uint32_t AddressLen, uint32_t NodeAddress)
{
  (((LPUARTx->CR2)) = ((((((LPUARTx->CR2))) & (~((0xFFUL << (24U)) | (0x1UL << (4U))))) | ((uint32_t)(AddressLen | (NodeAddress << (24U)))))));

}
# 1184 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline uint32_t LL_LPUART_GetNodeAddress(USART_TypeDef *LPUARTx)
{
  return (uint32_t)(((LPUARTx->CR2) & ((0xFFUL << (24U)))) >> (24U));
}
# 1197 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline uint32_t LL_LPUART_GetNodeAddressLen(USART_TypeDef *LPUARTx)
{
...
static __inline void LL_LPUART_EnableRTSHWFlowCtrl(USART_TypeDef *LPUARTx)
{
...
static __inline void LL_LPUART_DisableRTSHWFlowCtrl(USART_TypeDef *LPUARTx)
{
  ((LPUARTx->CR3) &= ~((0x1UL << (8U))));
}
...
static __inline void LL_LPUART_EnableCTSHWFlowCtrl(USART_TypeDef *LPUARTx)
{
...
static __inline void LL_LPUART_DisableCTSHWFlowCtrl(USART_TypeDef *LPUARTx)
{
  ((LPUARTx->CR3) &= ~((0x1UL << (9U))));
}
# 1258 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline void LL_LPUART_SetHWFlowCtrl(USART_TypeDef *LPUARTx, uint32_t HardwareFlowControl)
{
  (((LPUARTx->CR3)) = ((((((LPUARTx->CR3))) & (~((0x1UL << (8U)) | (0x1UL << (9U))))) | (HardwareFlowControl))));
}
# 1274 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline uint32_t LL_LPUART_GetHWFlowCtrl(USART_TypeDef *LPUARTx)
{
...
static __inline void LL_LPUART_EnableOverrunDetect(USART_TypeDef *LPUARTx)
{
...
static __inline void LL_LPUART_DisableOverrunDetect(USART_TypeDef *LPUARTx)
{
  ((LPUARTx->CR3) |= ((0x1UL << (12U))));
}
...
static __inline uint32_t LL_LPUART_IsEnabledOverrunDetect(USART_TypeDef *LPUARTx)
{
  return ((((LPUARTx->CR3) & ((0x1UL << (12U)))) != (0x1UL << (12U))) ? 1UL : 0UL);
}
# 1322 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline void LL_LPUART_SetWKUPType(USART_TypeDef *LPUARTx, uint32_t Type)
{
  (((LPUARTx->CR3)) = ((((((LPUARTx->CR3))) & (~((0x3UL << (20U))))) | (Type))));
}
# 1336 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline uint32_t LL_LPUART_GetWKUPType(USART_TypeDef *LPUARTx)
{
  return (uint32_t)(((LPUARTx->CR3) & ((0x3UL << (20U)))));
}
# 1370 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline void LL_LPUART_SetBaudRate(USART_TypeDef *LPUARTx, uint32_t PeriphClk, uint32_t PrescalerValue,
                                           uint32_t BaudRate)
{
  if (BaudRate != 0U)
  {
...
# 1401 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline uint32_t LL_LPUART_GetBaudRate(USART_TypeDef *LPUARTx, uint32_t PeriphClk, uint32_t PrescalerValue)
{
  uint32_t lpuartdiv;
  uint32_t brrresult;
...
# 1435 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline void LL_LPUART_EnableHalfDuplex(USART_TypeDef *LPUARTx)
{
...
static __inline void LL_LPUART_DisableHalfDuplex(USART_TypeDef *LPUARTx)
{
  ((LPUARTx->CR3) &= ~((0x1UL << (3U))));
}
...
static __inline uint32_t LL_LPUART_IsEnabledHalfDuplex(USART_TypeDef *LPUARTx)
{
  return ((((LPUARTx->CR3) & ((0x1UL << (3U)))) == ((0x1UL << (3U)))) ? 1UL : 0UL);
}
# 1477 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline void LL_LPUART_SetDEDeassertionTime(USART_TypeDef *LPUARTx, uint32_t Time)
{
...
static __inline uint32_t LL_LPUART_GetDEDeassertionTime(USART_TypeDef *LPUARTx)
{
  return (uint32_t)(((LPUARTx->CR1) & ((0x1FUL << (16U)))) >> (16U));
}
# 1500 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline void LL_LPUART_SetDEAssertionTime(USART_TypeDef *LPUARTx, uint32_t Time)
{
...
static __inline uint32_t LL_LPUART_GetDEAssertionTime(USART_TypeDef *LPUARTx)
{
...
static __inline void LL_LPUART_EnableDEMode(USART_TypeDef *LPUARTx)
{
...
static __inline void LL_LPUART_DisableDEMode(USART_TypeDef *LPUARTx)
{
  ((LPUARTx->CR3) &= ~((0x1UL << (14U))));
}
...
static __inline uint32_t LL_LPUART_IsEnabledDEMode(USART_TypeDef *LPUARTx)
{
  return ((((LPUARTx->CR3) & ((0x1UL << (14U)))) == ((0x1UL << (14U)))) ? 1UL : 0UL);
}
# 1558 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline void LL_LPUART_SetDESignalPolarity(USART_TypeDef *LPUARTx, uint32_t Polarity)
{
  (((LPUARTx->CR3)) = ((((((LPUARTx->CR3))) & (~((0x1UL << (15U))))) | (Polarity))));
}
# 1571 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline uint32_t LL_LPUART_GetDESignalPolarity(USART_TypeDef *LPUARTx)
{
  return (uint32_t)(((LPUARTx->CR3) & ((0x1UL << (15U)))));
}
# 1590 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline uint32_t LL_LPUART_IsActiveFlag_PE(USART_TypeDef *LPUARTx)
{
...
static __inline uint32_t LL_LPUART_IsActiveFlag_FE(USART_TypeDef *LPUARTx)
{
...
static __inline uint32_t LL_LPUART_IsActiveFlag_NE(USART_TypeDef *LPUARTx)
{
...
static __inline uint32_t LL_LPUART_IsActiveFlag_ORE(USART_TypeDef *LPUARTx)
{
...
static __inline uint32_t LL_LPUART_IsActiveFlag_IDLE(USART_TypeDef *LPUARTx)
{
  return ((((LPUARTx->ISR) & ((0x1UL << (4U)))) == ((0x1UL << (4U)))) ? 1UL : 0UL);
}
# 1648 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline uint32_t LL_LPUART_IsActiveFlag_RXNE_RXFNE(USART_TypeDef *LPUARTx)
{
...
static __inline uint32_t LL_LPUART_IsActiveFlag_TC(USART_TypeDef *LPUARTx)
{
  return ((((LPUARTx->ISR) & ((0x1UL << (6U)))) == ((0x1UL << (6U)))) ? 1UL : 0UL);
}
# 1673 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline uint32_t LL_LPUART_IsActiveFlag_TXE_TXFNF(USART_TypeDef *LPUARTx)
{
...
static __inline uint32_t LL_LPUART_IsActiveFlag_nCTS(USART_TypeDef *LPUARTx)
{
...
static __inline uint32_t LL_LPUART_IsActiveFlag_CTS(USART_TypeDef *LPUARTx)
{
...
static __inline uint32_t LL_LPUART_IsActiveFlag_BUSY(USART_TypeDef *LPUARTx)
{
...
static __inline uint32_t LL_LPUART_IsActiveFlag_CM(USART_TypeDef *LPUARTx)
{
...
static __inline uint32_t LL_LPUART_IsActiveFlag_SBK(USART_TypeDef *LPUARTx)
{
...
static __inline uint32_t LL_LPUART_IsActiveFlag_RWU(USART_TypeDef *LPUARTx)
{
...
static __inline uint32_t LL_LPUART_IsActiveFlag_WKUP(USART_TypeDef *LPUARTx)
{
...
static __inline uint32_t LL_LPUART_IsActiveFlag_TEACK(USART_TypeDef *LPUARTx)
{
...
static __inline uint32_t LL_LPUART_IsActiveFlag_REACK(USART_TypeDef *LPUARTx)
{
...
static __inline uint32_t LL_LPUART_IsActiveFlag_TXFE(USART_TypeDef *LPUARTx)
{
...
static __inline uint32_t LL_LPUART_IsActiveFlag_RXFF(USART_TypeDef *LPUARTx)
{
...
static __inline uint32_t LL_LPUART_IsActiveFlag_TXFT(USART_TypeDef *LPUARTx)
{
...
static __inline uint32_t LL_LPUART_IsActiveFlag_RXFT(USART_TypeDef *LPUARTx)
{
...
static __inline void LL_LPUART_ClearFlag_PE(USART_TypeDef *LPUARTx)
{
...
static __inline void LL_LPUART_ClearFlag_FE(USART_TypeDef *LPUARTx)
{
...
static __inline void LL_LPUART_ClearFlag_NE(USART_TypeDef *LPUARTx)
{
...
static __inline void LL_LPUART_ClearFlag_ORE(USART_TypeDef *LPUARTx)
{
...
static __inline void LL_LPUART_ClearFlag_IDLE(USART_TypeDef *LPUARTx)
{
...
static __inline void LL_LPUART_ClearFlag_TC(USART_TypeDef *LPUARTx)
{
...
static __inline void LL_LPUART_ClearFlag_nCTS(USART_TypeDef *LPUARTx)
{
...
static __inline void LL_LPUART_ClearFlag_CM(USART_TypeDef *LPUARTx)
{
...
static __inline void LL_LPUART_ClearFlag_WKUP(USART_TypeDef *LPUARTx)
{
  ((LPUARTx->ICR) = ((0x1UL << (20U))));
}
# 1934 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline void LL_LPUART_EnableIT_IDLE(USART_TypeDef *LPUARTx)
{
  do { uint32_t val; do { val = (uint32_t)__builtin_arm_ldrex((volatile uint32_t *)&(LPUARTx->CR1)) | ((0x1UL << (4U))); } while (((uint32_t)__builtin_arm_strex(val,(volatile uint32_t *)&(LPUARTx->CR1))) != 0U); } while(0);
}
# 1948 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline void LL_LPUART_EnableIT_RXNE_RXFNE(USART_TypeDef *LPUARTx)
{
  do { uint32_t val; do { val = (uint32_t)__builtin_arm_ldrex((volatile uint32_t *)&(LPUARTx->CR1)) | ((0x1UL << (5U))); } while (((uint32_t)__builtin_arm_strex(val,(volatile uint32_t *)&(LPUARTx->CR1))) != 0U); } while(0);
}
...
static __inline void LL_LPUART_EnableIT_TC(USART_TypeDef *LPUARTx)
{
  do { uint32_t val; do { val = (uint32_t)__builtin_arm_ldrex((volatile uint32_t *)&(LPUARTx->CR1)) | ((0x1UL << (6U))); } while (((uint32_t)__builtin_arm_strex(val,(volatile uint32_t *)&(LPUARTx->CR1))) != 0U); } while(0);
}
# 1973 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline void LL_LPUART_EnableIT_TXE_TXFNF(USART_TypeDef *LPUARTx)
{
  do { uint32_t val; do { val = (uint32_t)__builtin_arm_ldrex((volatile uint32_t *)&(LPUARTx->CR1)) | ((0x1UL << (7U))); } while (((uint32_t)__builtin_arm_strex(val,(volatile uint32_t *)&(LPUARTx->CR1))) != 0U); } while(0);
}
...
static __inline void LL_LPUART_EnableIT_PE(USART_TypeDef *LPUARTx)
{
  do { uint32_t val; do { val = (uint32_t)__builtin_arm_ldrex((volatile uint32_t *)&(LPUARTx->CR1)) | ((0x1UL << (8U))); } while (((uint32_t)__builtin_arm_strex(val,(volatile uint32_t *)&(LPUARTx->CR1))) != 0U); } while(0);
}
...
static __inline void LL_LPUART_EnableIT_CM(USART_TypeDef *LPUARTx)
{
  do { uint32_t val; do { val = (uint32_t)__builtin_arm_ldrex((volatile uint32_t *)&(LPUARTx->CR1)) | ((0x1UL << (14U))); } while (((uint32_t)__builtin_arm_strex(val,(volatile uint32_t *)&(LPUARTx->CR1))) != 0U); } while(0);
}
...
static __inline void LL_LPUART_EnableIT_TXFE(USART_TypeDef *LPUARTx)
{
  do { uint32_t val; do { val = (uint32_t)__builtin_arm_ldrex((volatile uint32_t *)&(LPUARTx->CR1)) | ((0x1UL << (30U))); } while (((uint32_t)__builtin_arm_strex(val,(volatile uint32_t *)&(LPUARTx->CR1))) != 0U); } while(0);
}
...
static __inline void LL_LPUART_EnableIT_RXFF(USART_TypeDef *LPUARTx)
{
  do { uint32_t val; do { val = (uint32_t)__builtin_arm_ldrex((volatile uint32_t *)&(LPUARTx->CR1)) | ((0x1UL << (31U))); } while (((uint32_t)__builtin_arm_strex(val,(volatile uint32_t *)&(LPUARTx->CR1))) != 0U); } while(0);
}
# 2032 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline void LL_LPUART_EnableIT_ERROR(USART_TypeDef *LPUARTx)
{
  do { uint32_t val; do { val = (uint32_t)__builtin_arm_ldrex((volatile uint32_t *)&(LPUARTx->CR3)) | ((0x1UL << (0U))); } while (((uint32_t)__builtin_arm_strex(val,(volatile uint32_t *)&(LPUARTx->CR3))) != 0U); } while(0);
}
...
static __inline void LL_LPUART_EnableIT_CTS(USART_TypeDef *LPUARTx)
{
  do { uint32_t val; do { val = (uint32_t)__builtin_arm_ldrex((volatile uint32_t *)&(LPUARTx->CR3)) | ((0x1UL << (10U))); } while (((uint32_t)__builtin_arm_strex(val,(volatile uint32_t *)&(LPUARTx->CR3))) != 0U); } while(0);
}
...
static __inline void LL_LPUART_EnableIT_WKUP(USART_TypeDef *LPUARTx)
{
  do { uint32_t val; do { val = (uint32_t)__builtin_arm_ldrex((volatile uint32_t *)&(LPUARTx->CR3)) | ((0x1UL << (22U))); } while (((uint32_t)__builtin_arm_strex(val,(volatile uint32_t *)&(LPUARTx->CR3))) != 0U); } while(0);
}
...
static __inline void LL_LPUART_EnableIT_TXFT(USART_TypeDef *LPUARTx)
{
  do { uint32_t val; do { val = (uint32_t)__builtin_arm_ldrex((volatile uint32_t *)&(LPUARTx->CR3)) | ((0x1UL << (23U))); } while (((uint32_t)__builtin_arm_strex(val,(volatile uint32_t *)&(LPUARTx->CR3))) != 0U); } while(0);
}
...
static __inline void LL_LPUART_EnableIT_RXFT(USART_TypeDef *LPUARTx)
{
  do { uint32_t val; do { val = (uint32_t)__builtin_arm_ldrex((volatile uint32_t *)&(LPUARTx->CR3)) | ((0x1UL << (28U))); } while (((uint32_t)__builtin_arm_strex(val,(volatile uint32_t *)&(LPUARTx->CR3))) != 0U); } while(0);
}
...
static __inline void LL_LPUART_DisableIT_IDLE(USART_TypeDef *LPUARTx)
{
  do { uint32_t val; do { val = (uint32_t)__builtin_arm_ldrex((volatile uint32_t *)&(LPUARTx->CR1)) & ~((0x1UL << (4U))); } while (((uint32_t)__builtin_arm_strex(val,(volatile uint32_t *)&(LPUARTx->CR1))) != 0U); } while(0);
}
# 2101 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline void LL_LPUART_DisableIT_RXNE_RXFNE(USART_TypeDef *LPUARTx)
{
  do { uint32_t val; do { val = (uint32_t)__builtin_arm_ldrex((volatile uint32_t *)&(LPUARTx->CR1)) & ~((0x1UL << (5U))); } while (((uint32_t)__builtin_arm_strex(val,(volatile uint32_t *)&(LPUARTx->CR1))) != 0U); } while(0);
}
...
static __inline void LL_LPUART_DisableIT_TC(USART_TypeDef *LPUARTx)
{
  do { uint32_t val; do { val = (uint32_t)__builtin_arm_ldrex((volatile uint32_t *)&(LPUARTx->CR1)) & ~((0x1UL << (6U))); } while (((uint32_t)__builtin_arm_strex(val,(volatile uint32_t *)&(LPUARTx->CR1))) != 0U); } while(0);
}
# 2126 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline void LL_LPUART_DisableIT_TXE_TXFNF(USART_TypeDef *LPUARTx)
{
  do { uint32_t val; do { val = (uint32_t)__builtin_arm_ldrex((volatile uint32_t *)&(LPUARTx->CR1)) & ~((0x1UL << (7U))); } while (((uint32_t)__builtin_arm_strex(val,(volatile uint32_t *)&(LPUARTx->CR1))) != 0U); } while(0);
}
...
static __inline void LL_LPUART_DisableIT_PE(USART_TypeDef *LPUARTx)
{
  do { uint32_t val; do { val = (uint32_t)__builtin_arm_ldrex((volatile uint32_t *)&(LPUARTx->CR1)) & ~((0x1UL << (8U))); } while (((uint32_t)__builtin_arm_strex(val,(volatile uint32_t *)&(LPUARTx->CR1))) != 0U); } while(0);
}
...
static __inline void LL_LPUART_DisableIT_CM(USART_TypeDef *LPUARTx)
{
  do { uint32_t val; do { val = (uint32_t)__builtin_arm_ldrex((volatile uint32_t *)&(LPUARTx->CR1)) & ~((0x1UL << (14U))); } while (((uint32_t)__builtin_arm_strex(val,(volatile uint32_t *)&(LPUARTx->CR1))) != 0U); } while(0);
}
...
static __inline void LL_LPUART_DisableIT_TXFE(USART_TypeDef *LPUARTx)
{
  do { uint32_t val; do { val = (uint32_t)__builtin_arm_ldrex((volatile uint32_t *)&(LPUARTx->CR1)) & ~((0x1UL << (30U))); } while (((uint32_t)__builtin_arm_strex(val,(volatile uint32_t *)&(LPUARTx->CR1))) != 0U); } while(0);
}
...
static __inline void LL_LPUART_DisableIT_RXFF(USART_TypeDef *LPUARTx)
{
  do { uint32_t val; do { val = (uint32_t)__builtin_arm_ldrex((volatile uint32_t *)&(LPUARTx->CR1)) & ~((0x1UL << (31U))); } while (((uint32_t)__builtin_arm_strex(val,(volatile uint32_t *)&(LPUARTx->CR1))) != 0U); } while(0);
}
# 2185 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline void LL_LPUART_DisableIT_ERROR(USART_TypeDef *LPUARTx)
{
  do { uint32_t val; do { val = (uint32_t)__builtin_arm_ldrex((volatile uint32_t *)&(LPUARTx->CR3)) & ~((0x1UL << (0U))); } while (((uint32_t)__builtin_arm_strex(val,(volatile uint32_t *)&(LPUARTx->CR3))) != 0U); } while(0);
}
...
static __inline void LL_LPUART_DisableIT_CTS(USART_TypeDef *LPUARTx)
{
  do { uint32_t val; do { val = (uint32_t)__builtin_arm_ldrex((volatile uint32_t *)&(LPUARTx->CR3)) & ~((0x1UL << (10U))); } while (((uint32_t)__builtin_arm_strex(val,(volatile uint32_t *)&(LPUARTx->CR3))) != 0U); } while(0);
}
...
static __inline void LL_LPUART_DisableIT_WKUP(USART_TypeDef *LPUARTx)
{
  do { uint32_t val; do { val = (uint32_t)__builtin_arm_ldrex((volatile uint32_t *)&(LPUARTx->CR3)) & ~((0x1UL << (22U))); } while (((uint32_t)__builtin_arm_strex(val,(volatile uint32_t *)&(LPUARTx->CR3))) != 0U); } while(0);
}
...
static __inline void LL_LPUART_DisableIT_TXFT(USART_TypeDef *LPUARTx)
{
  do { uint32_t val; do { val = (uint32_t)__builtin_arm_ldrex((volatile uint32_t *)&(LPUARTx->CR3)) & ~((0x1UL << (23U))); } while (((uint32_t)__builtin_arm_strex(val,(volatile uint32_t *)&(LPUARTx->CR3))) != 0U); } while(0);
}
...
static __inline void LL_LPUART_DisableIT_RXFT(USART_TypeDef *LPUARTx)
{
  do { uint32_t val; do { val = (uint32_t)__builtin_arm_ldrex((volatile uint32_t *)&(LPUARTx->CR3)) & ~((0x1UL << (28U))); } while (((uint32_t)__builtin_arm_strex(val,(volatile uint32_t *)&(LPUARTx->CR3))) != 0U); } while(0);
}
...
static __inline uint32_t LL_LPUART_IsEnabledIT_IDLE(USART_TypeDef *LPUARTx)
{
  return ((((LPUARTx->CR1) & ((0x1UL << (4U)))) == ((0x1UL << (4U)))) ? 1UL : 0UL);
}
# 2254 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline uint32_t LL_LPUART_IsEnabledIT_RXNE_RXFNE(USART_TypeDef *LPUARTx)
{
...
static __inline uint32_t LL_LPUART_IsEnabledIT_TC(USART_TypeDef *LPUARTx)
{
  return ((((LPUARTx->CR1) & ((0x1UL << (6U)))) == ((0x1UL << (6U)))) ? 1UL : 0UL);
}
# 2279 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline uint32_t LL_LPUART_IsEnabledIT_TXE_TXFNF(USART_TypeDef *LPUARTx)
{
...
static __inline uint32_t LL_LPUART_IsEnabledIT_PE(USART_TypeDef *LPUARTx)
{
...
static __inline uint32_t LL_LPUART_IsEnabledIT_CM(USART_TypeDef *LPUARTx)
{
...
static __inline uint32_t LL_LPUART_IsEnabledIT_TXFE(USART_TypeDef *LPUARTx)
{
...
static __inline uint32_t LL_LPUART_IsEnabledIT_RXFF(USART_TypeDef *LPUARTx)
{
...
static __inline uint32_t LL_LPUART_IsEnabledIT_ERROR(USART_TypeDef *LPUARTx)
{
...
static __inline uint32_t LL_LPUART_IsEnabledIT_CTS(USART_TypeDef *LPUARTx)
{
...
static __inline uint32_t LL_LPUART_IsEnabledIT_WKUP(USART_TypeDef *LPUARTx)
{
...
static __inline uint32_t LL_LPUART_IsEnabledIT_TXFT(USART_TypeDef *LPUARTx)
{
...
static __inline uint32_t LL_LPUART_IsEnabledIT_RXFT(USART_TypeDef *LPUARTx)
{
  return ((((LPUARTx->CR3) & ((0x1UL << (28U)))) == ((0x1UL << (28U)))) ? 1UL : 0UL);
}
# 2397 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline void LL_LPUART_EnableDMAReq_RX(USART_TypeDef *LPUARTx)
{
  do { uint32_t val; do { val = (uint32_t)__builtin_arm_ldrex((volatile uint32_t *)&(LPUARTx->CR3)) | ((0x1UL << (6U))); } while (((uint32_t)__builtin_arm_strex(val,(volatile uint32_t *)&(LPUARTx->CR3))) != 0U); } while(0);
}
...
static __inline void LL_LPUART_DisableDMAReq_RX(USART_TypeDef *LPUARTx)
{
  do { uint32_t val; do { val = (uint32_t)__builtin_arm_ldrex((volatile uint32_t *)&(LPUARTx->CR3)) & ~((0x1UL << (6U))); } while (((uint32_t)__builtin_arm_strex(val,(volatile uint32_t *)&(LPUARTx->CR3))) != 0U); } while(0);
}
...
static __inline uint32_t LL_LPUART_IsEnabledDMAReq_RX(USART_TypeDef *LPUARTx)
{
...
static __inline void LL_LPUART_EnableDMAReq_TX(USART_TypeDef *LPUARTx)
{
  do { uint32_t val; do { val = (uint32_t)__builtin_arm_ldrex((volatile uint32_t *)&(LPUARTx->CR3)) | ((0x1UL << (7U))); } while (((uint32_t)__builtin_arm_strex(val,(volatile uint32_t *)&(LPUARTx->CR3))) != 0U); } while(0);
}
...
static __inline void LL_LPUART_DisableDMAReq_TX(USART_TypeDef *LPUARTx)
{
  do { uint32_t val; do { val = (uint32_t)__builtin_arm_ldrex((volatile uint32_t *)&(LPUARTx->CR3)) & ~((0x1UL << (7U))); } while (((uint32_t)__builtin_arm_strex(val,(volatile uint32_t *)&(LPUARTx->CR3))) != 0U); } while(0);
}
...
static __inline uint32_t LL_LPUART_IsEnabledDMAReq_TX(USART_TypeDef *LPUARTx)
{
...
static __inline void LL_LPUART_EnableDMADeactOnRxErr(USART_TypeDef *LPUARTx)
{
...
static __inline void LL_LPUART_DisableDMADeactOnRxErr(USART_TypeDef *LPUARTx)
{
  ((LPUARTx->CR3) &= ~((0x1UL << (13U))));
}
...
static __inline uint32_t LL_LPUART_IsEnabledDMADeactOnRxErr(USART_TypeDef *LPUARTx)
{
  return ((((LPUARTx->CR3) & ((0x1UL << (13U)))) == ((0x1UL << (13U)))) ? 1UL : 0UL);
}
# 2500 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline uint32_t LL_LPUART_DMA_GetRegAddr(USART_TypeDef *LPUARTx, uint32_t Direction)
{
...
# 2532 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline uint8_t LL_LPUART_ReceiveData8(USART_TypeDef *LPUARTx)
{
  return (uint8_t)(((LPUARTx->RDR) & ((0x1FFUL << (0U)))) & 0xFFU);
}
...
static __inline uint16_t LL_LPUART_ReceiveData9(USART_TypeDef *LPUARTx)
{
  return (uint16_t)(((LPUARTx->RDR) & ((0x1FFUL << (0U)))));
}
# 2555 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline void LL_LPUART_TransmitData8(USART_TypeDef *LPUARTx, uint8_t Value)
{
  LPUARTx->TDR = Value;
}
# 2567 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline void LL_LPUART_TransmitData9(USART_TypeDef *LPUARTx, uint16_t Value)
{
  LPUARTx->TDR = Value & 0x1FFUL;
}
# 2586 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline void LL_LPUART_RequestBreakSending(USART_TypeDef *LPUARTx)
{
...
static __inline void LL_LPUART_RequestEnterMuteMode(USART_TypeDef *LPUARTx)
{
  ((LPUARTx->RQR) |= ((uint16_t)(0x1UL << (2U))));
}
# 2610 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
static __inline void LL_LPUART_RequestRxDataFlush(USART_TypeDef *LPUARTx)
{
  ((LPUARTx->RQR) |= ((uint16_t)(0x1UL << (3U))));
}
# 2623 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_lpuart.h"
ErrorStatus LL_LPUART_DeInit(USART_TypeDef *LPUARTx);
ErrorStatus LL_LPUART_Init(USART_TypeDef *LPUARTx, LL_LPUART_InitTypeDef *LPUART_InitStruct);
void LL_LPUART_StructInit(LL_LPUART_InitTypeDef *LPUART_InitStruct);
# 22 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_lpuart.c" 2
# 1 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h" 1
# 83 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
typedef struct
{
...
# 914 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 983 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 1035 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 1049 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 1077 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 1125 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 1171 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 1185 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 1207 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 1245 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 1283 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 1306 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 1318 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 1340 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 1353 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 1373 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 1389 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 1405 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 1424 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 1439 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 1454 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 1490 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 1521 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 1543 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 1559 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 1584 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 1600 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 1617 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 1632 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 1647 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 1661 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 1674 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 1694 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 1736 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 1760 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 1777 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 1808 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 1825 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 1845 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 1861 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 1878 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 1893 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 1907 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 1928 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 1970 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 1984 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 2053 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 2117 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 2187 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 2232 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 2247 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 2260 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 2312 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 2327 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 2342 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 2368 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 2392 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 2426 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 2460 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 2488 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 2736 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 2949 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 23 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_lpuart.c" 2
...
# 24 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_lpuart.c" 2
# 129 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_lpuart.c"
ErrorStatus LL_LPUART_DeInit(USART_TypeDef *LPUARTx)
{
  ...
  if (LPUARTx == ((USART_TypeDef *) ((0x40000000UL) + 0x8000UL)))
  {

    LL_APB1_GRP2_ForceReset((0x1UL << (0U)));


    LL_APB1_GRP2_ReleaseReset((0x1UL << (0U)));
  }
  else
  {
    status = ERROR;
...
# 167 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_lpuart.c"
ErrorStatus LL_LPUART_Init(USART_TypeDef *LPUARTx, LL_LPUART_InitTypeDef *LPUART_InitStruct)
{
  ...
  if (LL_LPUART_IsEnabled(LPUARTx) == 0U)
  {
    ...
    (((LPUARTx->CR1)) = ((((((LPUARTx->CR1))) & (~(((0x10001UL << (12U)) | (0x1UL << (10U)) | (0x1UL << (9U)) | (0x1UL << (3U)) | (0x1UL << (2U)))))) | ((LPUART_InitStruct->DataWidth | LPUART_InitStruct->Parity | LPUART_InitStruct->TransferDirection)))));
    ...
    periphclk = LL_RCC_GetLPUARTClockFreq((0x3UL << (10U)));
...
# 252 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_lpuart.c"
void LL_LPUART_StructInit(LL_LPUART_InitTypeDef *LPUART_InitStruct)
{

  LPUART_InitStruct->PrescalerValue = 0x00000000U;
  LPUART_InitStruct->BaudRate = 9600U;
  LPUART_InitStruct->DataWidth = 0x00000000U;
  LPUART_InitStruct->StopBits = 0x00000000U;
  LPUART_InitStruct->Parity = 0x00000000U ;
  LPUART_InitStruct->TransferDirection = ((0x1UL << (3U)) |(0x1UL << (2U)));
  LPUART_InitStruct->HardwareFlowControl = 0x00000000U;
}
