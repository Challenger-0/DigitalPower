# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_usb.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_usb.c" 2
# 42 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_usb.c"
...
# 43 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_usb.c" 2
# 64 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_usb.c"
HAL_StatusTypeDef USB_CoreInit(USB_TypeDef *USBx, USB_CfgTypeDef cfg)
{
...
HAL_StatusTypeDef USB_EnableGlobalInt(USB_TypeDef *USBx)
{
  ...
  winterruptmask = ((uint16_t)0x8000U) | ((uint16_t)0x1000U) |
                   ((uint16_t)0x0800U) | ((uint16_t)0x2000U) |
                   ((uint16_t)0x0200U) | ((uint16_t)0x0100U) |
                   ((uint16_t)0x0400U) | ((uint16_t)0x0080U);
...
# 133 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_usb.c"
HAL_StatusTypeDef USB_SetCurrentMode(USB_TypeDef *USBx, USB_ModeTypeDef mode)
{
...
# 154 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_usb.c"
HAL_StatusTypeDef USB_DevInit(USB_TypeDef *USBx, USB_CfgTypeDef cfg)
{
  ...
  USBx->CNTR = (uint16_t)((uint16_t)0x0001U);
...
# 182 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_usb.c"
HAL_StatusTypeDef USB_ActivateEndpoint(USB_TypeDef *USBx, USB_EPTypeDef *ep)
{
  HAL_StatusTypeDef ret = HAL_OK;
  uint16_t wEpRegVal;

  wEpRegVal = (*(volatile uint16_t *)(&(USBx)->EP0R + ((ep->num) * 2U))) & ((uint16_t) ~((uint16_t)0x0600U) & (((uint16_t)0x8000U)|((uint16_t)0x0800U)|((uint16_t)0x0600U)|((uint16_t)0x0100U)|((uint16_t)0x0080U)|((uint16_t)0x000FU)));


  switch (ep->type)
  {
    case 0U:
      wEpRegVal |= ((uint16_t)0x0200U);
      break;

    case 2U:
      wEpRegVal |= ((uint16_t)0x0000U);
      break;

    case 3U:
      wEpRegVal |= ((uint16_t)0x0600U);
      break;

    case 1U:
      wEpRegVal |= ((uint16_t)0x0400U);
      break;
  ...
  (*(volatile uint16_t *) (&(USBx)->EP0R + ((ep->num) * 2U)) = (uint16_t)((wEpRegVal | ((uint16_t)0x8000U) | ((uint16_t)0x0080U))));

  do { uint16_t _wRegVal; _wRegVal = ((*(volatile uint16_t *)(&((USBx))->EP0R + (((ep->num)) * 2U))) & (((uint16_t)0x8000U)|((uint16_t)0x0800U)|((uint16_t)0x0600U)|((uint16_t)0x0100U)|((uint16_t)0x0080U)|((uint16_t)0x000FU))) | (ep->num); (*(volatile uint16_t *) (&((USBx))->EP0R + (((ep->num)) * 2U)) = (uint16_t)((_wRegVal | ((uint16_t)0x8000U) | ((uint16_t)0x0080U)))); } while(0);
  ...
  if (ep->doublebuffer == 0U)
  {
    if (ep->is_in != 0U)
    {
      ...
      do { volatile uint16_t *_wRegVal; uint32_t _wRegBase = (uint32_t)USBx; _wRegBase += (uint32_t)(USBx)->BTABLE; _wRegVal = (volatile uint16_t *)(_wRegBase + 0x400U + (((uint32_t)(ep->num) * 8U) * 1U)); *_wRegVal = ((ep->pmaadress) >> 1) << 1; } while(0);
      do { uint16_t _wRegVal; _wRegVal = (*(volatile uint16_t *)(&((USBx))->EP0R + (((ep->num)) * 2U))); if ((_wRegVal & ((uint16_t)0x0040U)) != 0U) { do { uint16_t _wEPVal; _wEPVal = (*(volatile uint16_t *)(&(((USBx)))->EP0R + ((((ep->num))) * 2U))) & (((uint16_t)0x8000U)|((uint16_t)0x0800U)|((uint16_t)0x0600U)|((uint16_t)0x0100U)|((uint16_t)0x0080U)|((uint16_t)0x000FU)); (*(volatile uint16_t *) (&(((USBx)))->EP0R + ((((ep->num))) * 2U)) = (uint16_t)((_wEPVal | ((uint16_t)0x8000U) | ((uint16_t)0x0080U) | ((uint16_t)0x0040U)))); } while(0); } } while(0);

      if (ep->type != 1U)
      {

        do { uint16_t _wRegVal; _wRegVal = (*(volatile uint16_t *)(&((USBx))->EP0R + (((ep->num)) * 2U))) & (((uint16_t)0x0030U)|(((uint16_t)0x8000U)|((uint16_t)0x0800U)|((uint16_t)0x0600U)|((uint16_t)0x0100U)|((uint16_t)0x0080U)|((uint16_t)0x000FU))); if ((((uint16_t)0x0010U) & (((uint16_t)0x0020U)))!= 0U) { _wRegVal ^= ((uint16_t)0x0010U); } if ((((uint16_t)0x0020U) & (((uint16_t)0x0020U)))!= 0U) { _wRegVal ^= ((uint16_t)0x0020U); } (*(volatile uint16_t *) (&((USBx))->EP0R + (((ep->num)) * 2U)) = (uint16_t)((_wRegVal | ((uint16_t)0x8000U) | ((uint16_t)0x0080U)))); } while(0);
      }
      else
      {

        do { uint16_t _wRegVal; _wRegVal = (*(volatile uint16_t *)(&((USBx))->EP0R + (((ep->num)) * 2U))) & (((uint16_t)0x0030U)|(((uint16_t)0x8000U)|((uint16_t)0x0800U)|((uint16_t)0x0600U)|((uint16_t)0x0100U)|((uint16_t)0x0080U)|((uint16_t)0x000FU))); if ((((uint16_t)0x0010U) & (((uint16_t)0x0000U)))!= 0U) { _wRegVal ^= ((uint16_t)0x0010U); } if ((((uint16_t)0x0020U) & (((uint16_t)0x0000U)))!= 0U) { _wRegVal ^= ((uint16_t)0x0020U); } (*(volatile uint16_t *) (&((USBx))->EP0R + (((ep->num)) * 2U)) = (uint16_t)((_wRegVal | ((uint16_t)0x8000U) | ((uint16_t)0x0080U)))); } while(0);
      }
    }
    else
    {

      do { volatile uint16_t *_wRegVal; uint32_t _wRegBase = (uint32_t)USBx; _wRegBase += (uint32_t)(USBx)->BTABLE; _wRegVal = (volatile uint16_t *)(_wRegBase + 0x400U + ((((uint32_t)(ep->num) * 8U) + 4U) * 1U)); *_wRegVal = ((ep->pmaadress) >> 1) << 1; } while(0);


      do { uint32_t _wRegBase = (uint32_t)(USBx); volatile uint16_t *_wRegVal; _wRegBase += (uint32_t)(USBx)->BTABLE; _wRegVal = (volatile uint16_t *)(_wRegBase + 0x400U + ((((uint32_t)(ep->num) * 8U) + 6U) * 1U)); do { uint32_t wNBlocks; if (((ep->maxpacket)) > 62U) { do { (wNBlocks) = (((ep->maxpacket))) >> 5; if (((((ep->maxpacket))) & 0x1fU) == 0U) { (wNBlocks)--; } *((_wRegVal)) = (uint16_t)(((wNBlocks) << 10) | (0x1U << 15)); } while(0); } else { if (((ep->maxpacket)) == 0U) { *(_wRegVal) &= (uint16_t)~(0x1FU << 10); *(_wRegVal) |= (0x1U << 15); } else { do { (wNBlocks) = (((ep->maxpacket))) >> 1; if (((((ep->maxpacket))) & 0x1U) != 0U) { (wNBlocks)++; } *((_wRegVal)) = (uint16_t)((wNBlocks) << 10); } while(0); } } } while(0); } while(0);
      do { uint16_t _wRegVal; _wRegVal = (*(volatile uint16_t *)(&((USBx))->EP0R + (((ep->num)) * 2U))); if ((_wRegVal & ((uint16_t)0x4000U)) != 0U) { do { uint16_t _wEPVal; _wEPVal = (*(volatile uint16_t *)(&(((USBx)))->EP0R + ((((ep->num))) * 2U))) & (((uint16_t)0x8000U)|((uint16_t)0x0800U)|((uint16_t)0x0600U)|((uint16_t)0x0100U)|((uint16_t)0x0080U)|((uint16_t)0x000FU)); (*(volatile uint16_t *) (&(((USBx)))->EP0R + ((((ep->num))) * 2U)) = (uint16_t)((_wEPVal | ((uint16_t)0x8000U) | ((uint16_t)0x0080U) | ((uint16_t)0x4000U)))); } while(0); } } while(0);


      do { uint16_t _wRegVal; _wRegVal = (*(volatile uint16_t *)(&((USBx))->EP0R + (((ep->num)) * 2U))) & (((uint16_t)0x3000U)|(((uint16_t)0x8000U)|((uint16_t)0x0800U)|((uint16_t)0x0600U)|((uint16_t)0x0100U)|((uint16_t)0x0080U)|((uint16_t)0x000FU))); if ((((uint16_t)0x1000U) & (((uint16_t)0x3000U)))!= 0U) { _wRegVal ^= ((uint16_t)0x1000U); } if ((((uint16_t)0x2000U) & (((uint16_t)0x3000U)))!= 0U) { _wRegVal ^= ((uint16_t)0x2000U); } (*(volatile uint16_t *) (&((USBx))->EP0R + (((ep->num)) * 2U)) = (uint16_t)((_wRegVal | ((uint16_t)0x8000U) | ((uint16_t)0x0080U)))); } while(0);
    }
  }
  ...
  else
  {
    if (ep->type == 2U)
    {
      ...
      do { uint16_t _wRegVal; _wRegVal = (*(volatile uint16_t *)(&(((USBx)))->EP0R + ((((ep->num))) * 2U))) & (((uint16_t)0x8000U)|((uint16_t)0x0800U)|((uint16_t)0x0600U)|((uint16_t)0x0100U)|((uint16_t)0x0080U)|((uint16_t)0x000FU)); (*(volatile uint16_t *) (&(((USBx)))->EP0R + ((((ep->num))) * 2U)) = (uint16_t)((_wRegVal | ((uint16_t)0x8000U) | ((uint16_t)0x0080U) | ((uint16_t)0x0100U)))); } while(0);
    }
    else
    {

      do { uint16_t _wRegVal; _wRegVal = (*(volatile uint16_t *)(&((USBx))->EP0R + (((ep->num)) * 2U))) & ((uint16_t)~((uint16_t)0x0100U) & (((uint16_t)0x8000U)|((uint16_t)0x0800U)|((uint16_t)0x0600U)|((uint16_t)0x0100U)|((uint16_t)0x0080U)|((uint16_t)0x000FU))); (*(volatile uint16_t *) (&((USBx))->EP0R + (((ep->num)) * 2U)) = (uint16_t)((_wRegVal | ((uint16_t)0x8000U) | ((uint16_t)0x0080U)))); } while(0);
    }


    do { do { do { volatile uint16_t *_wRegVal; uint32_t _wRegBase = (uint32_t)((USBx)); _wRegBase += (uint32_t)(((USBx)))->BTABLE; _wRegVal = (volatile uint16_t *)(_wRegBase + 0x400U + (((uint32_t)(((ep->num))) * 8U) * 1U)); *_wRegVal = ((((ep->pmaaddr0))) >> 1) << 1; } while(0); } while(0); do { do { volatile uint16_t *_wRegVal; uint32_t _wRegBase = (uint32_t)((USBx)); _wRegBase += (uint32_t)(((USBx)))->BTABLE; _wRegVal = (volatile uint16_t *)(_wRegBase + 0x400U + ((((uint32_t)(((ep->num))) * 8U) + 4U) * 1U)); *_wRegVal = ((((ep->pmaaddr1))) >> 1) << 1; } while(0); } while(0); } while(0);
    ...
    else
    {
      ...
      do { uint16_t _wRegVal; _wRegVal = (*(volatile uint16_t *)(&((USBx))->EP0R + (((ep->num)) * 2U))) & (((uint16_t)0x3000U)|(((uint16_t)0x8000U)|((uint16_t)0x0800U)|((uint16_t)0x0600U)|((uint16_t)0x0100U)|((uint16_t)0x0080U)|((uint16_t)0x000FU))); if ((((uint16_t)0x1000U) & (((uint16_t)0x0000U)))!= 0U) { _wRegVal ^= ((uint16_t)0x1000U); } if ((((uint16_t)0x2000U) & (((uint16_t)0x0000U)))!= 0U) { _wRegVal ^= ((uint16_t)0x2000U); } (*(volatile uint16_t *) (&((USBx))->EP0R + (((ep->num)) * 2U)) = (uint16_t)((_wRegVal | ((uint16_t)0x8000U) | ((uint16_t)0x0080U)))); } while(0);
    }
  }
...
HAL_StatusTypeDef USB_DeactivateEndpoint(USB_TypeDef *USBx, USB_EPTypeDef *ep)
{
  ...
  else
  {
    if (ep->is_in == 0U)
    {
      ...
      do { uint16_t _wEPVal; _wEPVal = (*(volatile uint16_t *)(&((USBx))->EP0R + (((ep->num)) * 2U))) & (((uint16_t)0x8000U)|((uint16_t)0x0800U)|((uint16_t)0x0600U)|((uint16_t)0x0100U)|((uint16_t)0x0080U)|((uint16_t)0x000FU)); (*(volatile uint16_t *) (&((USBx))->EP0R + (((ep->num)) * 2U)) = (uint16_t)((_wEPVal | ((uint16_t)0x8000U) | ((uint16_t)0x0080U) | ((uint16_t)0x0040U)))); } while(0);
    ...
    else
    {
      ...
      do { uint16_t _wRegVal; _wRegVal = (*(volatile uint16_t *)(&((USBx))->EP0R + (((ep->num)) * 2U))); if ((_wRegVal & ((uint16_t)0x4000U)) != 0U) { do { uint16_t _wEPVal; _wEPVal = (*(volatile uint16_t *)(&(((USBx)))->EP0R + ((((ep->num))) * 2U))) & (((uint16_t)0x8000U)|((uint16_t)0x0800U)|((uint16_t)0x0600U)|((uint16_t)0x0100U)|((uint16_t)0x0080U)|((uint16_t)0x000FU)); (*(volatile uint16_t *) (&(((USBx)))->EP0R + ((((ep->num))) * 2U)) = (uint16_t)((_wEPVal | ((uint16_t)0x8000U) | ((uint16_t)0x0080U) | ((uint16_t)0x4000U)))); } while(0); } } while(0);
      do { uint16_t _wRegVal; _wRegVal = (*(volatile uint16_t *)(&((USBx))->EP0R + (((ep->num)) * 2U))); if ((_wRegVal & ((uint16_t)0x0040U)) != 0U) { do { uint16_t _wEPVal; _wEPVal = (*(volatile uint16_t *)(&(((USBx)))->EP0R + ((((ep->num))) * 2U))) & (((uint16_t)0x8000U)|((uint16_t)0x0800U)|((uint16_t)0x0600U)|((uint16_t)0x0100U)|((uint16_t)0x0080U)|((uint16_t)0x000FU)); (*(volatile uint16_t *) (&(((USBx)))->EP0R + ((((ep->num))) * 2U)) = (uint16_t)((_wEPVal | ((uint16_t)0x8000U) | ((uint16_t)0x0080U) | ((uint16_t)0x0040U)))); } while(0); } } while(0);
      do { uint16_t _wEPVal; _wEPVal = (*(volatile uint16_t *)(&((USBx))->EP0R + (((ep->num)) * 2U))) & (((uint16_t)0x8000U)|((uint16_t)0x0800U)|((uint16_t)0x0600U)|((uint16_t)0x0100U)|((uint16_t)0x0080U)|((uint16_t)0x000FU)); (*(volatile uint16_t *) (&((USBx))->EP0R + (((ep->num)) * 2U)) = (uint16_t)((_wEPVal | ((uint16_t)0x8000U) | ((uint16_t)0x0080U) | ((uint16_t)0x4000U)))); } while(0);
...
HAL_StatusTypeDef USB_EPStartXfer(USB_TypeDef *USBx, USB_EPTypeDef *ep)
{
  ...
  if (ep->is_in == 1U)
  {
    ...
    if (ep->doublebuffer == 0U)
    {
      ...
      do { uint32_t _wRegBase = (uint32_t)(USBx); volatile uint16_t *_wRegVal; _wRegBase += (uint32_t)(USBx)->BTABLE; _wRegVal = (volatile uint16_t *)(_wRegBase + 0x400U + ((((uint32_t)(ep->num) * 8U) + 2U) * 1U)); *_wRegVal = (uint16_t)(len); } while(0);
    }
    ...
    else
    {
      ...
      if (ep->type == 2U)
      {
        if (ep->xfer_len_db > ep->maxpacket)
        {
          ...
          if (((*(volatile uint16_t *)(&(USBx)->EP0R + ((ep->num) * 2U))) & ((uint16_t)0x0040U)) != 0U)
          {

            do { uint32_t _wBase = (uint32_t)(USBx); volatile uint16_t *_wEPRegVal; if ((ep->is_in) == 0U) { do { uint32_t _wRegBase = (uint32_t)((USBx)); volatile uint16_t *_wRegVal; _wRegBase += (uint32_t)((USBx))->BTABLE; _wRegVal = (volatile uint16_t *)(_wRegBase + 0x400U + ((((uint32_t)((ep->num)) * 8U) + 6U) * 1U)); do { uint32_t wNBlocks; if ((((len))) > 62U) { do { (wNBlocks) = ((((len)))) >> 5; if ((((((len)))) & 0x1fU) == 0U) { (wNBlocks)--; } *((_wRegVal)) = (uint16_t)(((wNBlocks) << 10) | (0x1U << 15)); } while(0); } else { if ((((len))) == 0U) { *(_wRegVal) &= (uint16_t)~(0x1FU << 10); *(_wRegVal) |= (0x1U << 15); } else { do { (wNBlocks) = ((((len)))) >> 1; if ((((((len)))) & 0x1U) != 0U) { (wNBlocks)++; } *((_wRegVal)) = (uint16_t)((wNBlocks) << 10); } while(0); } } } while(0); } while(0); } else { if ((ep->is_in) == 1U) { _wBase += (uint32_t)(USBx)->BTABLE; _wEPRegVal = (volatile uint16_t *)(_wBase + 0x400U + ((((uint32_t)(ep->num) * 8U) + 6U) * 1U)); *_wEPRegVal = (uint16_t)(len); } } } while(0);
            ...
            do { if ((ep->is_in) == 0U) { do { uint32_t _wRegBase = (uint32_t)((USBx)); volatile uint16_t *pdwReg; _wRegBase += (uint32_t)((USBx))->BTABLE; pdwReg = (volatile uint16_t *)(_wRegBase + 0x400U + ((((uint32_t)((ep->num)) * 8U) + 2U) * 1U)); do { uint32_t wNBlocks; if ((((len))) > 62U) { do { (wNBlocks) = ((((len)))) >> 5; if ((((((len)))) & 0x1fU) == 0U) { (wNBlocks)--; } *((pdwReg)) = (uint16_t)(((wNBlocks) << 10) | (0x1U << 15)); } while(0); } else { if ((((len))) == 0U) { *(pdwReg) &= (uint16_t)~(0x1FU << 10); *(pdwReg) |= (0x1U << 15); } else { do { (wNBlocks) = ((((len)))) >> 1; if ((((((len)))) & 0x1U) != 0U) { (wNBlocks)++; } *((pdwReg)) = (uint16_t)((wNBlocks) << 10); } while(0); } } } while(0); } while(0); } else { if ((ep->is_in) == 1U) { do { uint32_t _wRegBase = (uint32_t)((USBx)); volatile uint16_t *_wRegVal; _wRegBase += (uint32_t)((USBx))->BTABLE; _wRegVal = (volatile uint16_t *)(_wRegBase + 0x400U + ((((uint32_t)((ep->num)) * 8U) + 2U) * 1U)); *_wRegVal = (uint16_t)((len)); } while(0); } } } while(0);
    ...
    do { uint16_t _wRegVal; _wRegVal = (*(volatile uint16_t *)(&((USBx))->EP0R + (((ep->num)) * 2U))) & (((uint16_t)0x0030U)|(((uint16_t)0x8000U)|((uint16_t)0x0800U)|((uint16_t)0x0600U)|((uint16_t)0x0100U)|((uint16_t)0x0080U)|((uint16_t)0x000FU))); if ((((uint16_t)0x0010U) & (((uint16_t)0x0030U)))!= 0U) { _wRegVal ^= ((uint16_t)0x0010U); } if ((((uint16_t)0x0020U) & (((uint16_t)0x0030U)))!= 0U) { _wRegVal ^= ((uint16_t)0x0020U); } (*(volatile uint16_t *) (&((USBx))->EP0R + (((ep->num)) * 2U)) = (uint16_t)((_wRegVal | ((uint16_t)0x8000U) | ((uint16_t)0x0080U)))); } while(0);
  }
  else
  {
    if (ep->doublebuffer == 0U)
    ...
    else
    {
      ...
      if (ep->type == 2U)
      {
        do { do { if (((ep->is_in)) == 0U) { do { uint32_t _wRegBase = (uint32_t)(((USBx))); volatile uint16_t *pdwReg; _wRegBase += (uint32_t)(((USBx)))->BTABLE; pdwReg = (volatile uint16_t *)(_wRegBase + 0x400U + ((((uint32_t)(((ep->num))) * 8U) + 2U) * 1U)); do { uint32_t wNBlocks; if (((((ep->maxpacket)))) > 62U) { do { (wNBlocks) = (((((ep->maxpacket))))) >> 5; if (((((((ep->maxpacket))))) & 0x1fU) == 0U) { (wNBlocks)--; } *((pdwReg)) = (uint16_t)(((wNBlocks) << 10) | (0x1U << 15)); } while(0); } else { if (((((ep->maxpacket)))) == 0U) { *(pdwReg) &= (uint16_t)~(0x1FU << 10); *(pdwReg) |= (0x1U << 15); } else { do { (wNBlocks) = (((((ep->maxpacket))))) >> 1; if (((((((ep->maxpacket))))) & 0x1U) != 0U) { (wNBlocks)++; } *((pdwReg)) = (uint16_t)((wNBlocks) << 10); } while(0); } } } while(0); } while(0); } else { if (((ep->is_in)) == 1U) { do { uint32_t _wRegBase = (uint32_t)(((USBx))); volatile uint16_t *_wRegVal; _wRegBase += (uint32_t)(((USBx)))->BTABLE; _wRegVal = (volatile uint16_t *)(_wRegBase + 0x400U + ((((uint32_t)(((ep->num))) * 8U) + 2U) * 1U)); *_wRegVal = (uint16_t)(((ep->maxpacket))); } while(0); } } } while(0); do { uint32_t _wBase = (uint32_t)((USBx)); volatile uint16_t *_wEPRegVal; if (((ep->is_in)) == 0U) { do { uint32_t _wRegBase = (uint32_t)(((USBx))); volatile uint16_t *_wRegVal; _wRegBase += (uint32_t)(((USBx)))->BTABLE; _wRegVal = (volatile uint16_t *)(_wRegBase + 0x400U + ((((uint32_t)(((ep->num))) * 8U) + 6U) * 1U)); do { uint32_t wNBlocks; if (((((ep->maxpacket)))) > 62U) { do { (wNBlocks) = (((((ep->maxpacket))))) >> 5; if (((((((ep->maxpacket))))) & 0x1fU) == 0U) { (wNBlocks)--; } *((_wRegVal)) = (uint16_t)(((wNBlocks) << 10) | (0x1U << 15)); } while(0); } else { if (((((ep->maxpacket)))) == 0U) { *(_wRegVal) &= (uint16_t)~(0x1FU << 10); *(_wRegVal) |= (0x1U << 15); } else { do { (wNBlocks) = (((((ep->maxpacket))))) >> 1; if (((((((ep->maxpacket))))) & 0x1U) != 0U) { (wNBlocks)++; } *((_wRegVal)) = (uint16_t)((wNBlocks) << 10); } while(0); } } } while(0); } while(0); } else { if (((ep->is_in)) == 1U) { _wBase += (uint32_t)((USBx))->BTABLE; _wEPRegVal = (volatile uint16_t *)(_wBase + 0x400U + ((((uint32_t)((ep->num)) * 8U) + 6U) * 1U)); *_wEPRegVal = (uint16_t)((ep->maxpacket)); } } } while(0); } while(0);


        if (ep->xfer_count != 0U)
        {

          wEPVal = (*(volatile uint16_t *)(&(USBx)->EP0R + ((ep->num) * 2U)));


          if ((((wEPVal & ((uint16_t)0x4000U)) != 0U) && ((wEPVal & ((uint16_t)0x0040U)) != 0U)) ||
              (((wEPVal & ((uint16_t)0x4000U)) == 0U) && ((wEPVal & ((uint16_t)0x0040U)) == 0U)))
          {
            do { if ((0U) == 0U) { do { uint16_t _wEPVal; _wEPVal = (*(volatile uint16_t *)(&(((USBx)))->EP0R + ((((ep->num))) * 2U))) & (((uint16_t)0x8000U)|((uint16_t)0x0800U)|((uint16_t)0x0600U)|((uint16_t)0x0100U)|((uint16_t)0x0080U)|((uint16_t)0x000FU)); (*(volatile uint16_t *) (&(((USBx)))->EP0R + ((((ep->num))) * 2U)) = (uint16_t)((_wEPVal | ((uint16_t)0x8000U) | ((uint16_t)0x0080U) | ((uint16_t)0x0040U)))); } while(0); } else if ((0U) == 1U) { do { uint16_t _wEPVal; _wEPVal = (*(volatile uint16_t *)(&(((USBx)))->EP0R + ((((ep->num))) * 2U))) & (((uint16_t)0x8000U)|((uint16_t)0x0800U)|((uint16_t)0x0600U)|((uint16_t)0x0100U)|((uint16_t)0x0080U)|((uint16_t)0x000FU)); (*(volatile uint16_t *) (&(((USBx)))->EP0R + ((((ep->num))) * 2U)) = (uint16_t)((_wEPVal | ((uint16_t)0x8000U) | ((uint16_t)0x0080U) | ((uint16_t)0x4000U)))); } while(0); } } while(0);
          }
        }
      }
      ...
      else if (ep->type == 1U)
      {
        ...
        do { do { if (((ep->is_in)) == 0U) { do { uint32_t _wRegBase = (uint32_t)(((USBx))); volatile uint16_t *pdwReg; _wRegBase += (uint32_t)(((USBx)))->BTABLE; pdwReg = (volatile uint16_t *)(_wRegBase + 0x400U + ((((uint32_t)(((ep->num))) * 8U) + 2U) * 1U)); do { uint32_t wNBlocks; if (((((len)))) > 62U) { do { (wNBlocks) = (((((len))))) >> 5; if (((((((len))))) & 0x1fU) == 0U) { (wNBlocks)--; } *((pdwReg)) = (uint16_t)(((wNBlocks) << 10) | (0x1U << 15)); } while(0); } else { if (((((len)))) == 0U) { *(pdwReg) &= (uint16_t)~(0x1FU << 10); *(pdwReg) |= (0x1U << 15); } else { do { (wNBlocks) = (((((len))))) >> 1; if (((((((len))))) & 0x1U) != 0U) { (wNBlocks)++; } *((pdwReg)) = (uint16_t)((wNBlocks) << 10); } while(0); } } } while(0); } while(0); } else { if (((ep->is_in)) == 1U) { do { uint32_t _wRegBase = (uint32_t)(((USBx))); volatile uint16_t *_wRegVal; _wRegBase += (uint32_t)(((USBx)))->BTABLE; _wRegVal = (volatile uint16_t *)(_wRegBase + 0x400U + ((((uint32_t)(((ep->num))) * 8U) + 2U) * 1U)); *_wRegVal = (uint16_t)(((len))); } while(0); } } } while(0); do { uint32_t _wBase = (uint32_t)((USBx)); volatile uint16_t *_wEPRegVal; if (((ep->is_in)) == 0U) { do { uint32_t _wRegBase = (uint32_t)(((USBx))); volatile uint16_t *_wRegVal; _wRegBase += (uint32_t)(((USBx)))->BTABLE; _wRegVal = (volatile uint16_t *)(_wRegBase + 0x400U + ((((uint32_t)(((ep->num))) * 8U) + 6U) * 1U)); do { uint32_t wNBlocks; if (((((len)))) > 62U) { do { (wNBlocks) = (((((len))))) >> 5; if (((((((len))))) & 0x1fU) == 0U) { (wNBlocks)--; } *((_wRegVal)) = (uint16_t)(((wNBlocks) << 10) | (0x1U << 15)); } while(0); } else { if (((((len)))) == 0U) { *(_wRegVal) &= (uint16_t)~(0x1FU << 10); *(_wRegVal) |= (0x1U << 15); } else { do { (wNBlocks) = (((((len))))) >> 1; if (((((((len))))) & 0x1U) != 0U) { (wNBlocks)++; } *((_wRegVal)) = (uint16_t)((wNBlocks) << 10); } while(0); } } } while(0); } while(0); } else { if (((ep->is_in)) == 1U) { _wBase += (uint32_t)((USBx))->BTABLE; _wEPRegVal = (volatile uint16_t *)(_wBase + 0x400U + ((((uint32_t)((ep->num)) * 8U) + 6U) * 1U)); *_wEPRegVal = (uint16_t)((len)); } } } while(0); } while(0);
      }
      else
      {
        return HAL_ERROR;
...
# 586 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_usb.c"
HAL_StatusTypeDef USB_EPSetStall(USB_TypeDef *USBx, USB_EPTypeDef *ep)
{
  if (ep->is_in != 0U)
  {
    do { uint16_t _wRegVal; _wRegVal = (*(volatile uint16_t *)(&((USBx))->EP0R + (((ep->num)) * 2U))) & (((uint16_t)0x0030U)|(((uint16_t)0x8000U)|((uint16_t)0x0800U)|((uint16_t)0x0600U)|((uint16_t)0x0100U)|((uint16_t)0x0080U)|((uint16_t)0x000FU))); if ((((uint16_t)0x0010U) & (((uint16_t)0x0010U)))!= 0U) { _wRegVal ^= ((uint16_t)0x0010U); } if ((((uint16_t)0x0020U) & (((uint16_t)0x0010U)))!= 0U) { _wRegVal ^= ((uint16_t)0x0020U); } (*(volatile uint16_t *) (&((USBx))->EP0R + (((ep->num)) * 2U)) = (uint16_t)((_wRegVal | ((uint16_t)0x8000U) | ((uint16_t)0x0080U)))); } while(0);
  }
  else
  {
    do { uint16_t _wRegVal; _wRegVal = (*(volatile uint16_t *)(&((USBx))->EP0R + (((ep->num)) * 2U))) & (((uint16_t)0x3000U)|(((uint16_t)0x8000U)|((uint16_t)0x0800U)|((uint16_t)0x0600U)|((uint16_t)0x0100U)|((uint16_t)0x0080U)|((uint16_t)0x000FU))); if ((((uint16_t)0x1000U) & (((uint16_t)0x1000U)))!= 0U) { _wRegVal ^= ((uint16_t)0x1000U); } if ((((uint16_t)0x2000U) & (((uint16_t)0x1000U)))!= 0U) { _wRegVal ^= ((uint16_t)0x2000U); } (*(volatile uint16_t *) (&((USBx))->EP0R + (((ep->num)) * 2U)) = (uint16_t)((_wRegVal | ((uint16_t)0x8000U) | ((uint16_t)0x0080U)))); } while(0);
  }
...
HAL_StatusTypeDef USB_StopDevice(USB_TypeDef *USBx)
{
  ...
  USBx->CNTR = (uint16_t)(((uint16_t)0x0001U) | ((uint16_t)0x0002U));

  return HAL_OK;
}
# 659 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_usb.c"
HAL_StatusTypeDef USB_SetDevAddress(USB_TypeDef *USBx, uint8_t address)
{
  if (address == 0U)
  {

    USBx->DADDR = (uint16_t)((uint8_t)0x80U);
  }
...
HAL_StatusTypeDef USB_DevConnect(USB_TypeDef *USBx)
{
  ...
  USBx->BCDR |= (uint16_t)((uint16_t)0x8000U);
...
HAL_StatusTypeDef USB_ActivateRemoteWakeup(USB_TypeDef *USBx)
{
  USBx->CNTR |= (uint16_t)((uint16_t)0x0010U);
...
# 741 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_usb.c"
void USB_WritePMA(USB_TypeDef *USBx, uint8_t *pbUsrBuf, uint16_t wPMABufAddr, uint16_t wNBytes)
{
  ...
  pdwVal = (volatile uint16_t *)(BaseAddr + 0x400U + ((uint32_t)wPMABufAddr * 1U));
...
# 777 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_usb.c"
