# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_rng.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_rng.c" 2
# 21 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_rng.c"
# 1 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rng.h" 1
# 28 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rng.h"
...
# 29 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rng.h" 2
# 55 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rng.h"
typedef struct
{
...
# 155 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rng.h"
static __inline void LL_RNG_Enable(RNG_TypeDef *RNGx)
{
  ((RNGx->CR) |= ((0x1UL << (2U))));
}
...
static __inline void LL_RNG_Disable(RNG_TypeDef *RNGx)
{
  ((RNGx->CR) &= ~((0x1UL << (2U))));
}
...
static __inline uint32_t LL_RNG_IsEnabled(RNG_TypeDef *RNGx)
{
...
static __inline void LL_RNG_EnableClkErrorDetect(RNG_TypeDef *RNGx)
{
  ((RNGx->CR) &= ~((0x1UL << (3U))));
}
...
static __inline void LL_RNG_DisableClkErrorDetect(RNG_TypeDef *RNGx)
{
  ((RNGx->CR) |= ((0x1UL << (3U))));
}
...
static __inline uint32_t LL_RNG_IsEnabledClkErrorDetect(RNG_TypeDef *RNGx)
{
  return ((((RNGx->CR) & ((0x1UL << (3U)))) != ((0x1UL << (3U)))) ? 1UL : 0UL);
}
# 229 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rng.h"
static __inline uint32_t LL_RNG_IsActiveFlag_DRDY(RNG_TypeDef *RNGx)
{
...
static __inline uint32_t LL_RNG_IsActiveFlag_CECS(RNG_TypeDef *RNGx)
{
...
static __inline uint32_t LL_RNG_IsActiveFlag_SECS(RNG_TypeDef *RNGx)
{
...
static __inline uint32_t LL_RNG_IsActiveFlag_CEIS(RNG_TypeDef *RNGx)
{
...
static __inline uint32_t LL_RNG_IsActiveFlag_SEIS(RNG_TypeDef *RNGx)
{
...
static __inline void LL_RNG_ClearFlag_CEIS(RNG_TypeDef *RNGx)
{
  ((RNGx->SR) = (~(0x1UL << (5U))));
}
...
static __inline void LL_RNG_ClearFlag_SEIS(RNG_TypeDef *RNGx)
{
  ((RNGx->SR) = (~(0x1UL << (6U))));
}
# 315 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rng.h"
static __inline void LL_RNG_EnableIT(RNG_TypeDef *RNGx)
{
  ((RNGx->CR) |= ((0x1UL << (3U))));
}
# 327 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rng.h"
static __inline void LL_RNG_DisableIT(RNG_TypeDef *RNGx)
{
  ((RNGx->CR) &= ~((0x1UL << (3U))));
}
# 339 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rng.h"
static __inline uint32_t LL_RNG_IsEnabledIT(RNG_TypeDef *RNGx)
{
  return ((((RNGx->CR) & ((0x1UL << (3U)))) == ((0x1UL << (3U)))) ? 1UL : 0UL);
}
# 358 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rng.h"
static __inline uint32_t LL_RNG_ReadRandData32(RNG_TypeDef *RNGx)
{
  return (uint32_t)(((RNGx->DR)));
}
# 371 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rng.h"
ErrorStatus LL_RNG_Init(RNG_TypeDef *RNGx, LL_RNG_InitTypeDef *RNG_InitStruct);
void LL_RNG_StructInit(LL_RNG_InitTypeDef *RNG_InitStruct);
ErrorStatus LL_RNG_DeInit(RNG_TypeDef *RNGx);
# 22 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_rng.c" 2
...
# 23 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_rng.c" 2
# 71 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_rng.c"
ErrorStatus LL_RNG_DeInit(RNG_TypeDef *RNGx)
{
  ...
  ((void)0U);
  if (RNGx == ((RNG_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x08060800UL)))
  {

    LL_AHB2_GRP1_ForceReset((0x1UL << (26U)));


    LL_AHB2_GRP1_ReleaseReset((0x1UL << (26U)));
  }
  else
  {
    status = ERROR;
...
# 102 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_rng.c"
ErrorStatus LL_RNG_Init(RNG_TypeDef *RNGx, LL_RNG_InitTypeDef *RNG_InitStruct)
{
  ...
  (((RNGx->CR)) = ((((((RNGx->CR))) & (~((0x1UL << (3U))))) | (RNG_InitStruct->ClockErrorDetection))));
...
void LL_RNG_StructInit(LL_RNG_InitTypeDef *RNG_InitStruct)
{
  ...
  RNG_InitStruct->ClockErrorDetection = 0x00000000U;
