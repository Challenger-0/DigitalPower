# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_gpio.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_gpio.c" 2
# 106 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_gpio.c"
...
# 107 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_gpio.c" 2
# 162 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_gpio.c"
void HAL_GPIO_Init(GPIO_TypeDef *GPIOx, GPIO_InitTypeDef *GPIO_Init)
{
  ...
  while (((GPIO_Init->Pin) >> position) != 0U)
  {
    ...
    if (iocurrent != 0x00u)
    {
      ...
      if(((GPIO_Init->Mode & (0x3UL << 0U)) == (0x1UL << 0U)) ||
         ((GPIO_Init->Mode & (0x3UL << 0U)) == (0x2UL << 0U)))
      {
        ...
        temp |= (((GPIO_Init->Mode & (0x1UL << 4U)) >> 4U) << position);
        GPIOx->OTYPER = temp;
      }

      if ((GPIO_Init->Mode & (0x3UL << 0U)) != (0x3UL << 0U))
      {
      ...
      if ((GPIO_Init->Mode & (0x3UL << 0U)) == (0x2UL << 0U))
      {
      ...
      temp = GPIOx->MODER;
      temp &= ~((0x3UL << (0U)) << (position * 2U));
      temp |= ((GPIO_Init->Mode & (0x3UL << 0U)) << (position * 2U));
      GPIOx->MODER = temp;



      if ((GPIO_Init->Mode & (0x3UL << 16U)) != 0x00u)
      {

        do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB2ENR) |= ((0x1UL << (0U)))); tmpreg = ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB2ENR) & ((0x1UL << (0U)))); (void)tmpreg; } while(0);

        temp = ((SYSCFG_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0000UL))->EXTICR[position >> 2U];
        temp &= ~(0x0FUL << (4U * (position & 0x03U)));
        temp |= ((((GPIOx) == (((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0000UL))))? 0UL : ((GPIOx) == (((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0400UL))))? 1UL : ((GPIOx) == (((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0800UL))))? 2UL : ((GPIOx) == (((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0C00UL))))? 3UL : ((GPIOx) == (((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x1000UL))))? 4UL : ((GPIOx) == (((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x1400UL))))? 5UL : 6UL) << (4U * (position & 0x03U)));
        ((SYSCFG_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0000UL))->EXTICR[position >> 2U] = temp;


        temp = ((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->RTSR1;
        temp &= ~(iocurrent);
        if ((GPIO_Init->Mode & (0x1UL << 20U)) != 0x00U)
        {
          temp |= iocurrent;
        }
        ((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->RTSR1 = temp;

        temp = ((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->FTSR1;
        temp &= ~(iocurrent);
        if ((GPIO_Init->Mode & (0x2UL << 20U)) != 0x00U)
        {
          temp |= iocurrent;
        }
        ((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->FTSR1 = temp;

        temp = ((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->EMR1;
        temp &= ~(iocurrent);
        if ((GPIO_Init->Mode & (0x2UL << 16U)) != 0x00U)
        {
          temp |= iocurrent;
        }
        ((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->EMR1 = temp;


        temp = ((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->IMR1;
        temp &= ~(iocurrent);
        if ((GPIO_Init->Mode & (0x1UL << 16U)) != 0x00U)
        {
          temp |= iocurrent;
        }
        ((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->IMR1 = temp;
      }
    }
...
# 292 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_gpio.c"
void HAL_GPIO_DeInit(GPIO_TypeDef *GPIOx, uint32_t GPIO_Pin)
{
  uint32_t position = 0x00U;
  uint32_t iocurrent;
  ...
  while ((GPIO_Pin >> position) != 0U)
  {
    ...
    if (iocurrent != 0x00u)
    {
      ...
      tmp = ((SYSCFG_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0000UL))->EXTICR[position >> 2U];
      tmp &= (0x0FUL << (4U * (position & 0x03U)));
      if (tmp == ((((GPIOx) == (((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0000UL))))? 0UL : ((GPIOx) == (((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0400UL))))? 1UL : ((GPIOx) == (((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0800UL))))? 2UL : ((GPIOx) == (((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0C00UL))))? 3UL : ((GPIOx) == (((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x1000UL))))? 4UL : ((GPIOx) == (((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x1400UL))))? 5UL : 6UL) << (4U * (position & 0x03U))))
      {

        ((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->IMR1 &= ~(iocurrent);
        ((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->EMR1 &= ~(iocurrent);


        ((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->FTSR1 &= ~(iocurrent);
        ((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->RTSR1 &= ~(iocurrent);

        tmp = 0x0FUL << (4U * (position & 0x03U));
        ((SYSCFG_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0000UL))->EXTICR[position >> 2U] &= ~tmp;
      }



      GPIOx->MODER |= ((0x3UL << (0U)) << (position * 2u));


      GPIOx->AFR[position >> 3u] &= ~(0xFu << ((position & 0x07u) * 4u));


      GPIOx->PUPDR &= ~((0x3UL << (0U)) << (position * 2u));


      GPIOx->OTYPER &= ~((0x1UL << (0U)) << position);


      GPIOx->OSPEEDR &= ~((0x3UL << (0U)) << (position * 2u));
    }

    position++;
  }
}
# 373 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_gpio.c"
GPIO_PinState HAL_GPIO_ReadPin(GPIO_TypeDef *GPIOx, uint16_t GPIO_Pin)
{
...
# 407 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_gpio.c"
void HAL_GPIO_WritePin(GPIO_TypeDef *GPIOx, uint16_t GPIO_Pin, GPIO_PinState PinState)
{
...
# 430 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_gpio.c"
void HAL_GPIO_TogglePin(GPIO_TypeDef *GPIOx, uint16_t GPIO_Pin)
{
  uint32_t odr;
...
# 455 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_gpio.c"
HAL_StatusTypeDef HAL_GPIO_LockPin(GPIO_TypeDef *GPIOx, uint16_t GPIO_Pin)
{
...
void HAL_GPIO_EXTI_IRQHandler(uint16_t GPIO_Pin)
{
  ...
  if ((((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->PR1 & (GPIO_Pin)) != 0x00u)
  {
    (((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->PR1 = (GPIO_Pin));
