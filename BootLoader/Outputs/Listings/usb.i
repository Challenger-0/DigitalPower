# 1 "CubeMX/Core/Src/usb.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "CubeMX/Core/Src/usb.c" 2
# 21 "CubeMX/Core/Src/usb.c"
# 1 "./CubeMX/Core/Inc\\usb.h" 1
# 29 "./CubeMX/Core/Inc\\usb.h"
...
void MX_USB_PCD_Init(void)
{
# 41 "CubeMX/Core/Src/usb.c"
  hpcd_USB_FS.Instance = ((USB_TypeDef *) ((0x40000000UL) + 0x5C00UL));
  hpcd_USB_FS.Init.dev_endpoints = 8;
  hpcd_USB_FS.Init.speed = 2U;
  hpcd_USB_FS.Init.phy_itface = 2U;
...
void HAL_PCD_MspInit(PCD_HandleTypeDef* pcdHandle)
{
  ...
  if(pcdHandle->Instance==((USB_TypeDef *) ((0x40000000UL) + 0x5C00UL)))
  {
    ...
    PeriphClkInit.PeriphClockSelection = 0x00002000U;
    PeriphClkInit.UsbClockSelection = 0x00000000U;
    ...
    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB1ENR1) |= ((0x1UL << (23U)))); tmpreg = ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB1ENR1) & ((0x1UL << (23U)))); (void)tmpreg; } while(0);
...
void HAL_PCD_MspDeInit(PCD_HandleTypeDef* pcdHandle)
{
  ...
  if(pcdHandle->Instance==((USB_TypeDef *) ((0x40000000UL) + 0x5C00UL)))
  {
    ...
    ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB1ENR1) &= ~((0x1UL << (23U))));
