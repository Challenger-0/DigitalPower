# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_ucpd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_ucpd.c" 2
# 21 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_ucpd.c"
# 1 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_ucpd.h" 1
# 28 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_ucpd.h"
...
# 29 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_ucpd.h" 2
# 53 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_ucpd.h"
typedef struct
{
...
# 346 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_ucpd.h"
static __inline void LL_UCPD_Enable(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->CFG1) |= ((0x1UL << (31U))));
}
# 358 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_ucpd.h"
static __inline void LL_UCPD_Disable(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->CFG1) &= ~((0x1UL << (31U))));
}
...
static __inline uint32_t LL_UCPD_IsEnabled(UCPD_TypeDef const *const UCPDx)
{
  return ((((UCPDx->CFG1) & ((0x1UL << (31U)))) == ((0x1UL << (31U)))) ? 1UL : 0UL);
}
# 390 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_ucpd.h"
static __inline void LL_UCPD_SetRxOrderSet(UCPD_TypeDef *UCPDx, uint32_t OrderSet)
{
  (((UCPDx->CFG1)) = ((((((UCPDx->CFG1))) & (~((0x1FFUL << (20U))))) | (OrderSet))));
}
# 407 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_ucpd.h"
static __inline void LL_UCPD_SetPSCClk(UCPD_TypeDef *UCPDx, uint32_t Psc)
{
  (((UCPDx->CFG1)) = ((((((UCPDx->CFG1))) & (~((0x7UL << (17U))))) | (Psc))));
}
# 419 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_ucpd.h"
static __inline void LL_UCPD_SetTransWin(UCPD_TypeDef *UCPDx, uint32_t TransWin)
{
  (((UCPDx->CFG1)) = ((((((UCPDx->CFG1))) & (~((0x1FUL << (11U))))) | (TransWin << (11U)))));
}
# 431 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_ucpd.h"
static __inline void LL_UCPD_SetIfrGap(UCPD_TypeDef *UCPDx, uint32_t IfrGap)
{
  (((UCPDx->CFG1)) = ((((((UCPDx->CFG1))) & (~((0x1FUL << (6U))))) | (IfrGap << (6U)))));
}
# 443 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_ucpd.h"
static __inline void LL_UCPD_SetHbitClockDiv(UCPD_TypeDef *UCPDx, uint32_t HbitClock)
{
  (((UCPDx->CFG1)) = ((((((UCPDx->CFG1))) & (~((0x3FUL << (0U))))) | (HbitClock << (0U)))));
}
# 462 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_ucpd.h"
static __inline void LL_UCPD_WakeUpEnable(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->CFG2) |= ((0x1UL << (3U))));
}
...
static __inline void LL_UCPD_WakeUpDisable(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->CFG2) &= ~((0x1UL << (3U))));
}
...
static __inline void LL_UCPD_ForceClockEnable(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->CFG2) |= ((0x1UL << (2U))));
}
...
static __inline void LL_UCPD_ForceClockDisable(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->CFG2) &= ~((0x1UL << (2U))));
}
...
static __inline void LL_UCPD_RxFilterEnable(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->CFG2) &= ~((0x1UL << (0U))));
}
...
static __inline void LL_UCPD_RxFilterDisable(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->CFG2) |= ((0x1UL << (0U))));
}
# 539 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_ucpd.h"
static __inline void LL_UCPD_TypeCDetectionCC2Enable(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->CR) &= ~((0x1UL << (21U))));
}
...
static __inline void LL_UCPD_TypeCDetectionCC2Disable(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->CR) |= ((0x1UL << (21U))));
}
...
static __inline void LL_UCPD_TypeCDetectionCC1Enable(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->CR) &= ~((0x1UL << (20U))));
}
...
static __inline void LL_UCPD_TypeCDetectionCC1Disable(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->CR) |= ((0x1UL << (20U))));
}
...
static __inline void LL_UCPD_VconnDischargeEnable(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->CR) |= ((0x1UL << (18U))));
}
...
static __inline void LL_UCPD_VconnDischargeDisable(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->CR) &= ~((0x1UL << (18U))));
}
...
static __inline void LL_UCPD_SignalFRSTX(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->CR) |= ((0x1UL << (17U))));
}
...
static __inline void LL_UCPD_FRSDetectionEnable(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->CR) |= ((0x1UL << (16U))));
}
...
static __inline void LL_UCPD_FRSDetectionDisable(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->CR) &= ~((0x1UL << (16U))));
}
# 643 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_ucpd.h"
static __inline void LL_UCPD_SetccEnable(UCPD_TypeDef *UCPDx, uint32_t CCEnable)
{
  (((UCPDx->CR)) = ((((((UCPDx->CR))) & (~((0x3UL << (10U))))) | (CCEnable))));
}
...
static __inline void LL_UCPD_SetSNKRole(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->CR) |= ((0x1UL << (9U))));
}
...
static __inline void LL_UCPD_SetSRCRole(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->CR) &= ~((0x1UL << (9U))));
}
# 678 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_ucpd.h"
static __inline uint32_t LL_UCPD_GetRole(UCPD_TypeDef const *const UCPDx)
{
  return (uint32_t)(((UCPDx->CR) & ((0x1UL << (9U)))));
}
# 694 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_ucpd.h"
static __inline void LL_UCPD_SetRpResistor(UCPD_TypeDef *UCPDx, uint32_t Resistor)
{
  (((UCPDx->CR)) = ((((((UCPDx->CR))) & (~((0x3UL << (7U))))) | (Resistor))));
}
# 708 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_ucpd.h"
static __inline void LL_UCPD_SetCCPin(UCPD_TypeDef *UCPDx, uint32_t CCPin)
{
  (((UCPDx->CR)) = ((((((UCPDx->CR))) & (~((0x1UL << (6U))))) | (CCPin))));
}
...
static __inline void LL_UCPD_RxEnable(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->CR) |= ((0x1UL << (5U))));
}
...
static __inline void LL_UCPD_RxDisable(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->CR) &= ~((0x1UL << (5U))));
}
# 744 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_ucpd.h"
static __inline void LL_UCPD_SetRxMode(UCPD_TypeDef *UCPDx, uint32_t RxMode)
{
  (((UCPDx->CR)) = ((((((UCPDx->CR))) & (~((0x1UL << (4U))))) | (RxMode))));
}
...
static __inline void LL_UCPD_SendHardReset(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->CR) |= ((0x1UL << (3U))));
}
...
static __inline void LL_UCPD_SendMessage(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->CR) |= ((0x1UL << (2U))));
}
# 781 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_ucpd.h"
static __inline void LL_UCPD_SetTxMode(UCPD_TypeDef *UCPDx, uint32_t TxMode)
{
  (((UCPDx->CR)) = ((((((UCPDx->CR))) & (~((0x3UL << (0U))))) | (TxMode))));
}
# 800 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_ucpd.h"
static __inline void LL_UCPD_EnableIT_FRS(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->IMR) |= ((0x1UL << (20U))));
}
...
static __inline void LL_UCPD_EnableIT_TypeCEventCC2(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->IMR) |= ((0x1UL << (15U))));
}
...
static __inline void LL_UCPD_EnableIT_TypeCEventCC1(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->IMR) |= ((0x1UL << (14U))));
}
...
static __inline void LL_UCPD_EnableIT_RxMsgEnd(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->IMR) |= ((0x1UL << (12U))));
}
...
static __inline void LL_UCPD_EnableIT_RxOvr(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->IMR) |= ((0x1UL << (11U))));
}
...
static __inline void LL_UCPD_EnableIT_RxHRST(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->IMR) |= ((0x1UL << (10U))));
}
...
static __inline void LL_UCPD_EnableIT_RxOrderSet(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->IMR) |= ((0x1UL << (9U))));
}
...
static __inline void LL_UCPD_EnableIT_RxNE(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->IMR) |= ((0x1UL << (8U))));
}
...
static __inline void LL_UCPD_EnableIT_TxUND(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->IMR) |= ((0x1UL << (6U))));
}
...
static __inline void LL_UCPD_EnableIT_TxHRSTSENT(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->IMR) |= ((0x1UL << (5U))));
}
...
static __inline void LL_UCPD_EnableIT_TxHRSTDISC(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->IMR) |= ((0x1UL << (4U))));
}
...
static __inline void LL_UCPD_EnableIT_TxMSGABT(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->IMR) |= ((0x1UL << (3U))));
}
...
static __inline void LL_UCPD_EnableIT_TxMSGSENT(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->IMR) |= ((0x1UL << (2U))));
}
...
static __inline void LL_UCPD_EnableIT_TxMSGDISC(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->IMR) |= ((0x1UL << (1U))));
}
...
static __inline void LL_UCPD_EnableIT_TxIS(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->IMR) |= ((0x1UL << (0U))));
}
...
static __inline void LL_UCPD_DisableIT_FRS(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->IMR) &= ~((0x1UL << (20U))));
}
...
static __inline void LL_UCPD_DisableIT_TypeCEventCC2(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->IMR) &= ~((0x1UL << (15U))));
}
...
static __inline void LL_UCPD_DisableIT_TypeCEventCC1(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->IMR) &= ~((0x1UL << (14U))));
}
...
static __inline void LL_UCPD_DisableIT_RxMsgEnd(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->IMR) &= ~((0x1UL << (12U))));
}
...
static __inline void LL_UCPD_DisableIT_RxOvr(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->IMR) &= ~((0x1UL << (11U))));
}
...
static __inline void LL_UCPD_DisableIT_RxHRST(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->IMR) &= ~((0x1UL << (10U))));
}
...
static __inline void LL_UCPD_DisableIT_RxOrderSet(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->IMR) &= ~((0x1UL << (9U))));
}
...
static __inline void LL_UCPD_DisableIT_RxNE(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->IMR) &= ~((0x1UL << (8U))));
}
...
static __inline void LL_UCPD_DisableIT_TxUND(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->IMR) &= ~((0x1UL << (6U))));
}
...
static __inline void LL_UCPD_DisableIT_TxHRSTSENT(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->IMR) &= ~((0x1UL << (5U))));
}
...
static __inline void LL_UCPD_DisableIT_TxHRSTDISC(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->IMR) &= ~((0x1UL << (4U))));
}
...
static __inline void LL_UCPD_DisableIT_TxMSGABT(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->IMR) &= ~((0x1UL << (3U))));
}
...
static __inline void LL_UCPD_DisableIT_TxMSGSENT(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->IMR) &= ~((0x1UL << (2U))));
}
...
static __inline void LL_UCPD_DisableIT_TxMSGDISC(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->IMR) &= ~((0x1UL << (1U))));
}
...
static __inline void LL_UCPD_DisableIT_TxIS(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->IMR) &= ~((0x1UL << (0U))));
}
...
static __inline uint32_t LL_UCPD_IsEnableIT_FRS(UCPD_TypeDef const *const UCPDx)
{
  return ((((UCPDx->IMR) & ((0x1UL << (20U)))) == (0x1UL << (20U))) ? 1UL : 0UL);
}
...
static __inline uint32_t LL_UCPD_IsEnableIT_TypeCEventCC2(UCPD_TypeDef const *const UCPDx)
{
  return ((((UCPDx->IMR) & ((0x1UL << (15U)))) == (0x1UL << (15U))) ? 1UL : 0UL);
}
...
static __inline uint32_t LL_UCPD_IsEnableIT_TypeCEventCC1(UCPD_TypeDef const *const UCPDx)
{
  return ((((UCPDx->IMR) & ((0x1UL << (14U)))) == (0x1UL << (14U))) ? 1UL : 0UL);
}
...
static __inline uint32_t LL_UCPD_IsEnableIT_RxMsgEnd(UCPD_TypeDef const *const UCPDx)
{
  return ((((UCPDx->IMR) & ((0x1UL << (12U)))) == (0x1UL << (12U))) ? 1UL : 0UL);
}
...
static __inline uint32_t LL_UCPD_IsEnableIT_RxOvr(UCPD_TypeDef const *const UCPDx)
{
  return ((((UCPDx->IMR) & ((0x1UL << (11U)))) == (0x1UL << (11U))) ? 1UL : 0UL);
}
...
static __inline uint32_t LL_UCPD_IsEnableIT_RxHRST(UCPD_TypeDef const *const UCPDx)
{
  return ((((UCPDx->IMR) & ((0x1UL << (10U)))) == (0x1UL << (10U))) ? 1UL : 0UL);
}
...
static __inline uint32_t LL_UCPD_IsEnableIT_RxOrderSet(UCPD_TypeDef const *const UCPDx)
{
  return ((((UCPDx->IMR) & ((0x1UL << (9U)))) == (0x1UL << (9U))) ? 1UL : 0UL);
}
...
static __inline uint32_t LL_UCPD_IsEnableIT_RxNE(UCPD_TypeDef const *const UCPDx)
{
  return ((((UCPDx->IMR) & ((0x1UL << (8U)))) == (0x1UL << (8U))) ? 1UL : 0UL);
}
...
static __inline uint32_t LL_UCPD_IsEnableIT_TxUND(UCPD_TypeDef const *const UCPDx)
{
  return ((((UCPDx->IMR) & ((0x1UL << (6U)))) == (0x1UL << (6U))) ? 1UL : 0UL);
}
...
static __inline uint32_t LL_UCPD_IsEnableIT_TxHRSTSENT(UCPD_TypeDef const *const UCPDx)
{
  return ((((UCPDx->IMR) & ((0x1UL << (5U)))) == (0x1UL << (5U))) ? 1UL : 0UL);
}
...
static __inline uint32_t LL_UCPD_IsEnableIT_TxHRSTDISC(UCPD_TypeDef const *const UCPDx)
{
  return ((((UCPDx->IMR) & ((0x1UL << (4U)))) == (0x1UL << (4U))) ? 1UL : 0UL);
}
...
static __inline uint32_t LL_UCPD_IsEnableIT_TxMSGABT(UCPD_TypeDef const *const UCPDx)
{
  return ((((UCPDx->IMR) & ((0x1UL << (3U)))) == (0x1UL << (3U))) ? 1UL : 0UL);
}
...
static __inline uint32_t LL_UCPD_IsEnableIT_TxMSGSENT(UCPD_TypeDef const *const UCPDx)
{
  return ((((UCPDx->IMR) & ((0x1UL << (2U)))) == (0x1UL << (2U))) ? 1UL : 0UL);
}
...
static __inline uint32_t LL_UCPD_IsEnableIT_TxMSGDISC(UCPD_TypeDef const *const UCPDx)
{
  return ((((UCPDx->IMR) & ((0x1UL << (1U)))) == (0x1UL << (1U))) ? 1UL : 0UL);
}
...
static __inline uint32_t LL_UCPD_IsEnableIT_TxIS(UCPD_TypeDef const *const UCPDx)
{
  return ((((UCPDx->IMR) & ((0x1UL << (0U)))) == (0x1UL << (0U))) ? 1UL : 0UL);
}
# 1303 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_ucpd.h"
static __inline void LL_UCPD_ClearFlag_FRS(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->ICR) |= ((0x1UL << (20U))));
}
...
static __inline void LL_UCPD_ClearFlag_TypeCEventCC2(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->ICR) |= ((0x1UL << (15U))));
}
...
static __inline void LL_UCPD_ClearFlag_TypeCEventCC1(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->ICR) |= ((0x1UL << (14U))));
}
...
static __inline void LL_UCPD_ClearFlag_RxMsgEnd(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->ICR) |= ((0x1UL << (12U))));
}
...
static __inline void LL_UCPD_ClearFlag_RxOvr(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->ICR) |= ((0x1UL << (11U))));
}
...
static __inline void LL_UCPD_ClearFlag_RxHRST(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->ICR) |= ((0x1UL << (10U))));
}
...
static __inline void LL_UCPD_ClearFlag_RxOrderSet(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->ICR) |= ((0x1UL << (9U))));
}
...
static __inline void LL_UCPD_ClearFlag_TxUND(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->ICR) |= ((0x1UL << (6U))));
}
...
static __inline void LL_UCPD_ClearFlag_TxHRSTSENT(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->ICR) |= ((0x1UL << (5U))));
}
...
static __inline void LL_UCPD_ClearFlag_TxHRSTDISC(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->ICR) |= ((0x1UL << (4U))));
}
...
static __inline void LL_UCPD_ClearFlag_TxMSGABT(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->ICR) |= ((0x1UL << (3U))));
}
...
static __inline void LL_UCPD_ClearFlag_TxMSGSENT(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->ICR) |= ((0x1UL << (2U))));
}
...
static __inline void LL_UCPD_ClearFlag_TxMSGDISC(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->ICR) |= ((0x1UL << (1U))));
}
# 1454 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_ucpd.h"
static __inline uint32_t LL_UCPD_IsActiveFlag_FRS(UCPD_TypeDef const *const UCPDx)
{
  return ((((UCPDx->SR) & ((0x1UL << (20U)))) == (0x1UL << (20U))) ? 1UL : 0UL);
}
...
static __inline uint32_t LL_UCPD_IsActiveFlag_TypeCEventCC2(UCPD_TypeDef const *const UCPDx)
{
  return ((((UCPDx->SR) & ((0x1UL << (15U)))) == (0x1UL << (15U))) ? 1UL : 0UL);
}
...
static __inline uint32_t LL_UCPD_IsActiveFlag_TypeCEventCC1(UCPD_TypeDef const *const UCPDx)
{
  return ((((UCPDx->SR) & ((0x1UL << (14U)))) == (0x1UL << (14U))) ? 1UL : 0UL);
}
...
static __inline uint32_t LL_UCPD_IsActiveFlag_RxMsgEnd(UCPD_TypeDef const *const UCPDx)
{
  return ((((UCPDx->SR) & ((0x1UL << (12U)))) == (0x1UL << (12U))) ? 1UL : 0UL);
}
...
static __inline uint32_t LL_UCPD_IsActiveFlag_RxOvr(UCPD_TypeDef const *const UCPDx)
{
  return ((((UCPDx->SR) & ((0x1UL << (11U)))) == (0x1UL << (11U))) ? 1UL : 0UL);
}
...
static __inline uint32_t LL_UCPD_IsActiveFlag_RxHRST(UCPD_TypeDef const *const UCPDx)
{
  return ((((UCPDx->SR) & ((0x1UL << (10U)))) == (0x1UL << (10U))) ? 1UL : 0UL);
}
...
static __inline uint32_t LL_UCPD_IsActiveFlag_RxOrderSet(UCPD_TypeDef const *const UCPDx)
{
  return ((((UCPDx->SR) & ((0x1UL << (9U)))) == (0x1UL << (9U))) ? 1UL : 0UL);
}
...
static __inline uint32_t LL_UCPD_IsActiveFlag_RxNE(UCPD_TypeDef const *const UCPDx)
{
  return ((((UCPDx->SR) & ((0x1UL << (8U)))) == (0x1UL << (8U))) ? 1UL : 0UL);
}
...
static __inline uint32_t LL_UCPD_IsActiveFlag_TxUND(UCPD_TypeDef const *const UCPDx)
{
  return ((((UCPDx->SR) & ((0x1UL << (6U)))) == (0x1UL << (6U))) ? 1UL : 0UL);
}
...
static __inline uint32_t LL_UCPD_IsActiveFlag_TxHRSTSENT(UCPD_TypeDef const *const UCPDx)
{
  return ((((UCPDx->SR) & ((0x1UL << (5U)))) == (0x1UL << (5U))) ? 1UL : 0UL);
}
...
static __inline uint32_t LL_UCPD_IsActiveFlag_TxHRSTDISC(UCPD_TypeDef const *const UCPDx)
{
  return ((((UCPDx->SR) & ((0x1UL << (4U)))) == (0x1UL << (4U))) ? 1UL : 0UL);
}
...
static __inline uint32_t LL_UCPD_IsActiveFlag_TxMSGABT(UCPD_TypeDef const *const UCPDx)
{
  return ((((UCPDx->SR) & ((0x1UL << (3U)))) == (0x1UL << (3U))) ? 1UL : 0UL);
}
...
static __inline uint32_t LL_UCPD_IsActiveFlag_TxMSGSENT(UCPD_TypeDef const *const UCPDx)
{
  return ((((UCPDx->SR) & ((0x1UL << (2U)))) == (0x1UL << (2U))) ? 1UL : 0UL);
}
...
static __inline uint32_t LL_UCPD_IsActiveFlag_TxMSGDISC(UCPD_TypeDef const *const UCPDx)
{
  return ((((UCPDx->SR) & ((0x1UL << (1U)))) == (0x1UL << (1U))) ? 1UL : 0UL);
}
...
static __inline uint32_t LL_UCPD_IsActiveFlag_TxIS(UCPD_TypeDef const *const UCPDx)
{
  return ((((UCPDx->SR) & ((0x1UL << (0U)))) == (0x1UL << (0U))) ? 1UL : 0UL);
}
...
static __inline uint32_t LL_UCPD_GetTypeCVstateCC2(UCPD_TypeDef const *const UCPDx)
{
  return UCPDx->SR & (0x3UL << (18U));
}
...
static __inline uint32_t LL_UCPD_GetTypeCVstateCC1(UCPD_TypeDef const *const UCPDx)
{
  return UCPDx->SR & (0x3UL << (16U));
}
# 1650 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_ucpd.h"
static __inline void LL_UCPD_RxDMAEnable(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->CFG1) |= ((0x1UL << (30U))));
}
...
static __inline void LL_UCPD_RxDMADisable(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->CFG1) &= ~((0x1UL << (30U))));
}
...
static __inline void LL_UCPD_TxDMAEnable(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->CFG1) |= ((0x1UL << (29U))));
}
...
static __inline void LL_UCPD_TxDMADisable(UCPD_TypeDef *UCPDx)
{
  ((UCPDx->CFG1) &= ~((0x1UL << (29U))));
}
...
static __inline uint32_t LL_UCPD_IsEnabledTxDMA(UCPD_TypeDef const *const UCPDx)
{
  return ((((UCPDx->CFG1) & ((0x1UL << (29U)))) == ((0x1UL << (29U)))) ? 1UL : 0UL);
}
...
static __inline uint32_t LL_UCPD_IsEnabledRxDMA(UCPD_TypeDef const *const UCPDx)
{
  return ((((UCPDx->CFG1) & ((0x1UL << (30U)))) == ((0x1UL << (30U)))) ? 1UL : 0UL);
}
# 1732 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_ucpd.h"
static __inline void LL_UCPD_WriteTxOrderSet(UCPD_TypeDef *UCPDx, uint32_t TxOrderSet)
{
  ((UCPDx->TX_ORDSET) = (TxOrderSet));
}
# 1744 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_ucpd.h"
static __inline void LL_UCPD_WriteTxPaySize(UCPD_TypeDef *UCPDx, uint32_t TxPaySize)
{
  ((UCPDx->TX_PAYSZ) = (TxPaySize));
}
# 1756 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_ucpd.h"
static __inline void LL_UCPD_WriteData(UCPD_TypeDef *UCPDx, uint8_t Data)
{
  ((UCPDx->TXDR) = (Data));
}
# 1775 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_ucpd.h"
static __inline uint32_t LL_UCPD_ReadRxOrderSet(UCPD_TypeDef const *const UCPDx)
{
  return ((UCPDx->RX_ORDSET) & ((0x7UL << (0U))));
}
...
static __inline uint32_t LL_UCPD_ReadRxPaySize(UCPD_TypeDef const *const UCPDx)
{
  return ((UCPDx->TX_PAYSZ) & ((0x3FFUL << (0U))));
}
...
static __inline uint32_t LL_UCPD_ReadData(UCPD_TypeDef const *const UCPDx)
{
  return ((UCPDx->RXDR));
}
# 1809 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_ucpd.h"
static __inline void LL_UCPD_SetRxOrdExt1(UCPD_TypeDef *UCPDx, uint32_t SOPExt)
{
  ((UCPDx->RX_ORDEXT1) = (SOPExt));
}
# 1821 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_ucpd.h"
static __inline void LL_UCPD_SetRxOrdExt2(UCPD_TypeDef *UCPDx, uint32_t SOPExt)
{
  ((UCPDx->RX_ORDEXT2) = (SOPExt));
}
# 1835 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_ucpd.h"
...
# 22 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_ucpd.c" 2
...
# 23 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_ucpd.c" 2
...
# 24 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_ucpd.c" 2
# 79 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_ucpd.c"
ErrorStatus LL_UCPD_DeInit(UCPD_TypeDef *UCPDx)
{
  ...
  if (((UCPD_TypeDef *) ((0x40000000UL) + 0xA000UL)) == UCPDx)
  {

    LL_APB1_GRP2_ForceReset((0x1UL << (8U)));


    LL_APB1_GRP2_ReleaseReset((0x1UL << (8U)));


    LL_APB1_GRP2_DisableClock((0x1UL << (8U)));
...
# 115 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_ucpd.c"
ErrorStatus LL_UCPD_Init(UCPD_TypeDef *UCPDx, LL_UCPD_InitTypeDef *UCPD_InitStruct)
{
  ...
  if (((UCPD_TypeDef *) ((0x40000000UL) + 0xA000UL)) == UCPDx)
  {
    LL_APB1_GRP2_EnableClock((0x1UL << (8U)));
  }
  ...
  (((UCPDx->CFG1)) = ((((((UCPDx->CFG1))) & (~((0x7UL << (17U)) | (0x1FUL << (11U)) | (0x1FUL << (6U)) | (0x3FUL << (0U))))) | (UCPD_InitStruct->psc_ucpdclk | (UCPD_InitStruct->transwin << (11U)) | (UCPD_InitStruct->IfrGap << (6U)) | UCPD_InitStruct->HbitClockDiv))));
...
void LL_UCPD_StructInit(LL_UCPD_InitTypeDef *UCPD_InitStruct)
{
  ...
  UCPD_InitStruct->psc_ucpdclk = (0x1UL << (17U));
  UCPD_InitStruct->transwin = 0x7;
  UCPD_InitStruct->IfrGap = 0x10;
  UCPD_InitStruct->HbitClockDiv = 0x0D;
}
