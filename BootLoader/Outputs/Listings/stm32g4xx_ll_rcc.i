# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_rcc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_rcc.c" 2
# 20 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_rcc.c"
# 1 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h" 1
# 27 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h"
...
# 28 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_rcc.h" 2
...
# 21 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_rcc.c" 2
# 97 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_rcc.c"
...
# 133 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_rcc.c"
ErrorStatus LL_RCC_DeInit(void)
{
  uint32_t vl_mask;
  ...
  while(LL_RCC_GetSysClkSource() != (0x00000004U)) {};
  ...
  ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->PLLCFGR) = (16U << (8U)));


  ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->CIER) = (0x00000000U));


  vl_mask = (0x1UL << (0U)) | (0x1UL << (1U)) | (0x1UL << (3U)) | (0x1UL << (4U)) | (0x1UL << (5U)) | (0x1UL << (10U)) | (0x1UL << (8U)) | (0x1UL << (9U));


  ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->CICR) = (vl_mask));
...
# 208 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_rcc.c"
void LL_RCC_GetSystemClocksFreq(LL_RCC_ClocksTypeDef *RCC_Clocks)
{
...
# 233 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_rcc.c"
uint32_t LL_RCC_GetUSARTClockFreq(uint32_t USARTxSource)
{
  ...
  if (USARTxSource == (0x3UL << (0U)))
  {

    switch (LL_RCC_GetUSARTClockSource(USARTxSource))
    {
      case (((0x3UL << (0U)) << 16U) | (0x1UL << (0U))):
        usart_frequency = RCC_GetSystemClockFreq();
        break;

      case (((0x3UL << (0U)) << 16U) | (0x2UL << (0U))):
        if (LL_RCC_HSI_IsReady() != 0U)
        {
          usart_frequency = (16000000UL);
        }
        break;

      case (((0x3UL << (0U)) << 16U) | (0x3UL << (0U))):
        if (LL_RCC_LSE_IsReady() != 0U)
        {
          usart_frequency = (32768UL);
        }
        break;
  ...
  else if (USARTxSource == (0x3UL << (2U)))
  {

    switch (LL_RCC_GetUSARTClockSource(USARTxSource))
    {
      case (((0x3UL << (2U)) << 16U) | (0x1UL << (2U))):
        usart_frequency = RCC_GetSystemClockFreq();
        break;

      case (((0x3UL << (2U)) << 16U) | (0x2UL << (2U))):
        if (LL_RCC_HSI_IsReady() != 0U)
        {
          usart_frequency = (16000000UL);
        }
  ...
  {
    if (USARTxSource == (0x3UL << (4U)))
    {

      switch (LL_RCC_GetUSARTClockSource(USARTxSource))
      {
        case (((0x3UL << (4U)) << 16U) | (0x1UL << (4U))):
          usart_frequency = RCC_GetSystemClockFreq();
          break;

        case (((0x3UL << (4U)) << 16U) | (0x2UL << (4U))):
          if (LL_RCC_HSI_IsReady() != 0U)
          {
            usart_frequency = (16000000UL);
          }
...
# 344 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_rcc.c"
uint32_t LL_RCC_GetUARTClockFreq(uint32_t UARTxSource)
{
  uint32_t uart_frequency = 0x00000000U;


  ((void)0U);

  if (UARTxSource == (0x3UL << (6U)))
  {

    switch (LL_RCC_GetUARTClockSource(UARTxSource))
    {
      case (((0x3UL << (6U)) << 16U) | (0x1UL << (6U))):
        uart_frequency = RCC_GetSystemClockFreq();
        break;

      case (((0x3UL << (6U)) << 16U) | (0x2UL << (6U))):
        if (LL_RCC_HSI_IsReady() != 0U)
        {
          uart_frequency = (16000000UL);
        }
        break;

      case (((0x3UL << (6U)) << 16U) | (0x3UL << (6U))):
        if (LL_RCC_LSE_IsReady() != 0U)
        {
          uart_frequency = (32768UL);
        }
        break;
...
# 413 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_rcc.c"
  return uart_frequency;
}
# 429 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_rcc.c"
uint32_t LL_RCC_GetI2CClockFreq(uint32_t I2CxSource)
{
  ...
  if (I2CxSource == ((0U << 24U) | ((12U) << 16U) | ((0x3UL << (12U)) >> (12U))))
  {

    switch (LL_RCC_GetI2CClockSource(I2CxSource))
    {
      case ((0U << 24U) | ((12U) << 16U) | ((0x1UL << (12U)) >> (12U))):
        i2c_frequency = RCC_GetSystemClockFreq();
        break;

      case ((0U << 24U) | ((12U) << 16U) | ((0x2UL << (12U)) >> (12U))):
        if (LL_RCC_HSI_IsReady() != 0U)
        {
          i2c_frequency = (16000000UL);
        }
        break;
  ...
  else if (I2CxSource == ((0U << 24U) | ((14U) << 16U) | ((0x3UL << (14U)) >> (14U))))
  {

    switch (LL_RCC_GetI2CClockSource(I2CxSource))
    {
      case ((0U << 24U) | ((14U) << 16U) | ((0x1UL << (14U)) >> (14U))):
        i2c_frequency = RCC_GetSystemClockFreq();
        break;

      case ((0U << 24U) | ((14U) << 16U) | ((0x2UL << (14U)) >> (14U))):
        if (LL_RCC_HSI_IsReady() != 0U)
        {
          i2c_frequency = (16000000UL);
        }
  ...
  {
    if (I2CxSource == ((0U << 24U) | ((16U) << 16U) | ((0x3UL << (16U)) >> (16U))))
    {

      switch (LL_RCC_GetI2CClockSource(I2CxSource))
      {
        case ((0U << 24U) | ((16U) << 16U) | ((0x1UL << (16U)) >> (16U))):
          i2c_frequency = RCC_GetSystemClockFreq();
          break;

        case ((0U << 24U) | ((16U) << 16U) | ((0x2UL << (16U)) >> (16U))):
          if (LL_RCC_HSI_IsReady() != 0U)
          {
            i2c_frequency = (16000000UL);
          }
...
# 531 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_rcc.c"
  }

  return i2c_frequency;
}
# 544 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_rcc.c"
uint32_t LL_RCC_GetLPUARTClockFreq(uint32_t LPUARTxSource)
{
  uint32_t lpuart_frequency = 0x00000000U;
...
# 588 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_rcc.c"
uint32_t LL_RCC_GetLPTIMClockFreq(uint32_t LPTIMxSource)
{
  uint32_t lptim_frequency = 0x00000000U;


  ((void)0U);

  if (LPTIMxSource == (0x3UL << (18U)))
  {
...
# 639 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_rcc.c"
uint32_t LL_RCC_GetSAIClockFreq(uint32_t SAIxSource)
{
  uint32_t sai_frequency = 0x00000000U;


  ((void)0U);

  if (SAIxSource == (0x3UL << (20U)))
  {
    ...
    switch (LL_RCC_GetSAIClockSource(SAIxSource))
    {
      ...
      case (0x2UL << (20U)):
        sai_frequency = (12288000UL);
        break;

      case ((0x1UL << (20U)) | (0x2UL << (20U))):
      default:
        if (LL_RCC_HSI_IsReady() != 0U)
        {
          sai_frequency = (16000000UL);
        }
        break;
...
# 690 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_rcc.c"
uint32_t LL_RCC_GetI2SClockFreq(uint32_t I2SxSource)
{
  uint32_t i2s_frequency = 0x00000000U;


  ((void)0U);

  if (I2SxSource == (0x3UL << (22U)))
  {
    ...
    switch (LL_RCC_GetI2SClockSource(I2SxSource))
    {
      ...
      case (0x2UL << (22U)):
        i2s_frequency = (12288000UL);
        break;

      case ((0x1UL << (22U)) | (0x2UL << (22U))):
      default:
        if (LL_RCC_HSI_IsReady() != 0U)
        {
          i2s_frequency = (16000000UL);
        }
      break;
      }
  }
...
# 742 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_rcc.c"
uint32_t LL_RCC_GetFDCANClockFreq(uint32_t FDCANxSource)
{
  uint32_t fdcan_frequency = 0x00000000U;
  ...
  switch (LL_RCC_GetFDCANClockSource(FDCANxSource))
  {
    ...
    default:
      fdcan_frequency = 0xFFFFFFFFU;
      break;
  }
  return fdcan_frequency;
}
# 789 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_rcc.c"
uint32_t LL_RCC_GetRNGClockFreq(uint32_t RNGxSource)
{
  uint32_t rng_frequency = 0x00000000U;
  ...
  switch (LL_RCC_GetRNGClockSource(RNGxSource))
  {
    ...
    case 0x00000000U:
      ...
      {
        rng_frequency = (48000000UL);
      }
      break;

    default:
      rng_frequency = 0xFFFFFFFFU;
      break;
...
# 833 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_rcc.c"
uint32_t LL_RCC_GetUSBClockFreq(uint32_t USBxSource)
{
  uint32_t usb_frequency = 0x00000000U;
  ...
  switch (LL_RCC_GetUSBClockSource(USBxSource))
  {
    ...
    case 0x00000000U:
      if (LL_RCC_HSI48_IsReady() != 0U)
      {
        usb_frequency = (48000000UL);
      }
      break;

    default:
      usb_frequency = 0xFFFFFFFFU;
      break;
  }

  return usb_frequency;
}
# 879 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_rcc.c"
uint32_t LL_RCC_GetADCClockFreq(uint32_t ADCxSource)
{
  uint32_t adc_frequency = 0x00000000U;


  ((void)0U);

  if (ADCxSource == ((0U << 24U) | ((28U) << 16U) | ((0x3UL << (28U)) >> (28U))))
  {

    switch (LL_RCC_GetADCClockSource(ADCxSource))
    {
      case ((0U << 24U) | ((28U) << 16U) | ((0x1UL << (28U)) >> (28U))):
        if (LL_RCC_PLL_IsReady() != 0U)
        {
      ...
      case ((0U << 24U) | ((28U) << 16U) | ((0x2UL << (28U)) >> (28U))):
        adc_frequency = RCC_GetSystemClockFreq();
        break;

      case ((0U << 24U) | ((28U) << 16U)):
      default:
        adc_frequency = 0xFFFFFFFFU;
        break;
    }
  }
# 939 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_rcc.c"
  return adc_frequency;
}
# 1006 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_rcc.c"
static uint32_t RCC_GetSystemClockFreq(void)
{
  uint32_t frequency;
...
static uint32_t RCC_GetHCLKClockFreq(uint32_t SYSCLK_Frequency)
{
  ...
  return ((SYSCLK_Frequency) >> (AHBPrescTable[((LL_RCC_GetAHBPrescaler()) & (0xFUL << (4U))) >> (4U)] & 0x1FU));
}
...
static uint32_t RCC_GetPCLK1ClockFreq(uint32_t HCLK_Frequency)
{
  ...
  return ((HCLK_Frequency) >> (APBPrescTable[(LL_RCC_GetAPB1Prescaler()) >> (8U)] & 0x1FU));
}
...
static uint32_t RCC_GetPCLK2ClockFreq(uint32_t HCLK_Frequency)
{
  ...
  return ((HCLK_Frequency) >> (APBPrescTable[(LL_RCC_GetAPB2Prescaler()) >> (11U)] & 0x1FU));
}
...
static uint32_t RCC_PLL_GetFreqDomain_SYS(void)
{
  ...
  return ((pllinputfreq) * (LL_RCC_PLL_GetN()) / ((((LL_RCC_PLL_GetDivider())>> (4U)) + 1U)) / ((((LL_RCC_PLL_GetR()) >> (25U)) + 1U) * 2U));
...
static uint32_t RCC_PLL_GetFreqDomain_ADC(void)
{
  ...
  return ((pllinputfreq) * (LL_RCC_PLL_GetN()) / ((((LL_RCC_PLL_GetDivider())>> (4U)) + 1U)) / ((LL_RCC_PLL_GetP()) >> (27U)));
...
static uint32_t RCC_PLL_GetFreqDomain_48M(void)
{
  ...
  return ((pllinputfreq) * (LL_RCC_PLL_GetN()) / ((((LL_RCC_PLL_GetDivider())>> (4U)) + 1U)) / ((((LL_RCC_PLL_GetQ()) >> (21U)) + 1U) << 1U));
