# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal.c" 2
# 35 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal.c"
...
# 36 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal.c" 2
# 85 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal.c"
volatile uint32_t uwTick;
uint32_t uwTickPrio = (1UL << 4U);
uint32_t uwTickFreq = 1U;
# 148 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal.c"
HAL_StatusTypeDef HAL_Init(void)
{
  HAL_StatusTypeDef status = HAL_OK;
# 169 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal.c"
  HAL_NVIC_SetPriorityGrouping(0x00000003U);


  if (HAL_InitTick((15UL)) != HAL_OK)
  {
    status = HAL_ERROR;
  }
  else
...
HAL_StatusTypeDef HAL_DeInit(void)
{
  ...
  ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB1RSTR1) = (0xFFFFFFFFU));
  ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB1RSTR1) = (0x00000000U));

  ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB2RSTR) = (0xFFFFFFFFU));
  ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB2RSTR) = (0x00000000U));

  ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB1RSTR) = (0xFFFFFFFFU));
  ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB1RSTR) = (0x00000000U));

  ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB2RSTR) = (0xFFFFFFFFU));
  ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB2RSTR) = (0x00000000U));

  ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB3RSTR) = (0xFFFFFFFFU));
  ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB3RSTR) = (0x00000000U));
...
# 255 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal.c"
...
# 322 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal.c"
...
# 399 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal.c"
...
# 425 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal.c"
__attribute__((weak)) void HAL_SuspendTick(void)
{

  ((((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL) &= ~((1UL << 1U)));
}
# 441 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal.c"
...
uint32_t HAL_GetHalVersion(void)
{
  return (((0x01U) << 24U) |((0x02U) << 16U) |((0x02U) << 8U ) |((0x00U)));
}
...
uint32_t HAL_GetREVID(void)
{
  return ((((DBGMCU_TypeDef *) (0xE0042000UL))->IDCODE & (0xFFFFUL << (16U))) >> 16U);
}
...
uint32_t HAL_GetDEVID(void)
{
  return (((DBGMCU_TypeDef *) (0xE0042000UL))->IDCODE & (0xFFFUL << (0U)));
}
# 498 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal.c"
void HAL_DBGMCU_EnableDBGSleepMode(void)
{
...
# 576 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal.c"
void HAL_SYSCFG_CCMSRAMErase(void)
{
...
# 595 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal.c"
void HAL_SYSCFG_EnableMemorySwappingBank(void)
{
  ((((SYSCFG_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0000UL))->MEMRMP) |= ((0x1UL << (8U))));
}
# 610 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal.c"
void HAL_SYSCFG_DisableMemorySwappingBank(void)
{
  ((((SYSCFG_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0000UL))->MEMRMP) &= ~((0x1UL << (8U))));
}
# 628 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal.c"
void HAL_SYSCFG_VREFBUF_VoltageScalingConfig(uint32_t VoltageScaling)
{

  ((void)0U);

  (((((VREFBUF_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0030UL))->CSR)) = ((((((((VREFBUF_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0030UL))->CSR))) & (~((0x3UL << (4U))))) | (VoltageScaling))));
}
# 644 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal.c"
void HAL_SYSCFG_VREFBUF_HighImpedanceConfig(uint32_t Mode)
{

  ((void)0U);

  (((((VREFBUF_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0030UL))->CSR)) = ((((((((VREFBUF_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0030UL))->CSR))) & (~((0x1UL << (1U))))) | (Mode))));
}
...
void HAL_SYSCFG_VREFBUF_TrimmingConfig(uint32_t TrimmingValue)
{
  ...
  (((((VREFBUF_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0030UL))->CCR)) = ((((((((VREFBUF_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0030UL))->CCR))) & (~((0x3FUL << (0U))))) | (TrimmingValue))));
}
...
HAL_StatusTypeDef HAL_SYSCFG_EnableVREFBUF(void)
{
  ...
  while (((((VREFBUF_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0030UL))->CSR) & ((0x1UL << (3U)))) == 0x00U)
  {
...
void HAL_SYSCFG_CCMSRAM_WriteProtectionEnable(uint32_t Page)
{
  ...
  ((((SYSCFG_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0000UL))->SWPR) |= ((uint32_t)(Page)));
}
