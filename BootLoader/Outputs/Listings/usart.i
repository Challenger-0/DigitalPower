# 1 "CubeMX/Core/Src/usart.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "CubeMX/Core/Src/usart.c" 2
# 21 "CubeMX/Core/Src/usart.c"
# 1 "./CubeMX/Core/Inc\\usart.h" 1
# 29 "./CubeMX/Core/Inc\\usart.h"
...
void MX_USART1_UART_Init(void)
{
# 42 "CubeMX/Core/Src/usart.c"
  huart1.Instance = ((USART_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x3800UL));
  huart1.Init.BaudRate = 115200;
  huart1.Init.WordLength = 0x00000000U;
  huart1.Init.StopBits = 0x00000000U;
  huart1.Init.Parity = 0x00000000U;
  huart1.Init.Mode = ((0x1UL << (3U)) |(0x1UL << (2U)));
  huart1.Init.HwFlowCtl = 0x00000000U;
  huart1.Init.OverSampling = 0x00000000U;
  huart1.Init.OneBitSampling = 0x00000000U;
  huart1.Init.ClockPrescaler = 0x00000000U;
  huart1.AdvancedInit.AdvFeatureInit = 0x00000000U;
  if (HAL_UART_Init(&huart1) != HAL_OK)
  {
    Error_Handler();
  }
  if (HAL_UARTEx_SetTxFifoThreshold(&huart1, 0x00000000U) != HAL_OK)
  {
    Error_Handler();
  }
  if (HAL_UARTEx_SetRxFifoThreshold(&huart1, 0x00000000U) != HAL_OK)
  {
    Error_Handler();
  }
...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  if(uartHandle->Instance==((USART_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x3800UL)))
  {
    ...
    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB2ENR) |= ((0x1UL << (14U)))); tmpreg = ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB2ENR) & ((0x1UL << (14U)))); (void)tmpreg; } while(0);
    ...
    hdma_usart1_tx.Instance = ((DMA_Channel_TypeDef *) ((((0x40000000UL) + 0x00020000UL)) + 0x006CUL));
    hdma_usart1_tx.Init.Request = 25U;
    hdma_usart1_tx.Init.Direction = (0x1UL << (4U));
    hdma_usart1_tx.Init.PeriphInc = 0x00000000U;
    hdma_usart1_tx.Init.MemInc = (0x1UL << (7U));
    hdma_usart1_tx.Init.PeriphDataAlignment = 0x00000000U;
    hdma_usart1_tx.Init.MemDataAlignment = 0x00000000U;
    hdma_usart1_tx.Init.Mode = 0x00000000U;
    hdma_usart1_tx.Init.Priority = 0x00000000U;
    if (HAL_DMA_Init(&hdma_usart1_tx) != HAL_OK)
    {
      Error_Handler();
    }

    do{ (uartHandle)->hdmatx = &(hdma_usart1_tx); (hdma_usart1_tx).Parent = (uartHandle); } while(0);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  if(uartHandle->Instance==((USART_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x3800UL)))
  {
    ...
    ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB2ENR) &= ~((0x1UL << (14U))));





    HAL_GPIO_DeInit(((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0000UL)), ((uint16_t)0x0200)|((uint16_t)0x0400));
