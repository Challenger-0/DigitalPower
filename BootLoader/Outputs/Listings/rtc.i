# 1 "CubeMX/Core/Src/rtc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "CubeMX/Core/Src/rtc.c" 2
# 21 "CubeMX/Core/Src/rtc.c"
# 1 "./CubeMX/Core/Inc\\rtc.h" 1
# 29 "./CubeMX/Core/Inc\\rtc.h"
...
void MX_RTC_Init(void)
{
# 43 "CubeMX/Core/Src/rtc.c"
  hrtc.Instance = ((RTC_TypeDef *) ((0x40000000UL) + 0x2800UL));
  hrtc.Init.HourFormat = 0x00000000U;
  hrtc.Init.AsynchPrediv = 127;
  hrtc.Init.SynchPrediv = 255;
  hrtc.Init.OutPut = 0x00000000U;
  hrtc.Init.OutPutRemap = 0x00000000U;
  hrtc.Init.OutPutPolarity = 0x00000000U;
  hrtc.Init.OutPutType = (0x1UL << (30U));
  hrtc.Init.OutPutPullUp = 0x00000000U;
...
void HAL_RTC_MspInit(RTC_HandleTypeDef* rtcHandle)
{
  ...
  if(rtcHandle->Instance==((RTC_TypeDef *) ((0x40000000UL) + 0x2800UL)))
  {
    ...
    PeriphClkInit.PeriphClockSelection = 0x00080000U;
    PeriphClkInit.RTCClockSelection = (0x2UL << (8U));
...
void HAL_RTC_MspDeInit(RTC_HandleTypeDef* rtcHandle)
{
  ...
  if(rtcHandle->Instance==((RTC_TypeDef *) ((0x40000000UL) + 0x2800UL)))
  {
    ...
    ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->BDCR) &= ~((0x1UL << (15U))));
    ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB1ENR1) &= ~((0x1UL << (10U))));;
