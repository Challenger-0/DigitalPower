# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_fmac.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_fmac.c" 2
# 21 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_fmac.c"
# 1 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_fmac.h" 1
# 28 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_fmac.h"
...
# 29 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_fmac.h" 2
# 166 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_fmac.h"
static __inline void LL_FMAC_SetX1FullWatermark(FMAC_TypeDef *FMACx, uint32_t Watermark)
{
  (((FMACx->X1BUFCFG)) = ((((((FMACx->X1BUFCFG))) & (~((0x3UL << (24U))))) | (Watermark))));
}
# 181 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_fmac.h"
static __inline uint32_t LL_FMAC_GetX1FullWatermark(FMAC_TypeDef *FMACx)
{
  return (uint32_t)(((FMACx->X1BUFCFG) & ((0x3UL << (24U)))));
}
# 194 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_fmac.h"
static __inline void LL_FMAC_SetX1BufferSize(FMAC_TypeDef *FMACx, uint8_t BufferSize)
{
  (((FMACx->X1BUFCFG)) = ((((((FMACx->X1BUFCFG))) & (~((0xFFUL << (8U))))) | (((uint32_t)BufferSize) << (8U)))));
}
# 206 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_fmac.h"
static __inline uint8_t LL_FMAC_GetX1BufferSize(FMAC_TypeDef *FMACx)
{
  return (uint8_t)(((FMACx->X1BUFCFG) & ((0xFFUL << (8U)))) >> (8U));
}
# 219 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_fmac.h"
static __inline void LL_FMAC_SetX1Base(FMAC_TypeDef *FMACx, uint8_t Base)
{
  (((FMACx->X1BUFCFG)) = ((((((FMACx->X1BUFCFG))) & (~((0xFFUL << (0U))))) | (((uint32_t)Base) << (0U)))));
}
# 231 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_fmac.h"
static __inline uint8_t LL_FMAC_GetX1Base(FMAC_TypeDef *FMACx)
{
  return (uint8_t)(((FMACx->X1BUFCFG) & ((0xFFUL << (0U)))) >> (0U));
}
# 244 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_fmac.h"
static __inline void LL_FMAC_SetX2BufferSize(FMAC_TypeDef *FMACx, uint8_t BufferSize)
{
  (((FMACx->X2BUFCFG)) = ((((((FMACx->X2BUFCFG))) & (~((0xFFUL << (8U))))) | (((uint32_t)BufferSize) << (8U)))));
}
# 256 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_fmac.h"
static __inline uint8_t LL_FMAC_GetX2BufferSize(FMAC_TypeDef *FMACx)
{
  return (uint8_t)(((FMACx->X2BUFCFG) & ((0xFFUL << (8U)))) >> (8U));
}
# 269 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_fmac.h"
static __inline void LL_FMAC_SetX2Base(FMAC_TypeDef *FMACx, uint8_t Base)
{
  (((FMACx->X2BUFCFG)) = ((((((FMACx->X2BUFCFG))) & (~((0xFFUL << (0U))))) | (((uint32_t)Base) << (0U)))));
}
# 281 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_fmac.h"
static __inline uint8_t LL_FMAC_GetX2Base(FMAC_TypeDef *FMACx)
{
  return (uint8_t)(((FMACx->X2BUFCFG) & ((0xFFUL << (0U)))) >> (0U));
}
# 297 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_fmac.h"
static __inline void LL_FMAC_SetYEmptyWatermark(FMAC_TypeDef *FMACx, uint32_t Watermark)
{
  (((FMACx->YBUFCFG)) = ((((((FMACx->YBUFCFG))) & (~((0x3UL << (24U))))) | (Watermark))));
}
# 312 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_fmac.h"
static __inline uint32_t LL_FMAC_GetYEmptyWatermark(FMAC_TypeDef *FMACx)
{
  return (uint32_t)(((FMACx->YBUFCFG) & ((0x3UL << (24U)))));
}
# 325 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_fmac.h"
static __inline void LL_FMAC_SetYBufferSize(FMAC_TypeDef *FMACx, uint8_t BufferSize)
{
  (((FMACx->YBUFCFG)) = ((((((FMACx->YBUFCFG))) & (~((0xFFUL << (8U))))) | (((uint32_t)BufferSize) << (8U)))));
}
# 337 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_fmac.h"
static __inline uint8_t LL_FMAC_GetYBufferSize(FMAC_TypeDef *FMACx)
{
  return (uint8_t)(((FMACx->YBUFCFG) & ((0xFFUL << (8U)))) >> (8U));
}
# 350 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_fmac.h"
static __inline void LL_FMAC_SetYBase(FMAC_TypeDef *FMACx, uint8_t Base)
{
  (((FMACx->YBUFCFG)) = ((((((FMACx->YBUFCFG))) & (~((0xFFUL << (0U))))) | (((uint32_t)Base) << (0U)))));
}
# 362 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_fmac.h"
static __inline uint8_t LL_FMAC_GetYBase(FMAC_TypeDef *FMACx)
{
  return (uint8_t)(((FMACx->YBUFCFG) & ((0xFFUL << (0U)))) >> (0U));
}
...
static __inline void LL_FMAC_EnableStart(FMAC_TypeDef *FMACx)
{
  ((FMACx->PARAM) |= ((0x1UL << (31U))));
}
...
static __inline void LL_FMAC_DisableStart(FMAC_TypeDef *FMACx)
{
  ((FMACx->PARAM) &= ~((0x1UL << (31U))));
}
...
static __inline uint32_t LL_FMAC_IsEnabledStart(FMAC_TypeDef *FMACx)
{
  return ((((FMACx->PARAM) & ((0x1UL << (31U)))) == ((0x1UL << (31U)))) ? 1UL : 0UL);
}
# 412 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_fmac.h"
static __inline void LL_FMAC_SetFunction(FMAC_TypeDef *FMACx, uint32_t Function)
{
  (((FMACx->PARAM)) = ((((((FMACx->PARAM))) & (~((0x7FUL << (24U))))) | (Function))));
}
# 428 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_fmac.h"
static __inline uint32_t LL_FMAC_GetFunction(FMAC_TypeDef *FMACx)
{
  return (uint32_t)(((FMACx->PARAM) & ((0x7FUL << (24U)))));
}
# 441 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_fmac.h"
static __inline void LL_FMAC_SetParamR(FMAC_TypeDef *FMACx, uint8_t Param)
{
  (((FMACx->PARAM)) = ((((((FMACx->PARAM))) & (~((0xFFUL << (16U))))) | (((uint32_t)Param) << (16U)))));
}
...
static __inline uint8_t LL_FMAC_GetParamR(FMAC_TypeDef *FMACx)
{
  return (uint8_t)(((FMACx->PARAM) & ((0xFFUL << (16U)))) >> (16U));
}
# 465 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_fmac.h"
static __inline void LL_FMAC_SetParamQ(FMAC_TypeDef *FMACx, uint8_t Param)
{
  (((FMACx->PARAM)) = ((((((FMACx->PARAM))) & (~((0xFFUL << (8U))))) | (((uint32_t)Param) << (8U)))));
}
...
static __inline uint8_t LL_FMAC_GetParamQ(FMAC_TypeDef *FMACx)
{
  return (uint8_t)(((FMACx->PARAM) & ((0xFFUL << (8U)))) >> (8U));
}
# 489 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_fmac.h"
static __inline void LL_FMAC_SetParamP(FMAC_TypeDef *FMACx, uint8_t Param)
{
  (((FMACx->PARAM)) = ((((((FMACx->PARAM))) & (~((0xFFUL << (0U))))) | (((uint32_t)Param)))));
}
# 501 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_fmac.h"
static __inline uint8_t LL_FMAC_GetParamP(FMAC_TypeDef *FMACx)
{
  return (uint8_t)(((FMACx->PARAM) & ((0xFFUL << (0U)))));
}
# 520 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_fmac.h"
static __inline void LL_FMAC_EnableReset(FMAC_TypeDef *FMACx)
{
  ((FMACx->CR) |= ((0x1UL << (16U))));
}
...
static __inline uint32_t LL_FMAC_IsEnabledReset(FMAC_TypeDef *FMACx)
{
  return ((((FMACx->CR) & ((0x1UL << (16U)))) == ((0x1UL << (16U)))) ? 1UL : 0UL);
}
# 550 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_fmac.h"
static __inline void LL_FMAC_EnableClipping(FMAC_TypeDef *FMACx)
{
  ((FMACx->CR) |= ((0x1UL << (15U))));
}
...
static __inline void LL_FMAC_DisableClipping(FMAC_TypeDef *FMACx)
{
  ((FMACx->CR) &= ~((0x1UL << (15U))));
}
...
static __inline uint32_t LL_FMAC_IsEnabledClipping(FMAC_TypeDef *FMACx)
{
  return ((((FMACx->CR) & ((0x1UL << (15U)))) == ((0x1UL << (15U)))) ? 1UL : 0UL);
}
# 591 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_fmac.h"
static __inline void LL_FMAC_EnableDMAReq_WRITE(FMAC_TypeDef *FMACx)
{
  ((FMACx->CR) |= ((0x1UL << (9U))));
}
...
static __inline void LL_FMAC_DisableDMAReq_WRITE(FMAC_TypeDef *FMACx)
{
  ((FMACx->CR) &= ~((0x1UL << (9U))));
}
...
static __inline uint32_t LL_FMAC_IsEnabledDMAReq_WRITE(FMAC_TypeDef *FMACx)
{
  return ((((FMACx->CR) & ((0x1UL << (9U)))) == ((0x1UL << (9U)))) ? 1UL : 0UL);
}
...
static __inline void LL_FMAC_EnableDMAReq_READ(FMAC_TypeDef *FMACx)
{
  ((FMACx->CR) |= ((0x1UL << (8U))));
}
...
static __inline void LL_FMAC_DisableDMAReq_READ(FMAC_TypeDef *FMACx)
{
  ((FMACx->CR) &= ~((0x1UL << (8U))));
}
...
static __inline uint32_t LL_FMAC_IsEnabledDMAReq_READ(FMAC_TypeDef *FMACx)
{
  return ((((FMACx->CR) & ((0x1UL << (8U)))) == ((0x1UL << (8U)))) ? 1UL : 0UL);
}
# 665 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_fmac.h"
static __inline void LL_FMAC_EnableIT_SAT(FMAC_TypeDef *FMACx)
{
  ((FMACx->CR) |= ((0x1UL << (4U))));
}
...
static __inline void LL_FMAC_DisableIT_SAT(FMAC_TypeDef *FMACx)
{
  ((FMACx->CR) &= ~((0x1UL << (4U))));
}
...
static __inline uint32_t LL_FMAC_IsEnabledIT_SAT(FMAC_TypeDef *FMACx)
{
  return ((((FMACx->CR) & ((0x1UL << (4U)))) == ((0x1UL << (4U)))) ? 1UL : 0UL);
}
...
static __inline void LL_FMAC_EnableIT_UNFL(FMAC_TypeDef *FMACx)
{
  ((FMACx->CR) |= ((0x1UL << (3U))));
}
...
static __inline void LL_FMAC_DisableIT_UNFL(FMAC_TypeDef *FMACx)
{
  ((FMACx->CR) &= ~((0x1UL << (3U))));
}
...
static __inline uint32_t LL_FMAC_IsEnabledIT_UNFL(FMAC_TypeDef *FMACx)
{
  return ((((FMACx->CR) & ((0x1UL << (3U)))) == ((0x1UL << (3U)))) ? 1UL : 0UL);
}
...
static __inline void LL_FMAC_EnableIT_OVFL(FMAC_TypeDef *FMACx)
{
  ((FMACx->CR) |= ((0x1UL << (2U))));
}
...
static __inline void LL_FMAC_DisableIT_OVFL(FMAC_TypeDef *FMACx)
{
  ((FMACx->CR) &= ~((0x1UL << (2U))));
}
...
static __inline uint32_t LL_FMAC_IsEnabledIT_OVFL(FMAC_TypeDef *FMACx)
{
  return ((((FMACx->CR) & ((0x1UL << (2U)))) == ((0x1UL << (2U)))) ? 1UL : 0UL);
}
...
static __inline void LL_FMAC_EnableIT_WR(FMAC_TypeDef *FMACx)
{
  ((FMACx->CR) |= ((0x1UL << (1U))));
}
...
static __inline void LL_FMAC_DisableIT_WR(FMAC_TypeDef *FMACx)
{
  ((FMACx->CR) &= ~((0x1UL << (1U))));
}
...
static __inline uint32_t LL_FMAC_IsEnabledIT_WR(FMAC_TypeDef *FMACx)
{
  return ((((FMACx->CR) & ((0x1UL << (1U)))) == ((0x1UL << (1U)))) ? 1UL : 0UL);
}
...
static __inline void LL_FMAC_EnableIT_RD(FMAC_TypeDef *FMACx)
{
  ((FMACx->CR) |= ((0x1UL << (0U))));
}
...
static __inline void LL_FMAC_DisableIT_RD(FMAC_TypeDef *FMACx)
{
  ((FMACx->CR) &= ~((0x1UL << (0U))));
}
...
static __inline uint32_t LL_FMAC_IsEnabledIT_RD(FMAC_TypeDef *FMACx)
{
  return ((((FMACx->CR) & ((0x1UL << (0U)))) == ((0x1UL << (0U)))) ? 1UL : 0UL);
}
# 838 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_fmac.h"
static __inline uint32_t LL_FMAC_IsActiveFlag_SAT(FMAC_TypeDef *FMACx)
{
  return ((((FMACx->SR) & ((0x1UL << (10U)))) == ((0x1UL << (10U)))) ? 1UL : 0UL);
}
...
static __inline uint32_t LL_FMAC_IsActiveFlag_UNFL(FMAC_TypeDef *FMACx)
{
  return ((((FMACx->SR) & ((0x1UL << (9U)))) == ((0x1UL << (9U)))) ? 1UL : 0UL);
}
...
static __inline uint32_t LL_FMAC_IsActiveFlag_OVFL(FMAC_TypeDef *FMACx)
{
  return ((((FMACx->SR) & ((0x1UL << (8U)))) == ((0x1UL << (8U)))) ? 1UL : 0UL);
}
...
static __inline uint32_t LL_FMAC_IsActiveFlag_X1FULL(FMAC_TypeDef *FMACx)
{
  return ((((FMACx->SR) & ((0x1UL << (1U)))) == ((0x1UL << (1U)))) ? 1UL : 0UL);
}
...
static __inline uint32_t LL_FMAC_IsActiveFlag_YEMPTY(FMAC_TypeDef *FMACx)
{
  return ((((FMACx->SR) & ((0x1UL << (0U)))) == ((0x1UL << (0U)))) ? 1UL : 0UL);
}
# 903 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_fmac.h"
static __inline void LL_FMAC_WriteData(FMAC_TypeDef *FMACx, uint16_t InData)
{
  ((FMACx->WDATA) = (InData));
}
...
static __inline uint16_t LL_FMAC_ReadData(FMAC_TypeDef *FMACx)
{
  return (uint16_t)(((FMACx->RDATA)));
}
# 944 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_fmac.h"
static __inline void LL_FMAC_ConfigX1(FMAC_TypeDef *FMACx, uint32_t Watermark, uint8_t Base, uint8_t BufferSize)
{
  (((FMACx->X1BUFCFG)) = ((((((FMACx->X1BUFCFG))) & (~((0x3UL << (24U)) | (0xFFUL << (0U)) | (0xFFUL << (8U))))) | (Watermark | (((uint32_t)Base) << (0U)) | (((uint32_t)BufferSize) << (8U))))));


}
# 962 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_fmac.h"
static __inline void LL_FMAC_ConfigX2(FMAC_TypeDef *FMACx, uint8_t Base, uint8_t BufferSize)
{
  (((FMACx->X2BUFCFG)) = ((((((FMACx->X2BUFCFG))) & (~((0xFFUL << (0U)) | (0xFFUL << (8U))))) | ((((uint32_t)Base) << (0U)) | (((uint32_t)BufferSize) << (8U))))));


}
# 986 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_fmac.h"
static __inline void LL_FMAC_ConfigY(FMAC_TypeDef *FMACx, uint32_t Watermark, uint8_t Base, uint8_t BufferSize)
{
  (((FMACx->YBUFCFG)) = ((((((FMACx->YBUFCFG))) & (~((0x3UL << (24U)) | (0xFFUL << (0U)) | (0xFFUL << (8U))))) | (Watermark | (((uint32_t)Base) << (0U)) | (((uint32_t)BufferSize) << (8U))))));


}
# 1018 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_fmac.h"
static __inline void LL_FMAC_ConfigFunc(FMAC_TypeDef *FMACx, uint8_t Start, uint32_t Function, uint8_t ParamP,
                                        uint8_t ParamQ, uint8_t ParamR)
{
  (((FMACx->PARAM)) = ((((((FMACx->PARAM))) & (~((0x1UL << (31U)) | (0x7FUL << (24U)) | (0xFFUL << (0U)) | (0xFFUL << (8U)) | (0xFFUL << (16U))))) | ((((uint32_t)Start) << (31U)) | Function | (((uint32_t)ParamP) << (0U)) | (((uint32_t)ParamQ) << (8U)) | (((uint32_t)ParamR) << (16U))))));


}
# 1036 "./CubeMX/Drivers/STM32G4xx_HAL_Driver/Inc\\stm32g4xx_ll_fmac.h"
ErrorStatus LL_FMAC_Init(FMAC_TypeDef *FMACx);
ErrorStatus LL_FMAC_DeInit(FMAC_TypeDef *FMACx);
# 22 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_fmac.c" 2
...
# 23 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_fmac.c" 2
# 61 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_fmac.c"
ErrorStatus LL_FMAC_Init(FMAC_TypeDef *FMACx)
{
  ...
  if (FMACx == ((FMAC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1400UL)))
  {
...
# 93 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_fmac.c"
ErrorStatus LL_FMAC_DeInit(FMAC_TypeDef *FMACx)
{
  ErrorStatus status = SUCCESS;
  ...
  if (FMACx == ((FMAC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1400UL)))
  {
    ...
    LL_AHB1_GRP1_ForceReset((0x1UL << (4U)));


    LL_AHB1_GRP1_ReleaseReset((0x1UL << (4U)));
  }
  else
  {
    status = ERROR;
