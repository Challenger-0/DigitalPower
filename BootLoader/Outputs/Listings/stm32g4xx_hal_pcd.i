# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_pcd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_pcd.c" 2
# 57 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_pcd.c"
...
# 58 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_pcd.c" 2
# 90 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_pcd.c"
static HAL_StatusTypeDef PCD_EP_ISR_Handler(PCD_HandleTypeDef *hpcd);

static HAL_StatusTypeDef HAL_PCD_EP_DB_Transmit(PCD_HandleTypeDef *hpcd, PCD_EPTypeDef *ep, uint16_t wEPVal);
static uint16_t HAL_PCD_EP_DB_Receive(PCD_HandleTypeDef *hpcd, PCD_EPTypeDef *ep, uint16_t wEPVal);
# 124 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_pcd.c"
HAL_StatusTypeDef HAL_PCD_Init(PCD_HandleTypeDef *hpcd)
{
  uint8_t i;
...
# 166 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_pcd.c"
...
# 246 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_pcd.c"
...
# 977 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_pcd.c"
HAL_StatusTypeDef HAL_PCD_Start(PCD_HandleTypeDef *hpcd)
{
...
void HAL_PCD_IRQHandler(PCD_HandleTypeDef *hpcd)
{
  ...
  if ((wIstr & ((uint16_t)0x8000U)) == ((uint16_t)0x8000U))
  {
  ...
  if ((wIstr & ((uint16_t)0x0400U)) == ((uint16_t)0x0400U))
  {
  ...
  if ((wIstr & ((uint16_t)0x4000U)) == ((uint16_t)0x4000U))
  {
  ...
  if ((wIstr & ((uint16_t)0x2000U)) == ((uint16_t)0x2000U))
  {
  ...
  if ((wIstr & ((uint16_t)0x1000U)) == ((uint16_t)0x1000U))
  {
  ...
  if ((wIstr & ((uint16_t)0x0800U)) == ((uint16_t)0x0800U))
  {
  ...
  if ((wIstr & ((uint16_t)0x0080U)) == ((uint16_t)0x0080U))
  {
    (((hpcd)->Instance->ISTR) &= (uint16_t)(~(((uint16_t)0x0080U))));
    if (hpcd->LPM_State == LPM_L0)
    {
      ...
      hpcd->BESL = ((uint32_t)hpcd->Instance->LPMCSR & ((uint16_t)0x00F0U)) >> 2;
  ...
  if ((wIstr & ((uint16_t)0x0200U)) == ((uint16_t)0x0200U))
  {
  ...
  if ((wIstr & ((uint16_t)0x0100U)) == ((uint16_t)0x0100U))
  {
...
# 1154 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_pcd.c"
...
# 1344 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_pcd.c"
HAL_StatusTypeDef HAL_PCD_DevConnect(PCD_HandleTypeDef *hpcd)
{
  do{ if((hpcd)->Lock == HAL_LOCKED) { return HAL_BUSY; } else { (hpcd)->Lock = HAL_LOCKED; } }while (0U);
  (void)USB_DevConnect(hpcd->Instance);
...
# 1390 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_pcd.c"
HAL_StatusTypeDef HAL_PCD_EP_Open(PCD_HandleTypeDef *hpcd, uint8_t ep_addr,
                                  uint16_t ep_mps, uint8_t ep_type)
{
  ...
  {
    ep = &hpcd->IN_ep[ep_addr & 0x7U];
    ep->is_in = 1U;
  }
  else
  {
    ep = &hpcd->OUT_ep[ep_addr & 0x7U];
    ep->is_in = 0U;
  }
...
# 1466 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_pcd.c"
...
uint32_t HAL_PCD_EP_GetRxCount(PCD_HandleTypeDef *hpcd, uint8_t ep_addr)
{
  return hpcd->OUT_ep[ep_addr & 0x7U].xfer_count;
}
# 1509 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_pcd.c"
...
HAL_StatusTypeDef HAL_PCD_EP_SetStall(PCD_HandleTypeDef *hpcd, uint8_t ep_addr)
{
  ...
  if (((uint32_t)ep_addr & 0x7U) > hpcd->Init.dev_endpoints)
  {
    return HAL_ERROR;
  }
...
# 1669 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_pcd.c"
PCD_StateTypeDef HAL_PCD_GetState(PCD_HandleTypeDef *hpcd)
{
  return hpcd->State;
}
# 1693 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_pcd.c"
static HAL_StatusTypeDef PCD_EP_ISR_Handler(PCD_HandleTypeDef *hpcd)
{
  PCD_EPTypeDef *ep;
  uint16_t count;
  ...
  while ((hpcd->Instance->ISTR & ((uint16_t)0x8000U)) != 0U)
  {
    ...
    if (epindex == 0U)
    {
      ...
      if ((wIstr & ((uint16_t)0x0010U)) == 0U)
      {
        ...
        do { uint16_t _wRegVal; _wRegVal = (*(volatile uint16_t *)(&((hpcd->Instance))->EP0R + (((0U)) * 2U))) & (0xFF7FU & (((uint16_t)0x8000U)|((uint16_t)0x0800U)|((uint16_t)0x0600U)|((uint16_t)0x0100U)|((uint16_t)0x0080U)|((uint16_t)0x000FU))); (*(volatile uint16_t *) (&((hpcd->Instance))->EP0R + (((0U)) * 2U)) = (uint16_t)((_wRegVal | ((uint16_t)0x8000U)))); } while(0);
        ep = &hpcd->IN_ep[0];

        ep->xfer_count = ((uint32_t)(*((uint16_t *)((((uint32_t)((hpcd->Instance))->BTABLE + ((uint32_t)((ep->num)) * 8U) + 2U) * 1U) + ((uint32_t)((hpcd->Instance)) + 0x400U)))) & 0x3ffU);
        ...
        {
          hpcd->Instance->DADDR = ((uint16_t)hpcd->USB_Address | ((uint8_t)0x80U));
          hpcd->USB_Address = 0U;
        }
      }
      else
      {
        ...
        ep = &hpcd->OUT_ep[0];
        wEPVal = (*(volatile uint16_t *)(&(hpcd->Instance)->EP0R + ((0U) * 2U)));

        if ((wEPVal & ((uint16_t)0x0800U)) != 0U)
        {

          ep->xfer_count = ((uint32_t)(*((uint16_t *)((((uint32_t)((hpcd->Instance))->BTABLE + ((uint32_t)((ep->num)) * 8U) + 6U) * 1U) + ((uint32_t)((hpcd->Instance)) + 0x400U)))) & 0x3ffU);

          USB_ReadPMA(hpcd->Instance, (uint8_t *)hpcd->Setup,
                      ep->pmaadress, (uint16_t)ep->xfer_count);


          do { uint16_t _wRegVal; _wRegVal = (*(volatile uint16_t *)(&((hpcd->Instance))->EP0R + (((0U)) * 2U))) & (0x7FFFU & (((uint16_t)0x8000U)|((uint16_t)0x0800U)|((uint16_t)0x0600U)|((uint16_t)0x0100U)|((uint16_t)0x0080U)|((uint16_t)0x000FU))); (*(volatile uint16_t *) (&((hpcd->Instance))->EP0R + (((0U)) * 2U)) = (uint16_t)((_wRegVal | ((uint16_t)0x0080U)))); } while(0);
        ...
        else if ((wEPVal & ((uint16_t)0x8000U)) != 0U)
        {
          ...
          if (((*(volatile uint16_t *)(&(hpcd->Instance)->EP0R + ((0U) * 2U))) & ((uint16_t)0x0800U)) == 0U)
          {
            do { uint32_t _wRegBase = (uint32_t)(hpcd->Instance); volatile uint16_t *_wRegVal; _wRegBase += (uint32_t)(hpcd->Instance)->BTABLE; _wRegVal = (volatile uint16_t *)(_wRegBase + 0x400U + ((((uint32_t)(0U) * 8U) + 6U) * 1U)); do { uint32_t wNBlocks; if (((ep->maxpacket)) > 62U) { do { (wNBlocks) = (((ep->maxpacket))) >> 5; if (((((ep->maxpacket))) & 0x1fU) == 0U) { (wNBlocks)--; } *((_wRegVal)) = (uint16_t)(((wNBlocks) << 10) | (0x1U << 15)); } while(0); } else { if (((ep->maxpacket)) == 0U) { *(_wRegVal) &= (uint16_t)~(0x1FU << 10); *(_wRegVal) |= (0x1U << 15); } else { do { (wNBlocks) = (((ep->maxpacket))) >> 1; if (((((ep->maxpacket))) & 0x1U) != 0U) { (wNBlocks)++; } *((_wRegVal)) = (uint16_t)((wNBlocks) << 10); } while(0); } } } while(0); } while(0);
            do { uint16_t _wRegVal; _wRegVal = (*(volatile uint16_t *)(&((hpcd->Instance))->EP0R + (((0U)) * 2U))) & (((uint16_t)0x3000U)|(((uint16_t)0x8000U)|((uint16_t)0x0800U)|((uint16_t)0x0600U)|((uint16_t)0x0100U)|((uint16_t)0x0080U)|((uint16_t)0x000FU))); if ((((uint16_t)0x1000U) & (((uint16_t)0x3000U)))!= 0U) { _wRegVal ^= ((uint16_t)0x1000U); } if ((((uint16_t)0x2000U) & (((uint16_t)0x3000U)))!= 0U) { _wRegVal ^= ((uint16_t)0x2000U); } (*(volatile uint16_t *) (&((hpcd->Instance))->EP0R + (((0U)) * 2U)) = (uint16_t)((_wRegVal | ((uint16_t)0x8000U) | ((uint16_t)0x0080U)))); } while(0);
          }
        }
      }
    }
    else
    {
      ...
      wEPVal = (*(volatile uint16_t *)(&(hpcd->Instance)->EP0R + ((epindex) * 2U)));

      if ((wEPVal & ((uint16_t)0x8000U)) != 0U)
      {

        do { uint16_t _wRegVal; _wRegVal = (*(volatile uint16_t *)(&((hpcd->Instance))->EP0R + (((epindex)) * 2U))) & (0x7FFFU & (((uint16_t)0x8000U)|((uint16_t)0x0800U)|((uint16_t)0x0600U)|((uint16_t)0x0100U)|((uint16_t)0x0080U)|((uint16_t)0x000FU))); (*(volatile uint16_t *) (&((hpcd->Instance))->EP0R + (((epindex)) * 2U)) = (uint16_t)((_wRegVal | ((uint16_t)0x0080U)))); } while(0);
        ep = &hpcd->OUT_ep[epindex];


        if (ep->doublebuffer == 0U)
        {
          count = (uint16_t)((uint32_t)(*((uint16_t *)((((uint32_t)((hpcd->Instance))->BTABLE + ((uint32_t)((ep->num)) * 8U) + 6U) * 1U) + ((uint32_t)((hpcd->Instance)) + 0x400U)))) & 0x3ffU);
        ...
        else
        {
          ...
          else
          {
            ...
            do { if ((0U) == 0U) { do { uint16_t _wEPVal; _wEPVal = (*(volatile uint16_t *)(&(((hpcd->Instance)))->EP0R + ((((ep->num))) * 2U))) & (((uint16_t)0x8000U)|((uint16_t)0x0800U)|((uint16_t)0x0600U)|((uint16_t)0x0100U)|((uint16_t)0x0080U)|((uint16_t)0x000FU)); (*(volatile uint16_t *) (&(((hpcd->Instance)))->EP0R + ((((ep->num))) * 2U)) = (uint16_t)((_wEPVal | ((uint16_t)0x8000U) | ((uint16_t)0x0080U) | ((uint16_t)0x0040U)))); } while(0); } else if ((0U) == 1U) { do { uint16_t _wEPVal; _wEPVal = (*(volatile uint16_t *)(&(((hpcd->Instance)))->EP0R + ((((ep->num))) * 2U))) & (((uint16_t)0x8000U)|((uint16_t)0x0800U)|((uint16_t)0x0600U)|((uint16_t)0x0100U)|((uint16_t)0x0080U)|((uint16_t)0x000FU)); (*(volatile uint16_t *) (&(((hpcd->Instance)))->EP0R + ((((ep->num))) * 2U)) = (uint16_t)((_wEPVal | ((uint16_t)0x8000U) | ((uint16_t)0x0080U) | ((uint16_t)0x4000U)))); } while(0); } } while(0);

            if (((*(volatile uint16_t *)(&(hpcd->Instance)->EP0R + ((ep->num) * 2U))) & ((uint16_t)0x4000U)) != 0U)
            {

              count = (uint16_t)(((uint32_t)(*((uint16_t *)((((uint32_t)(((hpcd->Instance)))->BTABLE + ((uint32_t)(((ep->num))) * 8U) + 2U) * 1U) + ((uint32_t)(((hpcd->Instance))) + 0x400U)))) & 0x3ffU));
      ...
      if ((wEPVal & ((uint16_t)0x0080U)) != 0U)
      {
        ...
        do { uint16_t _wRegVal; _wRegVal = (*(volatile uint16_t *)(&((hpcd->Instance))->EP0R + (((epindex)) * 2U))) & (0xFF7FU & (((uint16_t)0x8000U)|((uint16_t)0x0800U)|((uint16_t)0x0600U)|((uint16_t)0x0100U)|((uint16_t)0x0080U)|((uint16_t)0x000FU))); (*(volatile uint16_t *) (&((hpcd->Instance))->EP0R + (((epindex)) * 2U)) = (uint16_t)((_wRegVal | ((uint16_t)0x8000U)))); } while(0);
        ...
        if (ep->type != 2U)
        {
          ...
          if (ep->doublebuffer != 0U)
          {
            if ((wEPVal & ((uint16_t)0x0040U)) != 0U)
            {
              do { if ((ep->is_in) == 0U) { do { uint32_t _wRegBase = (uint32_t)((hpcd->Instance)); volatile uint16_t *pdwReg; _wRegBase += (uint32_t)((hpcd->Instance))->BTABLE; pdwReg = (volatile uint16_t *)(_wRegBase + 0x400U + ((((uint32_t)((ep->num)) * 8U) + 2U) * 1U)); do { uint32_t wNBlocks; if ((((0U))) > 62U) { do { (wNBlocks) = ((((0U)))) >> 5; if ((((((0U)))) & 0x1fU) == 0U) { (wNBlocks)--; } *((pdwReg)) = (uint16_t)(((wNBlocks) << 10) | (0x1U << 15)); } while(0); } else { if ((((0U))) == 0U) { *(pdwReg) &= (uint16_t)~(0x1FU << 10); *(pdwReg) |= (0x1U << 15); } else { do { (wNBlocks) = ((((0U)))) >> 1; if ((((((0U)))) & 0x1U) != 0U) { (wNBlocks)++; } *((pdwReg)) = (uint16_t)((wNBlocks) << 10); } while(0); } } } while(0); } while(0); } else { if ((ep->is_in) == 1U) { do { uint32_t _wRegBase = (uint32_t)((hpcd->Instance)); volatile uint16_t *_wRegVal; _wRegBase += (uint32_t)((hpcd->Instance))->BTABLE; _wRegVal = (volatile uint16_t *)(_wRegBase + 0x400U + ((((uint32_t)((ep->num)) * 8U) + 2U) * 1U)); *_wRegVal = (uint16_t)((0U)); } while(0); } } } while(0);
            }
            else
            {
              do { uint32_t _wBase = (uint32_t)(hpcd->Instance); volatile uint16_t *_wEPRegVal; if ((ep->is_in) == 0U) { do { uint32_t _wRegBase = (uint32_t)((hpcd->Instance)); volatile uint16_t *_wRegVal; _wRegBase += (uint32_t)((hpcd->Instance))->BTABLE; _wRegVal = (volatile uint16_t *)(_wRegBase + 0x400U + ((((uint32_t)((ep->num)) * 8U) + 6U) * 1U)); do { uint32_t wNBlocks; if ((((0U))) > 62U) { do { (wNBlocks) = ((((0U)))) >> 5; if ((((((0U)))) & 0x1fU) == 0U) { (wNBlocks)--; } *((_wRegVal)) = (uint16_t)(((wNBlocks) << 10) | (0x1U << 15)); } while(0); } else { if ((((0U))) == 0U) { *(_wRegVal) &= (uint16_t)~(0x1FU << 10); *(_wRegVal) |= (0x1U << 15); } else { do { (wNBlocks) = ((((0U)))) >> 1; if ((((((0U)))) & 0x1U) != 0U) { (wNBlocks)++; } *((_wRegVal)) = (uint16_t)((wNBlocks) << 10); } while(0); } } } while(0); } while(0); } else { if ((ep->is_in) == 1U) { _wBase += (uint32_t)(hpcd->Instance)->BTABLE; _wEPRegVal = (volatile uint16_t *)(_wBase + 0x400U + ((((uint32_t)(ep->num) * 8U) + 6U) * 1U)); *_wEPRegVal = (uint16_t)(0U); } } } while(0);
            }
          }
        ...
        else
        {
          ...
          if ((wEPVal & ((uint16_t)0x0100U)) == 0U)
          {

            TxPctSize = (uint16_t)((uint32_t)(*((uint16_t *)((((uint32_t)((hpcd->Instance))->BTABLE + ((uint32_t)((ep->num)) * 8U) + 2U) * 1U) + ((uint32_t)((hpcd->Instance)) + 0x400U)))) & 0x3ffU);
...
# 1966 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_pcd.c"
...
# 2047 "CubeMX/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_pcd.c"
                                                ...
                                                PCD_EPTypeDef *ep, uint16_t wEPVal)
{
  ...
  if ((wEPVal & ((uint16_t)0x0040U)) != 0U)
  {
    ...
    if (ep->xfer_len == 0U)
    {
      ...
      if ((wEPVal & ((uint16_t)0x4000U)) != 0U)
      {
        do { if ((1U) == 0U) { do { uint16_t _wEPVal; _wEPVal = (*(volatile uint16_t *)(&(((hpcd->Instance)))->EP0R + ((((ep->num))) * 2U))) & (((uint16_t)0x8000U)|((uint16_t)0x0800U)|((uint16_t)0x0600U)|((uint16_t)0x0100U)|((uint16_t)0x0080U)|((uint16_t)0x000FU)); (*(volatile uint16_t *) (&(((hpcd->Instance)))->EP0R + ((((ep->num))) * 2U)) = (uint16_t)((_wEPVal | ((uint16_t)0x8000U) | ((uint16_t)0x0080U) | ((uint16_t)0x0040U)))); } while(0); } else if ((1U) == 1U) { do { uint16_t _wEPVal; _wEPVal = (*(volatile uint16_t *)(&(((hpcd->Instance)))->EP0R + ((((ep->num))) * 2U))) & (((uint16_t)0x8000U)|((uint16_t)0x0800U)|((uint16_t)0x0600U)|((uint16_t)0x0100U)|((uint16_t)0x0080U)|((uint16_t)0x000FU)); (*(volatile uint16_t *) (&(((hpcd->Instance)))->EP0R + ((((ep->num))) * 2U)) = (uint16_t)((_wEPVal | ((uint16_t)0x8000U) | ((uint16_t)0x0080U) | ((uint16_t)0x4000U)))); } while(0); } } while(0);
      }
    }
    else
    {
  ...
  else
  {
    ...
    TxPctSize = (uint16_t)(((uint32_t)(*((uint16_t *)((((uint32_t)(((hpcd->Instance)))->BTABLE + ((uint32_t)(((ep->num))) * 8U) + 6U) * 1U) + ((uint32_t)(((hpcd->Instance))) + 0x400U)))) & 0x3ffU));
