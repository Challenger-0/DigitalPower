...
static const LocalResource font_misterpixel_ch0x21_resource(font_misterpixel_ch0x21_content, 3); //!
static const LocalResource font_misterpixel_ch0x22_resource(font_misterpixel_ch0x22_content, 2); //"
static const LocalResource font_misterpixel_ch0x23_resource(font_misterpixel_ch0x23_content, 18); //#
static const LocalResource font_misterpixel_ch0x24_resource(font_misterpixel_ch0x24_content, 9); //$
static const LocalResource font_misterpixel_ch0x25_resource(font_misterpixel_ch0x25_content, 22); //%
static const LocalResource font_misterpixel_ch0x26_resource(font_misterpixel_ch0x26_content, 20); //&
static const LocalResource font_misterpixel_ch0x27_resource(font_misterpixel_ch0x27_content, 1); //'
static const LocalResource font_misterpixel_ch0x28_resource(font_misterpixel_ch0x28_content, 11); //(
static const LocalResource font_misterpixel_ch0x29_resource(font_misterpixel_ch0x29_content, 11); //)
static const LocalResource font_misterpixel_ch0x2a_resource(font_misterpixel_ch0x2a_content, 4); //*
static const LocalResource font_misterpixel_ch0x2b_resource(font_misterpixel_ch0x2b_content, 14); //+
static const LocalResource font_misterpixel_ch0x2c_resource(font_misterpixel_ch0x2c_content, 2); //,
static const LocalResource font_misterpixel_ch0x2d_resource(font_misterpixel_ch0x2d_content, 1); //-
static const LocalResource font_misterpixel_ch0x2e_resource(font_misterpixel_ch0x2e_content, 1); //.
static const LocalResource font_misterpixel_ch0x2f_resource(font_misterpixel_ch0x2f_content, 24); ///
static const LocalResource font_misterpixel_ch0x30_resource(font_misterpixel_ch0x30_content, 8); //0
static const LocalResource font_misterpixel_ch0x31_resource(font_misterpixel_ch0x31_content, 5); //1
static const LocalResource font_misterpixel_ch0x32_resource(font_misterpixel_ch0x32_content, 8); //2
static const LocalResource font_misterpixel_ch0x33_resource(font_misterpixel_ch0x33_content, 8); //3
static const LocalResource font_misterpixel_ch0x34_resource(font_misterpixel_ch0x34_content, 20); //4
static const LocalResource font_misterpixel_ch0x35_resource(font_misterpixel_ch0x35_content, 8); //5
static const LocalResource font_misterpixel_ch0x36_resource(font_misterpixel_ch0x36_content, 8); //6
static const LocalResource font_misterpixel_ch0x37_resource(font_misterpixel_ch0x37_content, 8); //7
static const LocalResource font_misterpixel_ch0x38_resource(font_misterpixel_ch0x38_content, 8); //8
static const LocalResource font_misterpixel_ch0x39_resource(font_misterpixel_ch0x39_content, 8); //9
static const LocalResource font_misterpixel_ch0x3a_resource(font_misterpixel_ch0x3a_content, 1); //:
static const LocalResource font_misterpixel_ch0x3b_resource(font_misterpixel_ch0x3b_content, 2); //;
static const LocalResource font_misterpixel_ch0x3c_resource(font_misterpixel_ch0x3c_content, 22); //<
static const LocalResource font_misterpixel_ch0x3d_resource(font_misterpixel_ch0x3d_content, 4); //=
static const LocalResource font_misterpixel_ch0x3e_resource(font_misterpixel_ch0x3e_content, 22); //>
static const LocalResource font_misterpixel_ch0x3f_resource(font_misterpixel_ch0x3f_content, 8); //?
static const LocalResource font_misterpixel_ch0x40_resource(font_misterpixel_ch0x40_content, 22); //@
static const LocalResource font_misterpixel_ch0x41_resource(font_misterpixel_ch0x41_content, 22); //A
static const LocalResource font_misterpixel_ch0x42_resource(font_misterpixel_ch0x42_content, 22); //B
static const LocalResource font_misterpixel_ch0x43_resource(font_misterpixel_ch0x43_content, 22); //C
static const LocalResource font_misterpixel_ch0x44_resource(font_misterpixel_ch0x44_content, 22); //D
static const LocalResource font_misterpixel_ch0x45_resource(font_misterpixel_ch0x45_content, 9); //E
static const LocalResource font_misterpixel_ch0x46_resource(font_misterpixel_ch0x46_content, 9); //F
static const LocalResource font_misterpixel_ch0x47_resource(font_misterpixel_ch0x47_content, 22); //G
static const LocalResource font_misterpixel_ch0x48_resource(font_misterpixel_ch0x48_content, 22); //H
static const LocalResource font_misterpixel_ch0x49_resource(font_misterpixel_ch0x49_content, 3); //I
static const LocalResource font_misterpixel_ch0x4a_resource(font_misterpixel_ch0x4a_content, 9); //J
static const LocalResource font_misterpixel_ch0x4b_resource(font_misterpixel_ch0x4b_content, 22); //K
static const LocalResource font_misterpixel_ch0x4c_resource(font_misterpixel_ch0x4c_content, 9); //L
static const LocalResource font_misterpixel_ch0x4d_resource(font_misterpixel_ch0x4d_content, 22); //M
static const LocalResource font_misterpixel_ch0x4e_resource(font_misterpixel_ch0x4e_content, 22); //N
static const LocalResource font_misterpixel_ch0x4f_resource(font_misterpixel_ch0x4f_content, 22); //O
static const LocalResource font_misterpixel_ch0x50_resource(font_misterpixel_ch0x50_content, 22); //P
static const LocalResource font_misterpixel_ch0x51_resource(font_misterpixel_ch0x51_content, 28); //Q
static const LocalResource font_misterpixel_ch0x52_resource(font_misterpixel_ch0x52_content, 22); //R
static const LocalResource font_misterpixel_ch0x53_resource(font_misterpixel_ch0x53_content, 22); //S
static const LocalResource font_misterpixel_ch0x54_resource(font_misterpixel_ch0x54_content, 22); //T
static const LocalResource font_misterpixel_ch0x55_resource(font_misterpixel_ch0x55_content, 22); //U
static const LocalResource font_misterpixel_ch0x56_resource(font_misterpixel_ch0x56_content, 22); //V
static const LocalResource font_misterpixel_ch0x57_resource(font_misterpixel_ch0x57_content, 22); //W
static const LocalResource font_misterpixel_ch0x58_resource(font_misterpixel_ch0x58_content, 22); //X
static const LocalResource font_misterpixel_ch0x59_resource(font_misterpixel_ch0x59_content, 22); //Y
static const LocalResource font_misterpixel_ch0x5a_resource(font_misterpixel_ch0x5a_content, 9); //Z
static const LocalResource font_misterpixel_ch0x5b_resource(font_misterpixel_ch0x5b_content, 7); //[
static const LocalResource font_misterpixel_ch0x5d_resource(font_misterpixel_ch0x5d_content, 7); //]
static const LocalResource font_misterpixel_ch0x5e_resource(font_misterpixel_ch0x5e_content, 20); //^
static const LocalResource font_misterpixel_ch0x5f_resource(font_misterpixel_ch0x5f_content, 2); //_
static const LocalResource font_misterpixel_ch0x60_resource(font_misterpixel_ch0x60_content, 1); //`
static const LocalResource font_misterpixel_ch0x61_resource(font_misterpixel_ch0x61_content, 7); //a
static const LocalResource font_misterpixel_ch0x62_resource(font_misterpixel_ch0x62_content, 9); //b
static const LocalResource font_misterpixel_ch0x63_resource(font_misterpixel_ch0x63_content, 7); //c
static const LocalResource font_misterpixel_ch0x64_resource(font_misterpixel_ch0x64_content, 9); //d
static const LocalResource font_misterpixel_ch0x65_resource(font_misterpixel_ch0x65_content, 7); //e
static const LocalResource font_misterpixel_ch0x66_resource(font_misterpixel_ch0x66_content, 8); //f
static const LocalResource font_misterpixel_ch0x67_resource(font_misterpixel_ch0x67_content, 9); //g
static const LocalResource font_misterpixel_ch0x68_resource(font_misterpixel_ch0x68_content, 9); //h
static const LocalResource font_misterpixel_ch0x69_resource(font_misterpixel_ch0x69_content, 3); //i
static const LocalResource font_misterpixel_ch0x6a_resource(font_misterpixel_ch0x6a_content, 7); //j
static const LocalResource font_misterpixel_ch0x6b_resource(font_misterpixel_ch0x6b_content, 24); //k
static const LocalResource font_misterpixel_ch0x6c_resource(font_misterpixel_ch0x6c_content, 5); //l
static const LocalResource font_misterpixel_ch0x6d_resource(font_misterpixel_ch0x6d_content, 18); //m
static const LocalResource font_misterpixel_ch0x6e_resource(font_misterpixel_ch0x6e_content, 7); //n
static const LocalResource font_misterpixel_ch0x6f_resource(font_misterpixel_ch0x6f_content, 7); //o
static const LocalResource font_misterpixel_ch0x70_resource(font_misterpixel_ch0x70_content, 9); //p
static const LocalResource font_misterpixel_ch0x71_resource(font_misterpixel_ch0x71_content, 9); //q
static const LocalResource font_misterpixel_ch0x72_resource(font_misterpixel_ch0x72_content, 7); //r
static const LocalResource font_misterpixel_ch0x73_resource(font_misterpixel_ch0x73_content, 7); //s
static const LocalResource font_misterpixel_ch0x74_resource(font_misterpixel_ch0x74_content, 9); //t
static const LocalResource font_misterpixel_ch0x75_resource(font_misterpixel_ch0x75_content, 7); //u
static const LocalResource font_misterpixel_ch0x76_resource(font_misterpixel_ch0x76_content, 18); //v
static const LocalResource font_misterpixel_ch0x77_resource(font_misterpixel_ch0x77_content, 18); //w
static const LocalResource font_misterpixel_ch0x78_resource(font_misterpixel_ch0x78_content, 18); //x
static const LocalResource font_misterpixel_ch0x79_resource(font_misterpixel_ch0x79_content, 9); //y
static const LocalResource font_misterpixel_ch0x7a_resource(font_misterpixel_ch0x7a_content, 6); //z
static const LocalResource font_misterpixel_ch0x7b_resource(font_misterpixel_ch0x7b_content, 10); //{
static const LocalResource font_misterpixel_ch0x7c_resource(font_misterpixel_ch0x7c_content, 2); //|
static const LocalResource font_misterpixel_ch0x7d_resource(font_misterpixel_ch0x7d_content, 10); //}
static const LocalResource font_misterpixel_ch0x7e_resource(font_misterpixel_ch0x7e_content, 8); //~
...
static const Graphics::FontCharacterSet font_misterpixel_chset(font_misterpixel_chset_content, 93);
